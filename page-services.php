          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="row margin-bottom-20">
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fas fa-thumbs-up color-grey"></i></div>
                    <h2>Harum quidem</h2>
                ...
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fas fa-download color-grey"></i></div>
                    <h2>Denim robatl</h2>
                    <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.</p>
                  </div>
                </div>
              ...
              <div class="row margin-bottom-20">
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fab fa-dropbox color-grey"></i></div>
                    <h2>Solnh mateore</h2>
                    <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fas fa-gift color-grey"></i></div>
                    <h2>Molestia pore</h2>
                    <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.</p>
                  </div>
                </div>
              ...
              <div class="row margin-bottom-20">
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fas fa-comments color-grey"></i></div>
                    <h2>Harum quidem</h2>
                    <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="service-box-v1">
                    <div><i class="fas fa-globe color-grey"></i></div>
                    <h2>Denim robatl</h2>
                    <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.</p>
                  </div>
                </div>
            ...
            <div class="col-md-5">
              ...
              <video width="320" height="570" controls autoplay>
                <source src="assets/pages/img/video/DR.X.mp4" type="video/mp4">
              </video>
              <!-- END VIDEO -->
                ...
                <div id="tab-1" class="tab-pane row fade active in">
                  <div class="col-md-3">
                    <a data-rel="fancybox-button" title="Image Title" class="fancybox-button" href="assets/temp/pics/img1-large.jpg">
                      <img alt="" src="assets/pages/img/pics/img1-large.jpg" class="img-responsive">
                    </a>
                  </div>
                  <div class="col-md-9">
                ...
                <div id="tab-2" class="tab-pane row fade">
                  ...
                  <div class="col-md-3">
                    <a data-rel="fancybox-button" title="Image Title" class="fancybox-button" href="assets/temp/pics/img2-large.jpg">
                      <img alt="" src="assets/pages/img/pics/img2-large.jpg" class="img-responsive">
                    </a>
                  </div>
                </div>
