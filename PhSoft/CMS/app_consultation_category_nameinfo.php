...
class capp_consultation_category_name extends cTable {
	...
	function __construct() {
		...
		// lang_id
		$this->lang_id = new cField('app_consultation_category_name', 'app_consultation_category_name', 'x_lang_id', 'lang_id', '`lang_id`', '`lang_id`', 3, -1, FALSE, '`lang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
