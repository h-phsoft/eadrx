...
class capp_vcons_cat extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'app_vcons_cat';
		$this->TableName = 'app_vcons_cat';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`app_vcons_cat`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// cat_price
		$this->cat_price = new cField('app_vcons_cat', 'app_vcons_cat', 'x_cat_price', 'cat_price', '`cat_price`', '`cat_price`', 131, -1, FALSE, '`cat_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// cat_desc
		$this->cat_desc = new cField('app_vcons_cat', 'app_vcons_cat', 'x_cat_desc', 'cat_desc', '`cat_desc`', '`cat_desc`', 201, -1, FALSE, '`cat_desc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_vcons_cat`";
	}
	...
	function SqlKeyFilter() {
		return "`cat_id` = @cat_id@ AND `ncat_id` = @ncat_id@";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "app_vcons_catview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "app_vcons_catedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_vcons_catadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_vcons_catview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_vcons_catview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_vcons_catadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_vcons_catadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("app_vcons_catedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("app_vcons_catadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_vcons_catdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->ncat_id->CurrentValue = $key[1];
	...
	function RenderEditRow() {
		...
		$this->cat_iname->EditCustomAttributes = "";
		$this->cat_iname->EditValue = $this->cat_iname->CurrentValue;
		$this->cat_iname->PlaceHolder = ew_RemoveHtml($this->cat_iname->FldCaption());
