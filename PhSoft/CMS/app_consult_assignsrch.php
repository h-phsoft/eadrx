...
$app_consult_assign_search = NULL; // Initialize page object first

class capp_consult_assign_search extends capp_consult_assign {
	...
	// Page object name
	var $PageObjName = 'app_consult_assign_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "app_consult_assignlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($app_consult_assign_search)) $app_consult_assign_search = new capp_consult_assign_search();

// Page init
$app_consult_assign_search->Page_Init();

// Page main
$app_consult_assign_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_consult_assign_search->Page_Render();
?>
...
<?php if ($app_consult_assign_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fapp_consult_assignsearch = new ew_Form("fapp_consult_assignsearch", "search");
<?php } else { ?>
var CurrentForm = fapp_consult_assignsearch = new ew_Form("fapp_consult_assignsearch", "search");
<?php } ?>

// Form_CustomValidate event
fapp_consult_assignsearch.Form_CustomValidate = 
...
fapp_consult_assignsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_consult_assignsearch.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_consult_assignsearch.Lists["x_user_id"].Data = "<?php echo $app_consult_assign_search->user_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_consult_assignsearch.Lists["x_cons_id"] = {"LinkField":"x_cons_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cons_message","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_consultation"};
fapp_consult_assignsearch.Lists["x_cons_id"].Data = "<?php echo $app_consult_assign_search->cons_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_consult_assignsearch.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fapp_consult_assignsearch.Lists["x_status_id"].Data = "<?php echo $app_consult_assign_search->status_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fapp_consult_assignsearch.Validate = function(fobj) {
...
<?php $app_consult_assign_search->ShowPageHeader(); ?>
<?php
$app_consult_assign_search->ShowMessage();
?>
<form name="fapp_consult_assignsearch" id="fapp_consult_assignsearch" class="<?php echo $app_consult_assign_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_consult_assign_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_consult_assign_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_consult_assign">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($app_consult_assign_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($app_consult_assign->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label for="x_user_id" class="<?php echo $app_consult_assign_search->LeftColumnClass ?>"><span id="elh_app_consult_assign_user_id"><?php echo $app_consult_assign->user_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_consult_assign_search->RightColumnClass ?>"><div<?php echo $app_consult_assign->user_id->CellAttributes() ?>>
...
<?php if ($app_consult_assign->cons_id->Visible) { // cons_id ?>
	<div id="r_cons_id" class="form-group">
		<label for="x_cons_id" class="<?php echo $app_consult_assign_search->LeftColumnClass ?>"><span id="elh_app_consult_assign_cons_id"><?php echo $app_consult_assign->cons_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_consult_assign_search->RightColumnClass ?>"><div<?php echo $app_consult_assign->cons_id->CellAttributes() ?>>
			<span id="el_app_consult_assign_cons_id">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_cons_id"><?php echo (strval($app_consult_assign->cons_id->AdvancedSearch->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $app_consult_assign->cons_id->AdvancedSearch->ViewValue); ?></span>
</span>
...
<?php if ($app_consult_assign->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label for="x_status_id" class="<?php echo $app_consult_assign_search->LeftColumnClass ?>"><span id="elh_app_consult_assign_status_id"><?php echo $app_consult_assign->status_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_consult_assign_search->RightColumnClass ?>"><div<?php echo $app_consult_assign->status_id->CellAttributes() ?>>
...
<?php if ($app_consult_assign->ins_datetime->Visible) { // ins_datetime ?>
	<div id="r_ins_datetime" class="form-group">
		<label for="x_ins_datetime" class="<?php echo $app_consult_assign_search->LeftColumnClass ?>"><span id="elh_app_consult_assign_ins_datetime"><?php echo $app_consult_assign->ins_datetime->FldCaption() ?></span>
		...
		<div class="<?php echo $app_consult_assign_search->RightColumnClass ?>"><div<?php echo $app_consult_assign->ins_datetime->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_consult_assign_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fapp_consult_assignsearch.Init();
</script>
<?php
$app_consult_assign_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_consult_assign_search->Page_Terminate();
?>
