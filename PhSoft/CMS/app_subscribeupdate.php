...
class capp_subscribe_update extends capp_subscribe {
	...
	function ValidateForm() {
		...
		if (!EW_SERVER_VALIDATE)
			return ($gsFormError == "");
		if ($this->serv_id->MultiUpdate <> "" && !$this->serv_id->FldIsDetailKey && !is_null($this->serv_id->FormValue) && $this->serv_id->FormValue == "") {
		...
		if ($this->cycle_id->MultiUpdate <> "" && !$this->cycle_id->FldIsDetailKey && !is_null($this->cycle_id->FormValue) && $this->cycle_id->FormValue == "") {
...
fapp_subscribeupdate.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			uelm = this.GetElements("u" + infix + "_serv_id");
			...
			uelm = this.GetElements("u" + infix + "_cycle_id");
			if (uelm && uelm.checked) {
				if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
