...
class cphs_perms_list extends cphs_perms {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiUpdate\" title=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" data-table=\"phs_perms\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fphs_permslist,url:'" . $this->MultiUpdateUrl . "'});return false;\">" . $Language->Phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->CanEdit());
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_phs_perms\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_phs_perms',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fphs_permslist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
<?php } ?>
<?php if ($phs_perms_list->Pager->RecordCount > 0) { ?>
...
// Render list options (body, right)
$phs_perms_list->ListOptions->Render("body", "right", $phs_perms_list->RowIndex);
?>
<script type="text/javascript">
fphs_permslist.UpdateOpts(<?php echo $phs_perms_list->RowIndex ?>);
</script>
