...
$cpy_faq_view = NULL; // Initialize page object first

class ccpy_faq_view extends ccpy_faq {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["faq_id"] <> "") {
			$this->RecKey["faq_id"] = $_GET["faq_id"];
			$KeyUrl .= "&amp;faq_id=" . urlencode($this->RecKey["faq_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["faq_id"] <> "") {
				...
				$this->RecKey["faq_id"] = $this->faq_id->QueryStringValue;
			} elseif (@$_POST["faq_id"] <> "") {
				$this->faq_id->setFormValue($_POST["faq_id"]);
				$this->RecKey["faq_id"] = $this->faq_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "cpy_faqlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "cpy_faqlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cpy_faq_view)) $cpy_faq_view = new ccpy_faq_view();

// Page init
$cpy_faq_view->Page_Init();

// Page main
$cpy_faq_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_faq_view->Page_Render();
?>
...
var CurrentForm = fcpy_faqview = new ew_Form("fcpy_faqview", "view");

// Form_CustomValidate event
fcpy_faqview.Form_CustomValidate = 
...
fcpy_faqview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_faqview.Lists["x_fcat_id"] = {"LinkField":"x_fcat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_fcat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_faq_category"};
fcpy_faqview.Lists["x_fcat_id"].Data = "<?php echo $cpy_faq_view->fcat_id->LookupFilterQuery(FALSE, "view") ?>";
fcpy_faqview.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_faqview.Lists["x_status_id"].Data = "<?php echo $cpy_faq_view->status_id->LookupFilterQuery(FALSE, "view") ?>";
fcpy_faqview.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fcpy_faqview.Lists["x_lang_id"].Data = "<?php echo $cpy_faq_view->lang_id->LookupFilterQuery(FALSE, "view") ?>";
fcpy_faqview.Lists["x_color_id"] = {"LinkField":"x_color_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_color_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_color"};
fcpy_faqview.Lists["x_color_id"].Data = "<?php echo $cpy_faq_view->color_id->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $cpy_faq_view->ExportOptions->Render("body") ?>
<?php
	foreach ($cpy_faq_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $cpy_faq_view->ShowPageHeader(); ?>
<?php
$cpy_faq_view->ShowMessage();
?>
<?php if (!$cpy_faq_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($cpy_faq_view->Pager)) $cpy_faq_view->Pager = new cPrevNextPager($cpy_faq_view->StartRec, $cpy_faq_view->DisplayRecs, $cpy_faq_view->TotalRecs, $cpy_faq_view->AutoHidePager) ?>
<?php if ($cpy_faq_view->Pager->RecordCount > 0 && $cpy_faq_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cpy_faq_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cpy_faq_view->PageUrl() ?>start=<?php echo $cpy_faq_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cpy_faq_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cpy_faq_view->PageUrl() ?>start=<?php echo $cpy_faq_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cpy_faq_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cpy_faq_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cpy_faq_view->PageUrl() ?>start=<?php echo $cpy_faq_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cpy_faq_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cpy_faq_view->PageUrl() ?>start=<?php echo $cpy_faq_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cpy_faq_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcpy_faqview" id="fcpy_faqview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_faq_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_faq_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_faq">
<input type="hidden" name="modal" value="<?php echo intval($cpy_faq_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($cpy_faq->fcat_id->Visible) { // fcat_id ?>
	<tr id="r_fcat_id">
		<td class="col-sm-2"><span id="elh_cpy_faq_fcat_id"><?php echo $cpy_faq->fcat_id->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->fcat_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->status_id->Visible) { // status_id ?>
	<tr id="r_status_id">
		<td class="col-sm-2"><span id="elh_cpy_faq_status_id"><?php echo $cpy_faq->status_id->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->status_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->lang_id->Visible) { // lang_id ?>
	<tr id="r_lang_id">
		<td class="col-sm-2"><span id="elh_cpy_faq_lang_id"><?php echo $cpy_faq->lang_id->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->lang_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->color_id->Visible) { // color_id ?>
	<tr id="r_color_id">
		<td class="col-sm-2"><span id="elh_cpy_faq_color_id"><?php echo $cpy_faq->color_id->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->color_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->faq_order->Visible) { // faq_order ?>
	<tr id="r_faq_order">
		<td class="col-sm-2"><span id="elh_cpy_faq_faq_order"><?php echo $cpy_faq->faq_order->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->faq_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->faq_title->Visible) { // faq_title ?>
	<tr id="r_faq_title">
		<td class="col-sm-2"><span id="elh_cpy_faq_faq_title"><?php echo $cpy_faq->faq_title->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->faq_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_faq->faq_text->Visible) { // faq_text ?>
	<tr id="r_faq_text">
		<td class="col-sm-2"><span id="elh_cpy_faq_faq_text"><?php echo $cpy_faq->faq_text->FldCaption() ?></span></td>
...
<?php echo $cpy_faq->faq_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
