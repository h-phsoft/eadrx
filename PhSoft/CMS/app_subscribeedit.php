...
class capp_subscribe_edit extends capp_subscribe {
	...
	function ValidateForm() {
		...
		if (in_array("app_subscribe_cats", $DetailTblVar) && $GLOBALS["app_subscribe_cats"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("app_subscribe_cats", $DetailTblVar) && $GLOBALS["app_subscribe_cats"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["app_subscribe_cats_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("app_subscribe_cats", $DetailTblVar)) {
				...
				if ($GLOBALS["app_subscribe_cats_grid"]->DetailEdit) {
					$GLOBALS["app_subscribe_cats_grid"]->CurrentMode = "edit";
					$GLOBALS["app_subscribe_cats_grid"]->CurrentAction = "gridedit";
...
fapp_subscribeedit.Lists["x_pkg_id"] = {"LinkField":"x_pkg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pkg_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_package"};
fapp_subscribeedit.Lists["x_pkg_id"].Data = "<?php echo $app_subscribe_edit->pkg_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($app_subscribe->serv_id->Visible) { // serv_id ?>
	<div id="r_serv_id" class="form-group">
		<label id="elh_app_subscribe_serv_id" for="x_serv_id" class="<?php echo $app_subscribe_edit->LeftColumnClass ?>"><?php echo $app_subscribe->serv_id->FldCaption() ?></label>
...
<?php if ($app_subscribe->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_subscribe_user_id" for="x_user_id" class="<?php echo $app_subscribe_edit->LeftColumnClass ?>"><?php echo $app_subscribe->user_id->FldCaption() ?></label>
...
<?php if ($app_subscribe->cycle_id->Visible) { // cycle_id ?>
	<div id="r_cycle_id" class="form-group">
		<label id="elh_app_subscribe_cycle_id" for="x_cycle_id" class="<?php echo $app_subscribe_edit->LeftColumnClass ?>"><?php echo $app_subscribe->cycle_id->FldCaption() ?></label>
...
<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
	<div id="r_pkg_id" class="form-group">
		<label id="elh_app_subscribe_pkg_id" for="x_pkg_id" class="<?php echo $app_subscribe_edit->LeftColumnClass ?>"><?php echo $app_subscribe->pkg_id->FldCaption() ?></label>
		<div class="<?php echo $app_subscribe_edit->RightColumnClass ?>"><div<?php echo $app_subscribe->pkg_id->CellAttributes() ?>>
...
<?php
	if (in_array("app_subscribe_cats", explode(",", $app_subscribe->getCurrentDetailTable())) && $app_subscribe_cats->DetailEdit) {
?>
