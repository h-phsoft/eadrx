...
class capp_subscribe_list extends capp_subscribe {
	...
	function __construct() {
		...
		$this->AddUrl = "app_subscribeadd.php?" . EW_TABLE_SHOW_DETAIL . "=";
	...
	function SetupListOptions() {
		...
		$item = &$this->ListOptions->Add("detail_app_subscribe_cats");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'app_subscribe_cats') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	function RenderListOptions() {
		...
		// "detail_app_subscribe_cats"
		$oListOpt = &$this->ListOptions->Items["detail_app_subscribe_cats"];
		if ($Security->AllowList(CurrentProjectID() . 'app_subscribe_cats')) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("app_subscribe_cats", "TblCaption");
			...
			$links = "";
			if ($GLOBALS["app_subscribe_cats_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'app_subscribe_cats')) {
				$caption = $Language->Phrase("MasterDetailViewLink");
				$url = $this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=app_subscribe_cats");
			...
			if ($GLOBALS["app_subscribe_cats_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'app_subscribe_cats')) {
				$caption = $Language->Phrase("MasterDetailEditLink");
				$url = $this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=app_subscribe_cats");
			...
			if ($GLOBALS["app_subscribe_cats_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'app_subscribe_cats')) {
				$caption = $Language->Phrase("MasterDetailCopyLink");
				$url = $this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=app_subscribe_cats");
	...
	function SetupOtherOptions() {
		...
		$DetailTableLink = "";
		$item = &$option->Add("detailadd_app_subscribe_cats");
		$url = $this->GetAddUrl(EW_TABLE_SHOW_DETAIL . "=app_subscribe_cats");
		$caption = $Language->Phrase("Add") . "&nbsp;" . $this->TableCaption() . "/" . $GLOBALS["app_subscribe_cats"]->TableCaption();
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["app_subscribe_cats"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'app_subscribe_cats') && $Security->CanAdd());
		if ($item->Visible) {
...
fapp_subscribelist.Lists["x_pkg_id"] = {"LinkField":"x_pkg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pkg_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_package"};
fapp_subscribelist.Lists["x_pkg_id"].Data = "<?php echo $app_subscribe_list->pkg_id->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
	<?php if ($app_subscribe->SortUrl($app_subscribe->pkg_id) == "") { ?>
		<th data-name="pkg_id" class="<?php echo $app_subscribe->pkg_id->HeaderCellClass() ?>"><div id="elh_app_subscribe_pkg_id" class="app_subscribe_pkg_id"><div class="ewTableHeaderCaption"><?php echo $app_subscribe->pkg_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pkg_id" class="<?php echo $app_subscribe->pkg_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $app_subscribe->SortUrl($app_subscribe->pkg_id) ?>',1);"><div id="elh_app_subscribe_pkg_id" class="app_subscribe_pkg_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $app_subscribe->pkg_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($app_subscribe->pkg_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($app_subscribe->pkg_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<input type="hidden" data-table="app_subscribe" data-field="x_book_id" name="o<?php echo $app_subscribe_list->RowIndex ?>_book_id" id="o<?php echo $app_subscribe_list->RowIndex ?>_book_id" value="<?php echo ew_HtmlEncode($app_subscribe->book_id->OldValue) ?>">
	...
	<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
		<td data-name="pkg_id">
<span id="el<?php echo $app_subscribe_list->RowCnt ?>_app_subscribe_pkg_id" class="form-group app_subscribe_pkg_id">
<select data-table="app_subscribe" data-field="x_pkg_id" data-value-separator="<?php echo $app_subscribe->pkg_id->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id" name="x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id"<?php echo $app_subscribe->pkg_id->EditAttributes() ?>>
<?php echo $app_subscribe->pkg_id->SelectOptionListHtml("x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id") ?>
</select>
</span>
<input type="hidden" data-table="app_subscribe" data-field="x_pkg_id" name="o<?php echo $app_subscribe_list->RowIndex ?>_pkg_id" id="o<?php echo $app_subscribe_list->RowIndex ?>_pkg_id" value="<?php echo ew_HtmlEncode($app_subscribe->pkg_id->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($app_subscribe->tcat_id->Visible) { // tcat_id ?>
...
<?php } ?>
<?php if ($app_subscribe->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $app_subscribe_list->RowCnt ?>_app_subscribe_pkg_id" class="app_subscribe_pkg_id">
...
<input type="hidden" data-table="app_subscribe" data-field="x_book_id" name="o<?php echo $app_subscribe_list->RowIndex ?>_book_id" id="o<?php echo $app_subscribe_list->RowIndex ?>_book_id" value="<?php echo ew_HtmlEncode($app_subscribe->book_id->OldValue) ?>">
	...
	<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
		<td data-name="pkg_id">
<span id="el$rowindex$_app_subscribe_pkg_id" class="form-group app_subscribe_pkg_id">
<select data-table="app_subscribe" data-field="x_pkg_id" data-value-separator="<?php echo $app_subscribe->pkg_id->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id" name="x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id"<?php echo $app_subscribe->pkg_id->EditAttributes() ?>>
<?php echo $app_subscribe->pkg_id->SelectOptionListHtml("x<?php echo $app_subscribe_list->RowIndex ?>_pkg_id") ?>
</select>
</span>
