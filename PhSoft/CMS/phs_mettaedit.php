...
fphs_mettaedit.Lists["x_metta_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fphs_mettaedit.Lists["x_metta_type"].Options = <?php echo json_encode($phs_metta_edit->metta_type->Options()) ?>;
...
<?php if ($phs_metta->metta_type->Visible) { // metta_type ?>
	<div id="r_metta_type" class="form-group">
		<label id="elh_phs_metta_metta_type" for="x_metta_type" class="<?php echo $phs_metta_edit->LeftColumnClass ?>"><?php echo $phs_metta->metta_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_metta_edit->RightColumnClass ?>"><div<?php echo $phs_metta->metta_type->CellAttributes() ?>>
