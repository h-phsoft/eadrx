...
$app_contactus_edit = NULL; // Initialize page object first

class capp_contactus_edit extends capp_contactus {
	...
	// Page object name
	var $PageObjName = 'app_contactus_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_contactuslist.php"); // Return to list page
			...
			if (!is_null($this->cont_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->cont_id->CurrentValue) == strval($this->Recordset->fields('cont_id'))) {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->cont_id->FldIsDetailKey)
			$this->cont_id->setFormValue($objForm->GetValue("x_cont_id"));
...
// Create page object
if (!isset($app_contactus_edit)) $app_contactus_edit = new capp_contactus_edit();

// Page init
$app_contactus_edit->Page_Init();

// Page main
$app_contactus_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_contactus_edit->Page_Render();
?>
...
var CurrentForm = fapp_contactusedit = new ew_Form("fapp_contactusedit", "edit");

// Validate form
fapp_contactusedit.Validate = function() {
...
fapp_contactusedit.Form_CustomValidate = 
...
fapp_contactusedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_contactusedit.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_contactusedit.Lists["x_user_id"].Data = "<?php echo $app_contactus_edit->user_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_contactus_edit->ShowPageHeader(); ?>
<?php
$app_contactus_edit->ShowMessage();
?>
<?php if (!$app_contactus_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_contactus_edit->Pager)) $app_contactus_edit->Pager = new cPrevNextPager($app_contactus_edit->StartRec, $app_contactus_edit->DisplayRecs, $app_contactus_edit->TotalRecs, $app_contactus_edit->AutoHidePager) ?>
<?php if ($app_contactus_edit->Pager->RecordCount > 0 && $app_contactus_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_contactus_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_contactus_edit->PageUrl() ?>start=<?php echo $app_contactus_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_contactus_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_contactus_edit->PageUrl() ?>start=<?php echo $app_contactus_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_contactus_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_contactus_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_contactus_edit->PageUrl() ?>start=<?php echo $app_contactus_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_contactus_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_contactus_edit->PageUrl() ?>start=<?php echo $app_contactus_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_contactus_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_contactusedit" id="fapp_contactusedit" class="<?php echo $app_contactus_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_contactus_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_contactus_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_contactus">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_contactus_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($app_contactus->cont_id->Visible) { // cont_id ?>
	<div id="r_cont_id" class="form-group">
		<label id="elh_app_contactus_cont_id" class="<?php echo $app_contactus_edit->LeftColumnClass ?>"><?php echo $app_contactus->cont_id->FldCaption() ?></label>
		<div class="<?php echo $app_contactus_edit->RightColumnClass ?>"><div<?php echo $app_contactus->cont_id->CellAttributes() ?>>
...
<input type="hidden" data-table="app_contactus" data-field="x_cont_id" name="x_cont_id" id="x_cont_id" value="<?php echo ew_HtmlEncode($app_contactus->cont_id->CurrentValue) ?>">
<?php echo $app_contactus->cont_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($app_contactus->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_contactus_user_id" for="x_user_id" class="<?php echo $app_contactus_edit->LeftColumnClass ?>"><?php echo $app_contactus->user_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_contactus_edit->RightColumnClass ?>"><div<?php echo $app_contactus->user_id->CellAttributes() ?>>
...
<?php if ($app_contactus->cont_subj->Visible) { // cont_subj ?>
	<div id="r_cont_subj" class="form-group">
		<label id="elh_app_contactus_cont_subj" for="x_cont_subj" class="<?php echo $app_contactus_edit->LeftColumnClass ?>"><?php echo $app_contactus->cont_subj->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_contactus_edit->RightColumnClass ?>"><div<?php echo $app_contactus->cont_subj->CellAttributes() ?>>
...
<?php if ($app_contactus->cont_msg->Visible) { // cont_msg ?>
	<div id="r_cont_msg" class="form-group">
		<label id="elh_app_contactus_cont_msg" for="x_cont_msg" class="<?php echo $app_contactus_edit->LeftColumnClass ?>"><?php echo $app_contactus->cont_msg->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_contactus_edit->RightColumnClass ?>"><div<?php echo $app_contactus->cont_msg->CellAttributes() ?>>
...
<?php if ($app_contactus->cont_datetime->Visible) { // cont_datetime ?>
	<div id="r_cont_datetime" class="form-group">
		<label id="elh_app_contactus_cont_datetime" for="x_cont_datetime" class="<?php echo $app_contactus_edit->LeftColumnClass ?>"><?php echo $app_contactus->cont_datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_contactus_edit->RightColumnClass ?>"><div<?php echo $app_contactus->cont_datetime->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_contactus_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_contactus_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_contactusedit.Init();
</script>
<?php
$app_contactus_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_contactus_edit->Page_Terminate();
?>
