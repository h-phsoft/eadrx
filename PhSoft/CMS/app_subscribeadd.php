...
<?php if ($app_subscribe->serv_id->Visible) { // serv_id ?>
	<div id="r_serv_id" class="form-group">
		<label id="elh_app_subscribe_serv_id" for="x_serv_id" class="<?php echo $app_subscribe_add->LeftColumnClass ?>"><?php echo $app_subscribe->serv_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($app_subscribe->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_subscribe_user_id" for="x_user_id" class="<?php echo $app_subscribe_add->LeftColumnClass ?>"><?php echo $app_subscribe->user_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($app_subscribe->cycle_id->Visible) { // cycle_id ?>
	<div id="r_cycle_id" class="form-group">
		<label id="elh_app_subscribe_cycle_id" for="x_cycle_id" class="<?php echo $app_subscribe_add->LeftColumnClass ?>"><?php echo $app_subscribe->cycle_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
