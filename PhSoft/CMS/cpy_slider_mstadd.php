...
fcpy_slider_mstadd.Lists["x_stype_id"] = {"LinkField":"x_stype_jd","Ajax":true,"AutoFill":false,"DisplayFields":["x_stype_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_slider_type"};
fcpy_slider_mstadd.Lists["x_stype_id"].Data = "<?php echo $cpy_slider_mst_add->stype_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_slider_mstadd.Lists["x_scols_id"] = {"LinkField":"x_scols_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_scols_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_slider_cols"};
fcpy_slider_mstadd.Lists["x_scols_id"].Data = "<?php echo $cpy_slider_mst_add->scols_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($cpy_slider_mst->stype_id->Visible) { // stype_id ?>
	<div id="r_stype_id" class="form-group">
		<label id="elh_cpy_slider_mst_stype_id" for="x_stype_id" class="<?php echo $cpy_slider_mst_add->LeftColumnClass ?>"><?php echo $cpy_slider_mst->stype_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_mst_add->RightColumnClass ?>"><div<?php echo $cpy_slider_mst->stype_id->CellAttributes() ?>>
...
<?php if ($cpy_slider_mst->scols_id->Visible) { // scols_id ?>
	<div id="r_scols_id" class="form-group">
		<label id="elh_cpy_slider_mst_scols_id" for="x_scols_id" class="<?php echo $cpy_slider_mst_add->LeftColumnClass ?>"><?php echo $cpy_slider_mst->scols_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_mst_add->RightColumnClass ?>"><div<?php echo $cpy_slider_mst->scols_id->CellAttributes() ?>>
