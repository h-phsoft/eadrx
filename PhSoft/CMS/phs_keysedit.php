...
$phs_keys_edit = NULL; // Initialize page object first

class cphs_keys_edit extends cphs_keys {
	...
	function ValidateForm() {
		...
		if (in_array("phs_keyvalues", $DetailTblVar) && $GLOBALS["phs_keyvalues"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("phs_keyvalues", $DetailTblVar) && $GLOBALS["phs_keyvalues"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["phs_keyvalues_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("phs_keyvalues", $DetailTblVar)) {
				...
				if ($GLOBALS["phs_keyvalues_grid"]->DetailEdit) {
					$GLOBALS["phs_keyvalues_grid"]->CurrentMode = "edit";
					$GLOBALS["phs_keyvalues_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($phs_keys_edit)) $phs_keys_edit = new cphs_keys_edit();

// Page init
$phs_keys_edit->Page_Init();

// Page main
$phs_keys_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_keys_edit->Page_Render();
?>
...
var CurrentForm = fphs_keysedit = new ew_Form("fphs_keysedit", "edit");

// Validate form
fphs_keysedit.Validate = function() {
...
fphs_keysedit.Form_CustomValidate = 
...
fphs_keysedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $phs_keys_edit->ShowPageHeader(); ?>
<?php
$phs_keys_edit->ShowMessage();
?>
<?php if (!$phs_keys_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($phs_keys_edit->Pager)) $phs_keys_edit->Pager = new cPrevNextPager($phs_keys_edit->StartRec, $phs_keys_edit->DisplayRecs, $phs_keys_edit->TotalRecs, $phs_keys_edit->AutoHidePager) ?>
<?php if ($phs_keys_edit->Pager->RecordCount > 0 && $phs_keys_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($phs_keys_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $phs_keys_edit->PageUrl() ?>start=<?php echo $phs_keys_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($phs_keys_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $phs_keys_edit->PageUrl() ?>start=<?php echo $phs_keys_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $phs_keys_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($phs_keys_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $phs_keys_edit->PageUrl() ?>start=<?php echo $phs_keys_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($phs_keys_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $phs_keys_edit->PageUrl() ?>start=<?php echo $phs_keys_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $phs_keys_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fphs_keysedit" id="fphs_keysedit" class="<?php echo $phs_keys_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_keys_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_keys_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_keys">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($phs_keys_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($phs_keys->key_name->Visible) { // key_name ?>
	<div id="r_key_name" class="form-group">
		<label id="elh_phs_keys_key_name" for="x_key_name" class="<?php echo $phs_keys_edit->LeftColumnClass ?>"><?php echo $phs_keys->key_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keys_edit->RightColumnClass ?>"><div<?php echo $phs_keys->key_name->CellAttributes() ?>>
...
<?php if ($phs_keys->key_defvalue->Visible) { // key_defvalue ?>
	<div id="r_key_defvalue" class="form-group">
		<label id="elh_phs_keys_key_defvalue" for="x_key_defvalue" class="<?php echo $phs_keys_edit->LeftColumnClass ?>"><?php echo $phs_keys->key_defvalue->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keys_edit->RightColumnClass ?>"><div<?php echo $phs_keys->key_defvalue->CellAttributes() ?>>
...
<input type="hidden" data-table="phs_keys" data-field="x_key_id" name="x_key_id" id="x_key_id" value="<?php echo ew_HtmlEncode($phs_keys->key_id->CurrentValue) ?>">
<?php
	if (in_array("phs_keyvalues", explode(",", $phs_keys->getCurrentDetailTable())) && $phs_keyvalues->DetailEdit) {
?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_keys_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_keys_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
