...
<?php if ($cpy_slider_trn->slid_order->Visible) { // slid_order ?>
	<div id="r_slid_order" class="form-group">
		<label id="elh_cpy_slider_trn_slid_order" for="x_slid_order" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($cpy_slider_trn->slid_label->Visible) { // slid_label ?>
	<div id="r_slid_label" class="form-group">
		<label id="elh_cpy_slider_trn_slid_label" for="x_slid_label" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_label->FldCaption() ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_label->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_slider_trnadd", "x_slid_text", 35, 8, <?php echo ($cpy_slider_trn->slid_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
