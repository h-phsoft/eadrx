...
//
// Table class for cpy_pgroup
//
class ccpy_pgroup extends cTable {
	var $pgrp_id;
	var $pgrp_name;
	...
	function __construct() {
		...
		$this->TableVar = 'cpy_pgroup';
		$this->TableName = 'cpy_pgroup';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`cpy_pgroup`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// pgrp_id
		$this->pgrp_id = new cField('cpy_pgroup', 'cpy_pgroup', 'x_pgrp_id', 'pgrp_id', '`pgrp_id`', '`pgrp_id`', 3, -1, FALSE, '`pgrp_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pgrp_name
		$this->pgrp_name = new cField('cpy_pgroup', 'cpy_pgroup', 'x_pgrp_name', 'pgrp_name', '`pgrp_name`', '`pgrp_name`', 200, -1, FALSE, '`pgrp_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cpy_pgroup`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "cpy_pgroupedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cpy_pgroupadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_pgroupview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_pgroupview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cpy_pgroupadd.php?" . $this->UrlParm($parm);
		else
			$url = "cpy_pgroupadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cpy_pgroupedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cpy_pgroupadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cpy_pgroupdelete.php", $this->UrlParm());
	}
