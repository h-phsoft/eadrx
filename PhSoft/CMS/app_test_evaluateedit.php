...
$app_test_evaluate_edit = NULL; // Initialize page object first

class capp_test_evaluate_edit extends capp_test_evaluate {
	...
	// Page object name
	var $PageObjName = 'app_test_evaluate_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_test_evaluatelist.php"); // Return to list page
			...
			if (!is_null($this->eval_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->eval_id->CurrentValue) == strval($this->Recordset->fields('eval_id'))) {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "app_test_evaluatelist.php")
...
// Create page object
if (!isset($app_test_evaluate_edit)) $app_test_evaluate_edit = new capp_test_evaluate_edit();

// Page init
$app_test_evaluate_edit->Page_Init();

// Page main
$app_test_evaluate_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_evaluate_edit->Page_Render();
?>
...
var CurrentForm = fapp_test_evaluateedit = new ew_Form("fapp_test_evaluateedit", "edit");

// Validate form
fapp_test_evaluateedit.Validate = function() {
...
fapp_test_evaluateedit.Form_CustomValidate = 
...
fapp_test_evaluateedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_evaluateedit.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_evaluateedit.Lists["x_test_id"].Data = "<?php echo $app_test_evaluate_edit->test_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_test_evaluateedit.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_test_evaluateedit.Lists["x_lang_id"].Data = "<?php echo $app_test_evaluate_edit->lang_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_test_evaluateedit.Lists["x_gend_id"] = {"LinkField":"x_gend_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gend_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_gender"};
fapp_test_evaluateedit.Lists["x_gend_id"].Data = "<?php echo $app_test_evaluate_edit->gend_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_test_evaluate_edit->ShowPageHeader(); ?>
<?php
$app_test_evaluate_edit->ShowMessage();
?>
<?php if (!$app_test_evaluate_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_test_evaluate_edit->Pager)) $app_test_evaluate_edit->Pager = new cPrevNextPager($app_test_evaluate_edit->StartRec, $app_test_evaluate_edit->DisplayRecs, $app_test_evaluate_edit->TotalRecs, $app_test_evaluate_edit->AutoHidePager) ?>
<?php if ($app_test_evaluate_edit->Pager->RecordCount > 0 && $app_test_evaluate_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_test_evaluate_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_test_evaluate_edit->PageUrl() ?>start=<?php echo $app_test_evaluate_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_test_evaluate_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_test_evaluate_edit->PageUrl() ?>start=<?php echo $app_test_evaluate_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_test_evaluate_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_test_evaluate_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_test_evaluate_edit->PageUrl() ?>start=<?php echo $app_test_evaluate_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_test_evaluate_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_test_evaluate_edit->PageUrl() ?>start=<?php echo $app_test_evaluate_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_test_evaluate_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_test_evaluateedit" id="fapp_test_evaluateedit" class="<?php echo $app_test_evaluate_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_evaluate_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_evaluate_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_evaluate">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_test_evaluate_edit->IsModal) ?>">
<?php if ($app_test_evaluate->getCurrentMasterTable() == "app_test") { ?>
...
<?php if ($app_test_evaluate->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label id="elh_app_test_evaluate_test_id" for="x_test_id" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->test_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->test_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_test_evaluate_lang_id" for="x_lang_id" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->lang_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->gend_id->Visible) { // gend_id ?>
	<div id="r_gend_id" class="form-group">
		<label id="elh_app_test_evaluate_gend_id" for="x_gend_id" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->gend_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->gend_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_from->Visible) { // eval_from ?>
	<div id="r_eval_from" class="form-group">
		<label id="elh_app_test_evaluate_eval_from" for="x_eval_from" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_from->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_from->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_to->Visible) { // eval_to ?>
	<div id="r_eval_to" class="form-group">
		<label id="elh_app_test_evaluate_eval_to" for="x_eval_to" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_to->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_to->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_text->Visible) { // eval_text ?>
	<div id="r_eval_text" class="form-group">
		<label id="elh_app_test_evaluate_eval_text" class="<?php echo $app_test_evaluate_edit->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_edit->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_test_evaluateedit", "x_eval_text", 35, 8, <?php echo ($app_test_evaluate->eval_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<input type="hidden" data-table="app_test_evaluate" data-field="x_eval_id" name="x_eval_id" id="x_eval_id" value="<?php echo ew_HtmlEncode($app_test_evaluate->eval_id->CurrentValue) ?>">
<?php if (!$app_test_evaluate_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_evaluate_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_test_evaluate_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_test_evaluateedit.Init();
</script>
<?php
$app_test_evaluate_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_evaluate_edit->Page_Terminate();
?>
