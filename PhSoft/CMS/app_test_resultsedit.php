...
$app_test_results_edit = NULL; // Initialize page object first

class capp_test_results_edit extends capp_test_results {
	...
	// Page object name
	var $PageObjName = 'app_test_results_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_test_resultslist.php"); // Return to list page
			...
			if (!is_null($this->res_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->res_id->CurrentValue) == strval($this->Recordset->fields('res_id'))) {
...
// Create page object
if (!isset($app_test_results_edit)) $app_test_results_edit = new capp_test_results_edit();

// Page init
$app_test_results_edit->Page_Init();

// Page main
$app_test_results_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_results_edit->Page_Render();
?>
...
var CurrentForm = fapp_test_resultsedit = new ew_Form("fapp_test_resultsedit", "edit");

// Validate form
fapp_test_resultsedit.Validate = function() {
...
fapp_test_resultsedit.Form_CustomValidate = 
...
fapp_test_resultsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_resultsedit.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_test_resultsedit.Lists["x_user_id"].Data = "<?php echo $app_test_results_edit->user_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_test_resultsedit.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_resultsedit.Lists["x_test_id"].Data = "<?php echo $app_test_results_edit->test_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_test_results_edit->ShowPageHeader(); ?>
<?php
$app_test_results_edit->ShowMessage();
?>
<?php if (!$app_test_results_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_test_results_edit->Pager)) $app_test_results_edit->Pager = new cPrevNextPager($app_test_results_edit->StartRec, $app_test_results_edit->DisplayRecs, $app_test_results_edit->TotalRecs, $app_test_results_edit->AutoHidePager) ?>
<?php if ($app_test_results_edit->Pager->RecordCount > 0 && $app_test_results_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_test_results_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_test_results_edit->PageUrl() ?>start=<?php echo $app_test_results_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_test_results_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_test_results_edit->PageUrl() ?>start=<?php echo $app_test_results_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_test_results_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_test_results_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_test_results_edit->PageUrl() ?>start=<?php echo $app_test_results_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_test_results_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_test_results_edit->PageUrl() ?>start=<?php echo $app_test_results_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_test_results_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_test_resultsedit" id="fapp_test_resultsedit" class="<?php echo $app_test_results_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_results_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_results_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_results">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_test_results_edit->IsModal) ?>">
...
<?php if ($app_test_results->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_test_results_user_id" for="x_user_id" class="<?php echo $app_test_results_edit->LeftColumnClass ?>"><?php echo $app_test_results->user_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_results_edit->RightColumnClass ?>"><div<?php echo $app_test_results->user_id->CellAttributes() ?>>
...
<?php if ($app_test_results->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label id="elh_app_test_results_test_id" for="x_test_id" class="<?php echo $app_test_results_edit->LeftColumnClass ?>"><?php echo $app_test_results->test_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_results_edit->RightColumnClass ?>"><div<?php echo $app_test_results->test_id->CellAttributes() ?>>
...
<?php if ($app_test_results->res_request->Visible) { // res_request ?>
	<div id="r_res_request" class="form-group">
		<label id="elh_app_test_results_res_request" for="x_res_request" class="<?php echo $app_test_results_edit->LeftColumnClass ?>"><?php echo $app_test_results->res_request->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_results_edit->RightColumnClass ?>"><div<?php echo $app_test_results->res_request->CellAttributes() ?>>
...
<?php if ($app_test_results->res_result->Visible) { // res_result ?>
	<div id="r_res_result" class="form-group">
		<label id="elh_app_test_results_res_result" for="x_res_result" class="<?php echo $app_test_results_edit->LeftColumnClass ?>"><?php echo $app_test_results->res_result->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_results_edit->RightColumnClass ?>"><div<?php echo $app_test_results->res_result->CellAttributes() ?>>
...
<input type="hidden" data-table="app_test_results" data-field="x_res_id" name="x_res_id" id="x_res_id" value="<?php echo ew_HtmlEncode($app_test_results->res_id->CurrentValue) ?>">
<?php if (!$app_test_results_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_results_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_test_results_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_test_resultsedit.Init();
</script>
<?php
$app_test_results_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_results_edit->Page_Terminate();
?>
