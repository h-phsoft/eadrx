...
$cpy_team_names_view = NULL; // Initialize page object first

class ccpy_team_names_view extends ccpy_team_names {
	...
	// Page object name
	var $PageObjName = 'cpy_team_names_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["teamn_id"] <> "") {
			$this->RecKey["teamn_id"] = $_GET["teamn_id"];
			$KeyUrl .= "&amp;teamn_id=" . urlencode($this->RecKey["teamn_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["teamn_id"] <> "") {
				...
				$this->RecKey["teamn_id"] = $this->teamn_id->QueryStringValue;
			} elseif (@$_POST["teamn_id"] <> "") {
				$this->teamn_id->setFormValue($_POST["teamn_id"]);
				$this->RecKey["teamn_id"] = $this->teamn_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "cpy_team_nameslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "cpy_team_nameslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cpy_team_names_view)) $cpy_team_names_view = new ccpy_team_names_view();

// Page init
$cpy_team_names_view->Page_Init();

// Page main
$cpy_team_names_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_team_names_view->Page_Render();
?>
...
var CurrentForm = fcpy_team_namesview = new ew_Form("fcpy_team_namesview", "view");

// Form_CustomValidate event
fcpy_team_namesview.Form_CustomValidate = 
...
fcpy_team_namesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_team_namesview.Lists["x_team_id"] = {"LinkField":"x_team_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_team_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_team"};
fcpy_team_namesview.Lists["x_team_id"].Data = "<?php echo $cpy_team_names_view->team_id->LookupFilterQuery(FALSE, "view") ?>";
fcpy_team_namesview.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_id","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fcpy_team_namesview.Lists["x_lang_id"].Data = "<?php echo $cpy_team_names_view->lang_id->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $cpy_team_names_view->ExportOptions->Render("body") ?>
<?php
	foreach ($cpy_team_names_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $cpy_team_names_view->ShowPageHeader(); ?>
<?php
$cpy_team_names_view->ShowMessage();
?>
<?php if (!$cpy_team_names_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($cpy_team_names_view->Pager)) $cpy_team_names_view->Pager = new cPrevNextPager($cpy_team_names_view->StartRec, $cpy_team_names_view->DisplayRecs, $cpy_team_names_view->TotalRecs, $cpy_team_names_view->AutoHidePager) ?>
<?php if ($cpy_team_names_view->Pager->RecordCount > 0 && $cpy_team_names_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cpy_team_names_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cpy_team_names_view->PageUrl() ?>start=<?php echo $cpy_team_names_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cpy_team_names_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cpy_team_names_view->PageUrl() ?>start=<?php echo $cpy_team_names_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cpy_team_names_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cpy_team_names_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cpy_team_names_view->PageUrl() ?>start=<?php echo $cpy_team_names_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cpy_team_names_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cpy_team_names_view->PageUrl() ?>start=<?php echo $cpy_team_names_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cpy_team_names_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcpy_team_namesview" id="fcpy_team_namesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_team_names_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_team_names_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_team_names">
<input type="hidden" name="modal" value="<?php echo intval($cpy_team_names_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($cpy_team_names->teamn_id->Visible) { // teamn_id ?>
	<tr id="r_teamn_id">
		<td class="col-sm-2"><span id="elh_cpy_team_names_teamn_id"><?php echo $cpy_team_names->teamn_id->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->teamn_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->team_id->Visible) { // team_id ?>
	<tr id="r_team_id">
		<td class="col-sm-2"><span id="elh_cpy_team_names_team_id"><?php echo $cpy_team_names->team_id->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->team_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->lang_id->Visible) { // lang_id ?>
	<tr id="r_lang_id">
		<td class="col-sm-2"><span id="elh_cpy_team_names_lang_id"><?php echo $cpy_team_names->lang_id->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->lang_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->team_name->Visible) { // team_name ?>
	<tr id="r_team_name">
		<td class="col-sm-2"><span id="elh_cpy_team_names_team_name"><?php echo $cpy_team_names->team_name->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->team_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->team_title->Visible) { // team_title ?>
	<tr id="r_team_title">
		<td class="col-sm-2"><span id="elh_cpy_team_names_team_title"><?php echo $cpy_team_names->team_title->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->team_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->team_position->Visible) { // team_position ?>
	<tr id="r_team_position">
		<td class="col-sm-2"><span id="elh_cpy_team_names_team_position"><?php echo $cpy_team_names->team_position->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->team_position->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cpy_team_names->team_text->Visible) { // team_text ?>
	<tr id="r_team_text">
		<td class="col-sm-2"><span id="elh_cpy_team_names_team_text"><?php echo $cpy_team_names->team_text->FldCaption() ?></span></td>
...
<?php echo $cpy_team_names->team_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fcpy_team_namesview.Init();
</script>
<?php
$cpy_team_names_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_team_names_view->Page_Terminate();
?>
