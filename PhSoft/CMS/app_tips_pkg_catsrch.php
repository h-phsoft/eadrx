...
$app_tips_pkg_cat_search = NULL; // Initialize page object first

class capp_tips_pkg_cat_search extends capp_tips_pkg_cat {
	...
	// Page object name
	var $PageObjName = 'app_tips_pkg_cat_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "app_tips_pkg_catlist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		$sSrchUrl = "";
		$this->BuildSearchUrl($sSrchUrl, $this->pkg_id); // pkg_id
	...
	function LoadSearchValues() {
		...
		$this->pkg_id->AdvancedSearch->SearchValue = $objForm->GetValue("x_pkg_id");
		$this->pkg_id->AdvancedSearch->SearchOperator = $objForm->GetValue("z_pkg_id");
	...
	function RenderRow() {
		...
		$this->tcat_id->ViewCustomAttributes = "";
			...
			if (trim(strval($this->pkg_id->AdvancedSearch->SearchValue)) == "") {
				$sFilterWrk = "0=1";
			} else {
				$sFilterWrk = "`pkg_id`" . ew_SearchString("=", $this->pkg_id->AdvancedSearch->SearchValue, EW_DATATYPE_NUMBER, "");
			}
...
// Create page object
if (!isset($app_tips_pkg_cat_search)) $app_tips_pkg_cat_search = new capp_tips_pkg_cat_search();

// Page init
$app_tips_pkg_cat_search->Page_Init();

// Page main
$app_tips_pkg_cat_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_tips_pkg_cat_search->Page_Render();
?>
...
<?php if ($app_tips_pkg_cat_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fapp_tips_pkg_catsearch = new ew_Form("fapp_tips_pkg_catsearch", "search");
<?php } else { ?>
var CurrentForm = fapp_tips_pkg_catsearch = new ew_Form("fapp_tips_pkg_catsearch", "search");
<?php } ?>

// Form_CustomValidate event
fapp_tips_pkg_catsearch.Form_CustomValidate = 
...
fapp_tips_pkg_catsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_tips_pkg_catsearch.Lists["x_pkg_id"] = {"LinkField":"x_pkg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pkg_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_package"};
fapp_tips_pkg_catsearch.Lists["x_pkg_id"].Data = "<?php echo $app_tips_pkg_cat_search->pkg_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_tips_pkg_catsearch.Lists["x_tcat_id"] = {"LinkField":"x_tcat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tcat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_category"};
fapp_tips_pkg_catsearch.Lists["x_tcat_id"].Data = "<?php echo $app_tips_pkg_cat_search->tcat_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fapp_tips_pkg_catsearch.Validate = function(fobj) {
...
<?php $app_tips_pkg_cat_search->ShowPageHeader(); ?>
<?php
$app_tips_pkg_cat_search->ShowMessage();
?>
<form name="fapp_tips_pkg_catsearch" id="fapp_tips_pkg_catsearch" class="<?php echo $app_tips_pkg_cat_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_tips_pkg_cat_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_tips_pkg_cat_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_tips_pkg_cat">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($app_tips_pkg_cat_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($app_tips_pkg_cat->pkg_id->Visible) { // pkg_id ?>
	<div id="r_pkg_id" class="form-group">
		<label for="x_pkg_id" class="<?php echo $app_tips_pkg_cat_search->LeftColumnClass ?>"><span id="elh_app_tips_pkg_cat_pkg_id"><?php echo $app_tips_pkg_cat->pkg_id->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_pkg_id" id="z_pkg_id" value="="></p>
		</label>
		<div class="<?php echo $app_tips_pkg_cat_search->RightColumnClass ?>"><div<?php echo $app_tips_pkg_cat->pkg_id->CellAttributes() ?>>
...
<?php if ($app_tips_pkg_cat->tcat_id->Visible) { // tcat_id ?>
	<div id="r_tcat_id" class="form-group">
		<label for="x_tcat_id" class="<?php echo $app_tips_pkg_cat_search->LeftColumnClass ?>"><span id="elh_app_tips_pkg_cat_tcat_id"><?php echo $app_tips_pkg_cat->tcat_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_tips_pkg_cat_search->RightColumnClass ?>"><div<?php echo $app_tips_pkg_cat->tcat_id->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_tips_pkg_cat_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fapp_tips_pkg_catsearch.Init();
</script>
<?php
$app_tips_pkg_cat_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_tips_pkg_cat_search->Page_Terminate();
?>
