...
//
// Table class for app_test_name
//
class capp_test_name extends cTable {
	var $ntest_id;
	var $test_id;
	var $lang_id;
	var $test_name;
	...
	function __construct() {
		...
		$this->TableVar = 'app_test_name';
		$this->TableName = 'app_test_name';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_test_name`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ntest_id
		$this->ntest_id = new cField('app_test_name', 'app_test_name', 'x_ntest_id', 'ntest_id', '`ntest_id`', '`ntest_id`', 3, -1, FALSE, '`ntest_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// test_id
		$this->test_id = new cField('app_test_name', 'app_test_name', 'x_test_id', 'test_id', '`test_id`', '`test_id`', 3, -1, FALSE, '`test_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// lang_id
		$this->lang_id = new cField('app_test_name', 'app_test_name', 'x_lang_id', 'lang_id', '`lang_id`', '`lang_id`', 3, -1, FALSE, '`lang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// test_name
		$this->test_name = new cField('app_test_name', 'app_test_name', 'x_test_name', 'test_name', '`test_name`', '`test_name`', 200, -1, FALSE, '`test_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->test_name->Sortable = TRUE; // Allow sort
		$this->fields['test_name'] = &$this->test_name;

		// test_desc
		$this->test_desc = new cField('app_test_name', 'app_test_name', 'x_test_desc', 'test_desc', '`test_desc`', '`test_desc`', 201, -1, FALSE, '`test_desc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_test_name`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`test_id` ASC,`lang_id` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_test_nameedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_test_nameadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_test_nameview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_test_nameview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_test_nameadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_test_nameadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("app_test_nameedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("app_test_nameadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_test_namedelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["ntest_id"]))
				$arKeys[] = $_POST["ntest_id"];
			elseif (isset($_GET["ntest_id"]))
				$arKeys[] = $_GET["ntest_id"];
			else
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->ntest_id->CurrentValue = $key;
