...
$app_test_evaluate_view = NULL; // Initialize page object first

class capp_test_evaluate_view extends capp_test_evaluate {
	...
	// Page object name
	var $PageObjName = 'app_test_evaluate_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["eval_id"] <> "") {
			$this->RecKey["eval_id"] = $_GET["eval_id"];
			$KeyUrl .= "&amp;eval_id=" . urlencode($this->RecKey["eval_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["eval_id"] <> "") {
				...
				$this->RecKey["eval_id"] = $this->eval_id->QueryStringValue;
			} elseif (@$_POST["eval_id"] <> "") {
				$this->eval_id->setFormValue($_POST["eval_id"]);
				$this->RecKey["eval_id"] = $this->eval_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "app_test_evaluatelist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "app_test_evaluatelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($app_test_evaluate_view)) $app_test_evaluate_view = new capp_test_evaluate_view();

// Page init
$app_test_evaluate_view->Page_Init();

// Page main
$app_test_evaluate_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_evaluate_view->Page_Render();
?>
...
var CurrentForm = fapp_test_evaluateview = new ew_Form("fapp_test_evaluateview", "view");

// Form_CustomValidate event
fapp_test_evaluateview.Form_CustomValidate = 
...
fapp_test_evaluateview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_evaluateview.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_evaluateview.Lists["x_test_id"].Data = "<?php echo $app_test_evaluate_view->test_id->LookupFilterQuery(FALSE, "view") ?>";
fapp_test_evaluateview.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_test_evaluateview.Lists["x_lang_id"].Data = "<?php echo $app_test_evaluate_view->lang_id->LookupFilterQuery(FALSE, "view") ?>";
fapp_test_evaluateview.Lists["x_gend_id"] = {"LinkField":"x_gend_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gend_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_gender"};
fapp_test_evaluateview.Lists["x_gend_id"].Data = "<?php echo $app_test_evaluate_view->gend_id->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $app_test_evaluate_view->ExportOptions->Render("body") ?>
<?php
	foreach ($app_test_evaluate_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $app_test_evaluate_view->ShowPageHeader(); ?>
<?php
$app_test_evaluate_view->ShowMessage();
?>
<?php if (!$app_test_evaluate_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_test_evaluate_view->Pager)) $app_test_evaluate_view->Pager = new cPrevNextPager($app_test_evaluate_view->StartRec, $app_test_evaluate_view->DisplayRecs, $app_test_evaluate_view->TotalRecs, $app_test_evaluate_view->AutoHidePager) ?>
<?php if ($app_test_evaluate_view->Pager->RecordCount > 0 && $app_test_evaluate_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_test_evaluate_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_test_evaluate_view->PageUrl() ?>start=<?php echo $app_test_evaluate_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_test_evaluate_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_test_evaluate_view->PageUrl() ?>start=<?php echo $app_test_evaluate_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_test_evaluate_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_test_evaluate_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_test_evaluate_view->PageUrl() ?>start=<?php echo $app_test_evaluate_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_test_evaluate_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_test_evaluate_view->PageUrl() ?>start=<?php echo $app_test_evaluate_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_test_evaluate_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_test_evaluateview" id="fapp_test_evaluateview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_evaluate_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_evaluate_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_evaluate">
<input type="hidden" name="modal" value="<?php echo intval($app_test_evaluate_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($app_test_evaluate->test_id->Visible) { // test_id ?>
	<tr id="r_test_id">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_test_id"><?php echo $app_test_evaluate->test_id->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->test_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_test_evaluate->lang_id->Visible) { // lang_id ?>
	<tr id="r_lang_id">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_lang_id"><?php echo $app_test_evaluate->lang_id->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->lang_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_test_evaluate->gend_id->Visible) { // gend_id ?>
	<tr id="r_gend_id">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_gend_id"><?php echo $app_test_evaluate->gend_id->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->gend_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_test_evaluate->eval_from->Visible) { // eval_from ?>
	<tr id="r_eval_from">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_eval_from"><?php echo $app_test_evaluate->eval_from->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->eval_from->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_test_evaluate->eval_to->Visible) { // eval_to ?>
	<tr id="r_eval_to">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_eval_to"><?php echo $app_test_evaluate->eval_to->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->eval_to->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_test_evaluate->eval_text->Visible) { // eval_text ?>
	<tr id="r_eval_text">
		<td class="col-sm-2"><span id="elh_app_test_evaluate_eval_text"><?php echo $app_test_evaluate->eval_text->FldCaption() ?></span></td>
...
<?php echo $app_test_evaluate->eval_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fapp_test_evaluateview.Init();
</script>
<?php
$app_test_evaluate_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_evaluate_view->Page_Terminate();
?>
