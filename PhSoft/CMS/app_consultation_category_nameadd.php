...
$app_consultation_category_name_add = NULL; // Initialize page object first

class capp_consultation_category_name_add extends capp_consultation_category_name {
	...
	// Page object name
	var $PageObjName = 'app_consultation_category_name_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("app_consultation_category_namelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "app_consultation_category_nameview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// cat_desc
		$this->cat_desc->SetDbValueDef($rsnew, $this->cat_desc->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($app_consultation_category_name_add)) $app_consultation_category_name_add = new capp_consultation_category_name_add();

// Page init
$app_consultation_category_name_add->Page_Init();

// Page main
$app_consultation_category_name_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_consultation_category_name_add->Page_Render();
?>
...
var CurrentForm = fapp_consultation_category_nameadd = new ew_Form("fapp_consultation_category_nameadd", "add");

// Validate form
fapp_consultation_category_nameadd.Validate = function() {
...
fapp_consultation_category_nameadd.Form_CustomValidate = 
...
fapp_consultation_category_nameadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_consultation_category_nameadd.Lists["x_cat_id"] = {"LinkField":"x_cat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_consultation_category"};
fapp_consultation_category_nameadd.Lists["x_cat_id"].Data = "<?php echo $app_consultation_category_name_add->cat_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_consultation_category_nameadd.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_consultation_category_nameadd.Lists["x_lang_id"].Data = "<?php echo $app_consultation_category_name_add->lang_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $app_consultation_category_name_add->ShowPageHeader(); ?>
<?php
$app_consultation_category_name_add->ShowMessage();
?>
<form name="fapp_consultation_category_nameadd" id="fapp_consultation_category_nameadd" class="<?php echo $app_consultation_category_name_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_consultation_category_name_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_consultation_category_name_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_consultation_category_name">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($app_consultation_category_name_add->IsModal) ?>">
...
<?php if ($app_consultation_category_name->cat_id->Visible) { // cat_id ?>
	<div id="r_cat_id" class="form-group">
		<label id="elh_app_consultation_category_name_cat_id" for="x_cat_id" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->cat_id->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_name_add->RightColumnClass ?>"><div<?php echo $app_consultation_category_name->cat_id->CellAttributes() ?>>
...
<?php if ($app_consultation_category_name->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_consultation_category_name_lang_id" for="x_lang_id" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->lang_id->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_name_add->RightColumnClass ?>"><div<?php echo $app_consultation_category_name->lang_id->CellAttributes() ?>>
...
<?php if ($app_consultation_category_name->cat_name->Visible) { // cat_name ?>
	<div id="r_cat_name" class="form-group">
		<label id="elh_app_consultation_category_name_cat_name" for="x_cat_name" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->cat_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_consultation_category_name_add->RightColumnClass ?>"><div<?php echo $app_consultation_category_name->cat_name->CellAttributes() ?>>
...
<?php if ($app_consultation_category_name->cat_desc->Visible) { // cat_desc ?>
	<div id="r_cat_desc" class="form-group">
		<label id="elh_app_consultation_category_name_cat_desc" for="x_cat_desc" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->cat_desc->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_name_add->RightColumnClass ?>"><div<?php echo $app_consultation_category_name->cat_desc->CellAttributes() ?>>
...
<?php if (!$app_consultation_category_name_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_consultation_category_name_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_consultation_category_name_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fapp_consultation_category_nameadd.Init();
</script>
<?php
$app_consultation_category_name_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_consultation_category_name_add->Page_Terminate();
?>
