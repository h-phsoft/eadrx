...
<?php if ($app_consultation_category_name->cat_id->Visible) { // cat_id ?>
	<div id="r_cat_id" class="form-group">
		<label id="elh_app_consultation_category_name_cat_id" for="x_cat_id" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->cat_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($app_consultation_category_name->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_consultation_category_name_lang_id" for="x_lang_id" class="<?php echo $app_consultation_category_name_add->LeftColumnClass ?>"><?php echo $app_consultation_category_name->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
