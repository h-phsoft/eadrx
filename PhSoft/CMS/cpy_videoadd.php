...
<?php if ($cpy_video->video_name->Visible) { // video_name ?>
	<div id="r_video_name" class="form-group">
		<label id="elh_cpy_video_video_name" for="x_video_name" class="<?php echo $cpy_video_add->LeftColumnClass ?>"><?php echo $cpy_video->video_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_video_add->RightColumnClass ?>"><div<?php echo $cpy_video->video_name->CellAttributes() ?>>
