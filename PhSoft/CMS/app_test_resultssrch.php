...
$app_test_results_search = NULL; // Initialize page object first

class capp_test_results_search extends capp_test_results {
	...
	// Page object name
	var $PageObjName = 'app_test_results_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "app_test_resultslist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->res_request); // res_request
		$this->BuildSearchUrl($sSrchUrl, $this->res_result); // res_result
	...
	function LoadSearchValues() {
		...
		// res_request
		$this->res_request->AdvancedSearch->SearchValue = $objForm->GetValue("x_res_request");
		$this->res_request->AdvancedSearch->SearchOperator = $objForm->GetValue("z_res_request");

		// res_result
		$this->res_result->AdvancedSearch->SearchValue = $objForm->GetValue("x_res_result");
		$this->res_result->AdvancedSearch->SearchOperator = $objForm->GetValue("z_res_result");
	...
	function RenderRow() {
		...
		$this->ins_datetime->ViewCustomAttributes = "";
			...
			$this->res_request->EditValue = ew_HtmlEncode($this->res_request->AdvancedSearch->SearchValue);
			...
			$this->res_result->EditValue = ew_HtmlEncode($this->res_result->AdvancedSearch->SearchValue);
...
// Create page object
if (!isset($app_test_results_search)) $app_test_results_search = new capp_test_results_search();

// Page init
$app_test_results_search->Page_Init();

// Page main
$app_test_results_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_results_search->Page_Render();
?>
...
<?php if ($app_test_results_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fapp_test_resultssearch = new ew_Form("fapp_test_resultssearch", "search");
<?php } else { ?>
var CurrentForm = fapp_test_resultssearch = new ew_Form("fapp_test_resultssearch", "search");
<?php } ?>

// Form_CustomValidate event
fapp_test_resultssearch.Form_CustomValidate = 
...
fapp_test_resultssearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_resultssearch.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_test_resultssearch.Lists["x_user_id"].Data = "<?php echo $app_test_results_search->user_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_test_resultssearch.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_resultssearch.Lists["x_test_id"].Data = "<?php echo $app_test_results_search->test_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fapp_test_resultssearch.Validate = function(fobj) {
...
<?php $app_test_results_search->ShowPageHeader(); ?>
<?php
$app_test_results_search->ShowMessage();
?>
<form name="fapp_test_resultssearch" id="fapp_test_resultssearch" class="<?php echo $app_test_results_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_results_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_results_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_results">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($app_test_results_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($app_test_results->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label for="x_user_id" class="<?php echo $app_test_results_search->LeftColumnClass ?>"><span id="elh_app_test_results_user_id"><?php echo $app_test_results->user_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_test_results_search->RightColumnClass ?>"><div<?php echo $app_test_results->user_id->CellAttributes() ?>>
...
<?php if ($app_test_results->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label for="x_test_id" class="<?php echo $app_test_results_search->LeftColumnClass ?>"><span id="elh_app_test_results_test_id"><?php echo $app_test_results->test_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_test_results_search->RightColumnClass ?>"><div<?php echo $app_test_results->test_id->CellAttributes() ?>>
...
<?php if ($app_test_results->res_request->Visible) { // res_request ?>
	<div id="r_res_request" class="form-group">
		<label for="x_res_request" class="<?php echo $app_test_results_search->LeftColumnClass ?>"><span id="elh_app_test_results_res_request"><?php echo $app_test_results->res_request->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_res_request" id="z_res_request" value="LIKE"></p>
		</label>
		<div class="<?php echo $app_test_results_search->RightColumnClass ?>"><div<?php echo $app_test_results->res_request->CellAttributes() ?>>
			<span id="el_app_test_results_res_request">
<input type="text" data-table="app_test_results" data-field="x_res_request" name="x_res_request" id="x_res_request" size="35" placeholder="<?php echo ew_HtmlEncode($app_test_results->res_request->getPlaceHolder()) ?>" value="<?php echo $app_test_results->res_request->EditValue ?>"<?php echo $app_test_results->res_request->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($app_test_results->res_result->Visible) { // res_result ?>
	<div id="r_res_result" class="form-group">
		<label for="x_res_result" class="<?php echo $app_test_results_search->LeftColumnClass ?>"><span id="elh_app_test_results_res_result"><?php echo $app_test_results->res_result->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_res_result" id="z_res_result" value="LIKE"></p>
		</label>
		<div class="<?php echo $app_test_results_search->RightColumnClass ?>"><div<?php echo $app_test_results->res_result->CellAttributes() ?>>
			<span id="el_app_test_results_res_result">
<input type="text" data-table="app_test_results" data-field="x_res_result" name="x_res_result" id="x_res_result" size="35" placeholder="<?php echo ew_HtmlEncode($app_test_results->res_result->getPlaceHolder()) ?>" value="<?php echo $app_test_results->res_result->EditValue ?>"<?php echo $app_test_results->res_result->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($app_test_results->ins_datetime->Visible) { // ins_datetime ?>
	<div id="r_ins_datetime" class="form-group">
		<label for="x_ins_datetime" class="<?php echo $app_test_results_search->LeftColumnClass ?>"><span id="elh_app_test_results_ins_datetime"><?php echo $app_test_results->ins_datetime->FldCaption() ?></span>
		...
		<div class="<?php echo $app_test_results_search->RightColumnClass ?>"><div<?php echo $app_test_results->ins_datetime->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_results_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fapp_test_resultssearch.Init();
</script>
<?php
$app_test_results_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_results_search->Page_Terminate();
?>
