...
<?php if ($app_consultation_category->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_app_consultation_category_status_id" for="x_status_id" class="<?php echo $app_consultation_category_add->LeftColumnClass ?>"><?php echo $app_consultation_category->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
