...
$app_consultation_category = NULL;

//
// Table class for app_consultation_category
//
class capp_consultation_category extends cTable {
	var $cat_id;
	var $status_id;
	var $cat_order;
	var $cat_name;
	...
	function __construct() {
		...
		$this->TableVar = 'app_consultation_category';
		$this->TableName = 'app_consultation_category';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_consultation_category`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// cat_id
		$this->cat_id = new cField('app_consultation_category', 'app_consultation_category', 'x_cat_id', 'cat_id', '`cat_id`', '`cat_id`', 3, -1, FALSE, '`cat_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// status_id
		$this->status_id = new cField('app_consultation_category', 'app_consultation_category', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// cat_order
		$this->cat_order = new cField('app_consultation_category', 'app_consultation_category', 'x_cat_order', 'cat_order', '`cat_order`', '`cat_order`', 16, -1, FALSE, '`cat_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cat_order->Sortable = TRUE; // Allow sort
		$this->cat_order->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cat_order'] = &$this->cat_order;

		// cat_name
		$this->cat_name = new cField('app_consultation_category', 'app_consultation_category', 'x_cat_name', 'cat_name', '`cat_name`', '`cat_name`', 200, -1, FALSE, '`cat_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cat_name->Sortable = TRUE; // Allow sort
		$this->fields['cat_name'] = &$this->cat_name;

		// cat_Price
		$this->cat_Price = new cField('app_consultation_category', 'app_consultation_category', 'x_cat_Price', 'cat_Price', '`cat_Price`', '`cat_Price`', 131, -1, FALSE, '`cat_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "app_consultation_category_name") {
			$sDetailUrl = $GLOBALS["app_consultation_category_name"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_cat_id=" . urlencode($this->cat_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "app_consultation_categorylist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_consultation_category`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "app_consultation_categorylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_consultation_categoryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_consultation_categoryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_consultation_categoryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_consultation_categoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_consultation_categoryadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_consultation_categoryadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_consultation_categoryedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_consultation_categoryedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_consultation_categoryadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_consultation_categoryadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_consultation_categorydelete.php", $this->UrlParm());
	}
