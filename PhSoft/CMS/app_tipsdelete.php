...
$app_tips_delete = NULL; // Initialize page object first

class capp_tips_delete extends capp_tips {
	...
	// Page object name
	var $PageObjName = 'app_tips_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("app_tipslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in app_tips class, app_tipsinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("app_tipslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($app_tips_delete)) $app_tips_delete = new capp_tips_delete();

// Page init
$app_tips_delete->Page_Init();

// Page main
$app_tips_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_tips_delete->Page_Render();
?>
...
var CurrentForm = fapp_tipsdelete = new ew_Form("fapp_tipsdelete", "delete");

// Form_CustomValidate event
fapp_tipsdelete.Form_CustomValidate = 
...
fapp_tipsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_tipsdelete.Lists["x_tcat_id"] = {"LinkField":"x_tcat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tcat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_category"};
fapp_tipsdelete.Lists["x_tcat_id"].Data = "<?php echo $app_tips_delete->tcat_id->LookupFilterQuery(FALSE, "delete") ?>";
fapp_tipsdelete.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_tipsdelete.Lists["x_lang_id"].Data = "<?php echo $app_tips_delete->lang_id->LookupFilterQuery(FALSE, "delete") ?>";
fapp_tipsdelete.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fapp_tipsdelete.Lists["x_status_id"].Data = "<?php echo $app_tips_delete->status_id->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php $app_tips_delete->ShowPageHeader(); ?>
<?php
$app_tips_delete->ShowMessage();
?>
<form name="fapp_tipsdelete" id="fapp_tipsdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_tips_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_tips_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_tips">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($app_tips_delete->RecKeys as $key) { ?>
...
<?php if ($app_tips->tcat_id->Visible) { // tcat_id ?>
		<th class="<?php echo $app_tips->tcat_id->HeaderCellClass() ?>"><span id="elh_app_tips_tcat_id" class="app_tips_tcat_id"><?php echo $app_tips->tcat_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_tips->lang_id->Visible) { // lang_id ?>
		<th class="<?php echo $app_tips->lang_id->HeaderCellClass() ?>"><span id="elh_app_tips_lang_id" class="app_tips_lang_id"><?php echo $app_tips->lang_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_tips->status_id->Visible) { // status_id ?>
		<th class="<?php echo $app_tips->status_id->HeaderCellClass() ?>"><span id="elh_app_tips_status_id" class="app_tips_status_id"><?php echo $app_tips->status_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_tips->tips_text->Visible) { // tips_text ?>
		<th class="<?php echo $app_tips->tips_text->HeaderCellClass() ?>"><span id="elh_app_tips_tips_text" class="app_tips_tips_text"><?php echo $app_tips->tips_text->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_tips->ins_datetime->Visible) { // ins_datetime ?>
		<th class="<?php echo $app_tips->ins_datetime->HeaderCellClass() ?>"><span id="elh_app_tips_ins_datetime" class="app_tips_ins_datetime"><?php echo $app_tips->ins_datetime->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$app_tips_delete->RecCnt = 0;
$i = 0;
while (!$app_tips_delete->Recordset->EOF) {
	$app_tips_delete->RecCnt++;
	$app_tips_delete->RowCnt++;

	// Set row properties
	$app_tips->ResetAttrs();
	$app_tips->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$app_tips_delete->LoadRowValues($app_tips_delete->Recordset);

	// Render row
	$app_tips_delete->RenderRow();
?>
	<tr<?php echo $app_tips->RowAttributes() ?>>
<?php if ($app_tips->tcat_id->Visible) { // tcat_id ?>
		<td<?php echo $app_tips->tcat_id->CellAttributes() ?>>
<span id="el<?php echo $app_tips_delete->RowCnt ?>_app_tips_tcat_id" class="app_tips_tcat_id">
...
<?php } ?>
<?php if ($app_tips->lang_id->Visible) { // lang_id ?>
		<td<?php echo $app_tips->lang_id->CellAttributes() ?>>
<span id="el<?php echo $app_tips_delete->RowCnt ?>_app_tips_lang_id" class="app_tips_lang_id">
...
<?php } ?>
<?php if ($app_tips->status_id->Visible) { // status_id ?>
		<td<?php echo $app_tips->status_id->CellAttributes() ?>>
<span id="el<?php echo $app_tips_delete->RowCnt ?>_app_tips_status_id" class="app_tips_status_id">
...
<?php } ?>
<?php if ($app_tips->tips_text->Visible) { // tips_text ?>
		<td<?php echo $app_tips->tips_text->CellAttributes() ?>>
<span id="el<?php echo $app_tips_delete->RowCnt ?>_app_tips_tips_text" class="app_tips_tips_text">
...
<?php } ?>
<?php if ($app_tips->ins_datetime->Visible) { // ins_datetime ?>
		<td<?php echo $app_tips->ins_datetime->CellAttributes() ?>>
<span id="el<?php echo $app_tips_delete->RowCnt ?>_app_tips_ins_datetime" class="app_tips_ins_datetime">
...
<?php
	$app_tips_delete->Recordset->MoveNext();
}
$app_tips_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_tips_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fapp_tipsdelete.Init();
</script>
<?php
$app_tips_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_tips_delete->Page_Terminate();
?>
