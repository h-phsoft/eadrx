...
$app_consultation_category_name_grid = NULL; // Initialize page object first

class capp_consultation_category_name_grid extends capp_consultation_category_name {
	...
	// Page object name
	var $PageObjName = 'app_consultation_category_name_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_consultation_category_namegrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_consultation_category_name"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->ncat_id->CurrentValue = strval($arKeys[0]); // ncat_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "app_consultation_category") {
			...
			if ($GLOBALS["app_consultation_category"]->EventCancelled) $this->EventCancelled = TRUE;
		}
