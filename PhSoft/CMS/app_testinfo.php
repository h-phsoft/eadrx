...
//
// Table class for app_test
//
class capp_test extends cTable {
	var $test_id;
	var $status_id;
	var $test_num;
	var $test_iname;
	...
	function __construct() {
		...
		$this->TableVar = 'app_test';
		$this->TableName = 'app_test';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_test`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// test_id
		$this->test_id = new cField('app_test', 'app_test', 'x_test_id', 'test_id', '`test_id`', '`test_id`', 3, -1, FALSE, '`test_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// status_id
		$this->status_id = new cField('app_test', 'app_test', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// test_num
		$this->test_num = new cField('app_test', 'app_test', 'x_test_num', 'test_num', '`test_num`', '`test_num`', 16, -1, FALSE, '`test_num`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// test_iname
		$this->test_iname = new cField('app_test', 'app_test', 'x_test_iname', 'test_iname', '`test_iname`', '`test_iname`', 200, -1, FALSE, '`test_iname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->test_iname->Sortable = TRUE; // Allow sort
		$this->fields['test_iname'] = &$this->test_iname;

		// test_price
		$this->test_price = new cField('app_test', 'app_test', 'x_test_price', 'test_price', '`test_price`', '`test_price`', 131, -1, FALSE, '`test_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// test_image
		$this->test_image = new cField('app_test', 'app_test', 'x_test_image', 'test_image', '`test_image`', '`test_image`', 200, -1, TRUE, '`test_image`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "app_test_name") {
			$sDetailUrl = $GLOBALS["app_test_name"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_test_id=" . urlencode($this->test_id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "app_test_question") {
			$sDetailUrl = $GLOBALS["app_test_question"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_test_id=" . urlencode($this->test_id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "app_test_evaluate") {
			$sDetailUrl = $GLOBALS["app_test_evaluate"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_test_id=" . urlencode($this->test_id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "app_test_results") {
			$sDetailUrl = $GLOBALS["app_test_results"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_test_id=" . urlencode($this->test_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "app_testlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_test`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`test_num` ASC,`test_id` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_testedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_testadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_testview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_testview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_testadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_testadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_testedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_testedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_testadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_testadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_testdelete.php", $this->UrlParm());
	}
