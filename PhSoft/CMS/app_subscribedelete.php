...
fapp_subscribedelete.Lists["x_pkg_id"] = {"LinkField":"x_pkg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pkg_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_package"};
fapp_subscribedelete.Lists["x_pkg_id"].Data = "<?php echo $app_subscribe_delete->pkg_id->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
		<th class="<?php echo $app_subscribe->pkg_id->HeaderCellClass() ?>"><span id="elh_app_subscribe_pkg_id" class="app_subscribe_pkg_id"><?php echo $app_subscribe->pkg_id->FldCaption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $app_subscribe_delete->RowCnt ?>_app_subscribe_pkg_id" class="app_subscribe_pkg_id">
