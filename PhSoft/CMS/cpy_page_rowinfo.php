...
//
// Table class for cpy_page_row
//
class ccpy_page_row extends cTable {
	var $row_id;
	var $page_id;
	var $lang_id;
	var $status_id;
	...
	function __construct() {
		...
		$this->TableVar = 'cpy_page_row';
		$this->TableName = 'cpy_page_row';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`cpy_page_row`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// row_id
		$this->row_id = new cField('cpy_page_row', 'cpy_page_row', 'x_row_id', 'row_id', '`row_id`', '`row_id`', 3, -1, FALSE, '`row_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// page_id
		$this->page_id = new cField('cpy_page_row', 'cpy_page_row', 'x_page_id', 'page_id', '`page_id`', '`page_id`', 3, -1, FALSE, '`page_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// lang_id
		$this->lang_id = new cField('cpy_page_row', 'cpy_page_row', 'x_lang_id', 'lang_id', '`lang_id`', '`lang_id`', 3, -1, FALSE, '`lang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status_id
		$this->status_id = new cField('cpy_page_row', 'cpy_page_row', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// color_id
		$this->color_id = new cField('cpy_page_row', 'cpy_page_row', 'x_color_id', 'color_id', '`color_id`', '`color_id`', 16, -1, FALSE, '`color_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// slid_id
		$this->slid_id = new cField('cpy_page_row', 'cpy_page_row', 'x_slid_id', 'slid_id', '`slid_id`', '`slid_id`', 3, -1, FALSE, '`slid_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// row_order
		$this->row_order = new cField('cpy_page_row', 'cpy_page_row', 'x_row_order', 'row_order', '`row_order`', '`row_order`', 2, -1, FALSE, '`row_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->row_order->Sortable = TRUE; // Allow sort
		$this->row_order->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['row_order'] = &$this->row_order;

		// row_name
		$this->row_name = new cField('cpy_page_row', 'cpy_page_row', 'x_row_name', 'row_name', '`row_name`', '`row_name`', 200, -1, FALSE, '`row_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->row_name->Sortable = TRUE; // Allow sort
		$this->fields['row_name'] = &$this->row_name;

		// row_stext
		$this->row_stext = new cField('cpy_page_row', 'cpy_page_row', 'x_row_stext', 'row_stext', '`row_stext`', '`row_stext`', 201, -1, FALSE, '`row_stext`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->row_stext->Sortable = TRUE; // Allow sort
		$this->fields['row_stext'] = &$this->row_stext;
	}
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cpy_page_row_block") {
			$sDetailUrl = $GLOBALS["cpy_page_row_block"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_row_id=" . urlencode($this->row_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "cpy_page_rowlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cpy_page_row`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`page_id` ASC,`lang_id` ASC,`row_order` ASC,`row_id` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "cpy_page_rowedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cpy_page_rowadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_page_rowview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_page_rowview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cpy_page_rowadd.php?" . $this->UrlParm($parm);
		else
			$url = "cpy_page_rowadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_page_rowedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_page_rowedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_page_rowadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_page_rowadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cpy_page_rowdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->row_order->setDbValue($rs->fields('row_order'));
		$this->row_name->setDbValue($rs->fields('row_name'));
		$this->row_stext->setDbValue($rs->fields('row_stext'));
	}
	...
	function RenderEditRow() {
		...
		$this->row_order->EditValue = $this->row_order->CurrentValue;
		...
		$this->row_name->EditValue = $this->row_name->CurrentValue;
		...
		$this->row_stext->EditValue = $this->row_stext->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->row_order->Exportable) $Doc->ExportCaption($this->row_order);
					if ($this->row_name->Exportable) $Doc->ExportCaption($this->row_name);
					if ($this->row_stext->Exportable) $Doc->ExportCaption($this->row_stext);
				} else {
					if ($this->page_id->Exportable) $Doc->ExportCaption($this->page_id);
					if ($this->lang_id->Exportable) $Doc->ExportCaption($this->lang_id);
					if ($this->status_id->Exportable) $Doc->ExportCaption($this->status_id);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->row_order->Exportable) $Doc->ExportField($this->row_order);
						if ($this->row_name->Exportable) $Doc->ExportField($this->row_name);
						if ($this->row_stext->Exportable) $Doc->ExportField($this->row_stext);
					} else {
						if ($this->page_id->Exportable) $Doc->ExportField($this->page_id);
						if ($this->lang_id->Exportable) $Doc->ExportField($this->lang_id);
						if ($this->status_id->Exportable) $Doc->ExportField($this->status_id);
