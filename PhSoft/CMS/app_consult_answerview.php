...
$app_consult_answer_view = NULL; // Initialize page object first

class capp_consult_answer_view extends capp_consult_answer {
	...
	// Page object name
	var $PageObjName = 'app_consult_answer_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["answer_id"] <> "") {
				$this->answer_id->setFormValue($_POST["answer_id"]);
				$this->RecKey["answer_id"] = $this->answer_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "app_consult_answerlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "app_consult_answerlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($app_consult_answer_view)) $app_consult_answer_view = new capp_consult_answer_view();

// Page init
$app_consult_answer_view->Page_Init();

// Page main
$app_consult_answer_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_consult_answer_view->Page_Render();
?>
...
var CurrentForm = fapp_consult_answerview = new ew_Form("fapp_consult_answerview", "view");

// Form_CustomValidate event
fapp_consult_answerview.Form_CustomValidate = 
...
fapp_consult_answerview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_consult_answerview.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_consult_answerview.Lists["x_user_id"].Data = "<?php echo $app_consult_answer_view->user_id->LookupFilterQuery(FALSE, "view") ?>";
fapp_consult_answerview.Lists["x_cons_id"] = {"LinkField":"x_cons_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cons_message","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_consultation"};
fapp_consult_answerview.Lists["x_cons_id"].Data = "<?php echo $app_consult_answer_view->cons_id->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $app_consult_answer_view->ExportOptions->Render("body") ?>
<?php
	foreach ($app_consult_answer_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $app_consult_answer_view->ShowPageHeader(); ?>
<?php
$app_consult_answer_view->ShowMessage();
?>
<?php if (!$app_consult_answer_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_consult_answer_view->Pager)) $app_consult_answer_view->Pager = new cPrevNextPager($app_consult_answer_view->StartRec, $app_consult_answer_view->DisplayRecs, $app_consult_answer_view->TotalRecs, $app_consult_answer_view->AutoHidePager) ?>
<?php if ($app_consult_answer_view->Pager->RecordCount > 0 && $app_consult_answer_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_consult_answer_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_consult_answer_view->PageUrl() ?>start=<?php echo $app_consult_answer_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_consult_answer_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_consult_answer_view->PageUrl() ?>start=<?php echo $app_consult_answer_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_consult_answer_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_consult_answer_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_consult_answer_view->PageUrl() ?>start=<?php echo $app_consult_answer_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_consult_answer_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_consult_answer_view->PageUrl() ?>start=<?php echo $app_consult_answer_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_consult_answer_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_consult_answerview" id="fapp_consult_answerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_consult_answer_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_consult_answer_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_consult_answer">
<input type="hidden" name="modal" value="<?php echo intval($app_consult_answer_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($app_consult_answer->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td class="col-sm-2"><span id="elh_app_consult_answer_user_id"><?php echo $app_consult_answer->user_id->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_consult_answer->cons_id->Visible) { // cons_id ?>
	<tr id="r_cons_id">
		<td class="col-sm-2"><span id="elh_app_consult_answer_cons_id"><?php echo $app_consult_answer->cons_id->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->cons_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_consult_answer->answer_file->Visible) { // answer_file ?>
	<tr id="r_answer_file">
		<td class="col-sm-2"><span id="elh_app_consult_answer_answer_file"><?php echo $app_consult_answer->answer_file->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->answer_file->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_consult_answer->answer_audio->Visible) { // answer_audio ?>
	<tr id="r_answer_audio">
		<td class="col-sm-2"><span id="elh_app_consult_answer_answer_audio"><?php echo $app_consult_answer->answer_audio->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->answer_audio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_consult_answer->answer_text->Visible) { // answer_text ?>
	<tr id="r_answer_text">
		<td class="col-sm-2"><span id="elh_app_consult_answer_answer_text"><?php echo $app_consult_answer->answer_text->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->answer_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($app_consult_answer->ins_datetime->Visible) { // ins_datetime ?>
	<tr id="r_ins_datetime">
		<td class="col-sm-2"><span id="elh_app_consult_answer_ins_datetime"><?php echo $app_consult_answer->ins_datetime->FldCaption() ?></span></td>
...
<?php echo $app_consult_answer->ins_datetime->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fapp_consult_answerview.Init();
</script>
<?php
$app_consult_answer_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_consult_answer_view->Page_Terminate();
?>
