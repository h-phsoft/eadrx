...
class ccpy_video_search extends ccpy_video {
	...
	function BuildAdvancedSearch() {
		$sSrchUrl = "";
		$this->BuildSearchUrl($sSrchUrl, $this->video_name); // video_name
	...
	function LoadSearchValues() {
		...
		$this->video_name->AdvancedSearch->SearchValue = $objForm->GetValue("x_video_name");
		$this->video_name->AdvancedSearch->SearchOperator = $objForm->GetValue("z_video_name");
	...
	function RenderRow() {
		...
		$this->video_URL->ViewCustomAttributes = "";
			...
			$this->video_name->EditValue = ew_HtmlEncode($this->video_name->AdvancedSearch->SearchValue);
...
<?php if ($cpy_video->video_name->Visible) { // video_name ?>
	<div id="r_video_name" class="form-group">
		<label for="x_video_name" class="<?php echo $cpy_video_search->LeftColumnClass ?>"><span id="elh_cpy_video_video_name"><?php echo $cpy_video->video_name->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_video_name" id="z_video_name" value="LIKE"></p>
		</label>
		<div class="<?php echo $cpy_video_search->RightColumnClass ?>"><div<?php echo $cpy_video->video_name->CellAttributes() ?>>
