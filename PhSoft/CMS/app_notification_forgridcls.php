...
$app_notification_for_grid = NULL; // Initialize page object first

class capp_notification_for_grid extends capp_notification_for {
	...
	// Page object name
	var $PageObjName = 'app_notification_for_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_notification_forgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_notification_for"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->nfor_id->CurrentValue = strval($arKeys[0]); // nfor_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
