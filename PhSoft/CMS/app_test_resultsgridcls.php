...
$app_test_results_grid = NULL; // Initialize page object first

class capp_test_results_grid extends capp_test_results {
	...
	// Page object name
	var $PageObjName = 'app_test_results_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_test_resultsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_test_results"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->res_id->CurrentValue = strval($arKeys[0]); // res_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
