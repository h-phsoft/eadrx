...
<?php if ($app_notification_for->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label id="elh_app_notification_for_nstatus_id" for="x_nstatus_id" class="<?php echo $app_notification_for_edit->LeftColumnClass ?>"><?php echo $app_notification_for->nstatus_id->FldCaption() ?></label>
