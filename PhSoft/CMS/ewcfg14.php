...
define("EW_PROJECT_NAME", "eadrx", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{0D45E216-03EA-4B51-B419-4F1A34666877}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'qYDiI7Y50W2L3lGW', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/eadrx.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "eadrx", "qs" => "`", "qe" => "`");
...
define("EW_UPLOAD_DEST_PATH", "../../assets/img/", TRUE); // Upload destination path (relative to app root)
