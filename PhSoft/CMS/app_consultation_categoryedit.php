...
$app_consultation_category_edit = NULL; // Initialize page object first

class capp_consultation_category_edit extends capp_consultation_category {
	...
	// Page object name
	var $PageObjName = 'app_consultation_category_edit';
	...
	function ValidateForm() {
		...
		if (in_array("app_consultation_category_name", $DetailTblVar) && $GLOBALS["app_consultation_category_name"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("app_consultation_category_name", $DetailTblVar) && $GLOBALS["app_consultation_category_name"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["app_consultation_category_name_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("app_consultation_category_name", $DetailTblVar)) {
				...
				if ($GLOBALS["app_consultation_category_name_grid"]->DetailEdit) {
					$GLOBALS["app_consultation_category_name_grid"]->CurrentMode = "edit";
					$GLOBALS["app_consultation_category_name_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($app_consultation_category_edit)) $app_consultation_category_edit = new capp_consultation_category_edit();

// Page init
$app_consultation_category_edit->Page_Init();

// Page main
$app_consultation_category_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_consultation_category_edit->Page_Render();
?>
...
var CurrentForm = fapp_consultation_categoryedit = new ew_Form("fapp_consultation_categoryedit", "edit");

// Validate form
fapp_consultation_categoryedit.Validate = function() {
...
fapp_consultation_categoryedit.Form_CustomValidate = 
...
fapp_consultation_categoryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_consultation_categoryedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fapp_consultation_categoryedit.Lists["x_status_id"].Data = "<?php echo $app_consultation_category_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_consultation_category_edit->ShowPageHeader(); ?>
<?php
$app_consultation_category_edit->ShowMessage();
?>
<?php if (!$app_consultation_category_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_consultation_category_edit->Pager)) $app_consultation_category_edit->Pager = new cPrevNextPager($app_consultation_category_edit->StartRec, $app_consultation_category_edit->DisplayRecs, $app_consultation_category_edit->TotalRecs, $app_consultation_category_edit->AutoHidePager) ?>
<?php if ($app_consultation_category_edit->Pager->RecordCount > 0 && $app_consultation_category_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_consultation_category_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_consultation_category_edit->PageUrl() ?>start=<?php echo $app_consultation_category_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_consultation_category_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_consultation_category_edit->PageUrl() ?>start=<?php echo $app_consultation_category_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_consultation_category_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_consultation_category_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_consultation_category_edit->PageUrl() ?>start=<?php echo $app_consultation_category_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_consultation_category_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_consultation_category_edit->PageUrl() ?>start=<?php echo $app_consultation_category_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_consultation_category_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_consultation_categoryedit" id="fapp_consultation_categoryedit" class="<?php echo $app_consultation_category_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_consultation_category_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_consultation_category_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_consultation_category">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_consultation_category_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($app_consultation_category->cat_id->Visible) { // cat_id ?>
	<div id="r_cat_id" class="form-group">
		<label id="elh_app_consultation_category_cat_id" class="<?php echo $app_consultation_category_edit->LeftColumnClass ?>"><?php echo $app_consultation_category->cat_id->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_edit->RightColumnClass ?>"><div<?php echo $app_consultation_category->cat_id->CellAttributes() ?>>
...
<input type="hidden" data-table="app_consultation_category" data-field="x_cat_id" name="x_cat_id" id="x_cat_id" value="<?php echo ew_HtmlEncode($app_consultation_category->cat_id->CurrentValue) ?>">
<?php echo $app_consultation_category->cat_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($app_consultation_category->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_app_consultation_category_status_id" for="x_status_id" class="<?php echo $app_consultation_category_edit->LeftColumnClass ?>"><?php echo $app_consultation_category->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_consultation_category_edit->RightColumnClass ?>"><div<?php echo $app_consultation_category->status_id->CellAttributes() ?>>
...
<?php if ($app_consultation_category->cat_order->Visible) { // cat_order ?>
	<div id="r_cat_order" class="form-group">
		<label id="elh_app_consultation_category_cat_order" for="x_cat_order" class="<?php echo $app_consultation_category_edit->LeftColumnClass ?>"><?php echo $app_consultation_category->cat_order->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_edit->RightColumnClass ?>"><div<?php echo $app_consultation_category->cat_order->CellAttributes() ?>>
...
<?php if ($app_consultation_category->cat_name->Visible) { // cat_name ?>
	<div id="r_cat_name" class="form-group">
		<label id="elh_app_consultation_category_cat_name" for="x_cat_name" class="<?php echo $app_consultation_category_edit->LeftColumnClass ?>"><?php echo $app_consultation_category->cat_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_consultation_category_edit->RightColumnClass ?>"><div<?php echo $app_consultation_category->cat_name->CellAttributes() ?>>
...
<?php if ($app_consultation_category->cat_Price->Visible) { // cat_Price ?>
	<div id="r_cat_Price" class="form-group">
		<label id="elh_app_consultation_category_cat_Price" for="x_cat_Price" class="<?php echo $app_consultation_category_edit->LeftColumnClass ?>"><?php echo $app_consultation_category->cat_Price->FldCaption() ?></label>
		<div class="<?php echo $app_consultation_category_edit->RightColumnClass ?>"><div<?php echo $app_consultation_category->cat_Price->CellAttributes() ?>>
...
<?php
	if (in_array("app_consultation_category_name", explode(",", $app_consultation_category->getCurrentDetailTable())) && $app_consultation_category_name->DetailEdit) {
?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_consultation_category_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_consultation_category_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_consultation_categoryedit.Init();
</script>
<?php
$app_consultation_category_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_consultation_category_edit->Page_Terminate();
?>
