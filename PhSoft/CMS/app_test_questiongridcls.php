...
$app_test_question_grid = NULL; // Initialize page object first

class capp_test_question_grid extends capp_test_question {
	...
	// Page object name
	var $PageObjName = 'app_test_question_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_test_questiongrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_test_question"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->qstn_id->CurrentValue = strval($arKeys[0]); // qstn_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "app_test") {
			...
			if ($GLOBALS["app_test"]->EventCancelled) $this->EventCancelled = TRUE;
		}
