...
$phs_log_add = NULL; // Initialize page object first

class cphs_log_add extends cphs_log {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("phs_loglist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "phs_logview.php")
...
// Create page object
if (!isset($phs_log_add)) $phs_log_add = new cphs_log_add();

// Page init
$phs_log_add->Page_Init();

// Page main
$phs_log_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_log_add->Page_Render();
?>
...
var CurrentForm = fphs_logadd = new ew_Form("fphs_logadd", "add");

// Validate form
fphs_logadd.Validate = function() {
...
fphs_logadd.Form_CustomValidate = 
...
fphs_logadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $phs_log_add->ShowPageHeader(); ?>
<?php
$phs_log_add->ShowMessage();
?>
<form name="fphs_logadd" id="fphs_logadd" class="<?php echo $phs_log_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_log_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_log_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_log">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($phs_log_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($phs_log->log_date->Visible) { // log_date ?>
	<div id="r_log_date" class="form-group">
		<label id="elh_phs_log_log_date" for="x_log_date" class="<?php echo $phs_log_add->LeftColumnClass ?>"><?php echo $phs_log->log_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_log_add->RightColumnClass ?>"><div<?php echo $phs_log->log_date->CellAttributes() ?>>
...
<?php if ($phs_log->log_action->Visible) { // log_action ?>
	<div id="r_log_action" class="form-group">
		<label id="elh_phs_log_log_action" for="x_log_action" class="<?php echo $phs_log_add->LeftColumnClass ?>"><?php echo $phs_log->log_action->FldCaption() ?></label>
		<div class="<?php echo $phs_log_add->RightColumnClass ?>"><div<?php echo $phs_log->log_action->CellAttributes() ?>>
...
<?php if ($phs_log->log_text->Visible) { // log_text ?>
	<div id="r_log_text" class="form-group">
		<label id="elh_phs_log_log_text" for="x_log_text" class="<?php echo $phs_log_add->LeftColumnClass ?>"><?php echo $phs_log->log_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_log_add->RightColumnClass ?>"><div<?php echo $phs_log->log_text->CellAttributes() ?>>
...
<?php if (!$phs_log_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_log_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_log_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
