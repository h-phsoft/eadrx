...
$phs_log_edit = NULL; // Initialize page object first

class cphs_log_edit extends cphs_log {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("phs_loglist.php"); // Return to list page
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "phs_loglist.php")
...
// Create page object
if (!isset($phs_log_edit)) $phs_log_edit = new cphs_log_edit();

// Page init
$phs_log_edit->Page_Init();

// Page main
$phs_log_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_log_edit->Page_Render();
?>
...
var CurrentForm = fphs_logedit = new ew_Form("fphs_logedit", "edit");

// Validate form
fphs_logedit.Validate = function() {
...
fphs_logedit.Form_CustomValidate = 
...
fphs_logedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $phs_log_edit->ShowPageHeader(); ?>
<?php
$phs_log_edit->ShowMessage();
?>
<?php if (!$phs_log_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($phs_log_edit->Pager)) $phs_log_edit->Pager = new cPrevNextPager($phs_log_edit->StartRec, $phs_log_edit->DisplayRecs, $phs_log_edit->TotalRecs, $phs_log_edit->AutoHidePager) ?>
<?php if ($phs_log_edit->Pager->RecordCount > 0 && $phs_log_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($phs_log_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $phs_log_edit->PageUrl() ?>start=<?php echo $phs_log_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($phs_log_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $phs_log_edit->PageUrl() ?>start=<?php echo $phs_log_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $phs_log_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($phs_log_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $phs_log_edit->PageUrl() ?>start=<?php echo $phs_log_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($phs_log_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $phs_log_edit->PageUrl() ?>start=<?php echo $phs_log_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $phs_log_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fphs_logedit" id="fphs_logedit" class="<?php echo $phs_log_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_log_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_log_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_log">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($phs_log_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($phs_log->log_date->Visible) { // log_date ?>
	<div id="r_log_date" class="form-group">
		<label id="elh_phs_log_log_date" for="x_log_date" class="<?php echo $phs_log_edit->LeftColumnClass ?>"><?php echo $phs_log->log_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_log_edit->RightColumnClass ?>"><div<?php echo $phs_log->log_date->CellAttributes() ?>>
...
<?php if ($phs_log->log_action->Visible) { // log_action ?>
	<div id="r_log_action" class="form-group">
		<label id="elh_phs_log_log_action" for="x_log_action" class="<?php echo $phs_log_edit->LeftColumnClass ?>"><?php echo $phs_log->log_action->FldCaption() ?></label>
		<div class="<?php echo $phs_log_edit->RightColumnClass ?>"><div<?php echo $phs_log->log_action->CellAttributes() ?>>
...
<?php if ($phs_log->log_text->Visible) { // log_text ?>
	<div id="r_log_text" class="form-group">
		<label id="elh_phs_log_log_text" for="x_log_text" class="<?php echo $phs_log_edit->LeftColumnClass ?>"><?php echo $phs_log->log_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_log_edit->RightColumnClass ?>"><div<?php echo $phs_log->log_text->CellAttributes() ?>>
...
<input type="hidden" data-table="phs_log" data-field="x_log_id" name="x_log_id" id="x_log_id" value="<?php echo ew_HtmlEncode($phs_log->log_id->CurrentValue) ?>">
<?php if (!$phs_log_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_log_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_log_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
