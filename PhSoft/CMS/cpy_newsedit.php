...
fcpy_newsedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_newsedit.Lists["x_status_id"].Data = "<?php echo $cpy_news_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($cpy_news->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_cpy_news_status_id" for="x_status_id" class="<?php echo $cpy_news_edit->LeftColumnClass ?>"><?php echo $cpy_news->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_news_edit->RightColumnClass ?>"><div<?php echo $cpy_news->status_id->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fcpy_newsedit", "x_news_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($cpy_news->news_text->Visible) { // news_text ?>
	<div id="r_news_text" class="form-group">
		<label id="elh_cpy_news_news_text" class="<?php echo $cpy_news_edit->LeftColumnClass ?>"><?php echo $cpy_news->news_text->FldCaption() ?></label>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_newsedit", "x_news_text", 35, 8, <?php echo ($cpy_news->news_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
