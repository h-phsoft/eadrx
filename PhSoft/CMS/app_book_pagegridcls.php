...
$app_book_page_grid = NULL; // Initialize page object first

class capp_book_page_grid extends capp_book_page {
	...
	// Page object name
	var $PageObjName = 'app_book_page_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_book_pagegrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_book_page"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadDefaultValues() {
		...
		$this->page_image->Upload->Index = $this->RowIndex;
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->bpage_id->CurrentValue = strval($arKeys[0]); // bpage_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "app_book") {
			...
			if ($GLOBALS["app_book"]->EventCancelled) $this->EventCancelled = TRUE;
		}
