...
class ccpy_page extends cTable {
	...
	function __construct() {
		...
		// status_id
		$this->status_id = new cField('cpy_page', 'cpy_page', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cpy_page_row") {
			$sDetailUrl = $GLOBALS["cpy_page_row"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
