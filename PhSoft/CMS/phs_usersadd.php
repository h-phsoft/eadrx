...
fphs_usersadd.Lists["x_pgrp_id"] = {"LinkField":"x_user_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_user_id","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_users"};
fphs_usersadd.Lists["x_pgrp_id"].Options = <?php echo json_encode($phs_users_add->pgrp_id->Options()) ?>;
