...
$app_tips_category = NULL;

//
// Table class for app_tips_category
//
class capp_tips_category extends cTable {
	var $tcat_id;
	var $status_id;
	var $tcat_name;
	...
	function __construct() {
		...
		$this->TableVar = 'app_tips_category';
		$this->TableName = 'app_tips_category';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_tips_category`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// tcat_id
		$this->tcat_id = new cField('app_tips_category', 'app_tips_category', 'x_tcat_id', 'tcat_id', '`tcat_id`', '`tcat_id`', 3, -1, FALSE, '`tcat_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// status_id
		$this->status_id = new cField('app_tips_category', 'app_tips_category', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tcat_name
		$this->tcat_name = new cField('app_tips_category', 'app_tips_category', 'x_tcat_name', 'tcat_name', '`tcat_name`', '`tcat_name`', 200, -1, FALSE, '`tcat_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "app_tips") {
			$sDetailUrl = $GLOBALS["app_tips"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_tcat_id=" . urlencode($this->tcat_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "app_tips_categorylist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_tips_category`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`tcat_name` ASC";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "app_tips_categorylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_tips_categoryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_tips_categoryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_tips_categoryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_tips_categoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_tips_categoryadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_tips_categoryadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_tips_categoryedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_tips_categoryedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_tips_categoryadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_tips_categoryadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_tips_categorydelete.php", $this->UrlParm());
	}
