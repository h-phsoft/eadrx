...
//
// Table class for cpy_vuser
//
class ccpy_vuser extends cTable {
	var $pgrp_id;
	var $lang_id;
	var $cntry_id;
	var $user_id;
	...
	function __construct() {
		...
		$this->TableVar = 'cpy_vuser';
		$this->TableName = 'cpy_vuser';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`cpy_vuser`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// pgrp_id
		$this->pgrp_id = new cField('cpy_vuser', 'cpy_vuser', 'x_pgrp_id', 'pgrp_id', '`pgrp_id`', '`pgrp_id`', 3, -1, FALSE, '`pgrp_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lang_id
		$this->lang_id = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_id', 'lang_id', '`lang_id`', '`lang_id`', 3, -1, FALSE, '`lang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// cntry_id
		$this->cntry_id = new cField('cpy_vuser', 'cpy_vuser', 'x_cntry_id', 'cntry_id', '`cntry_id`', '`cntry_id`', 3, -1, FALSE, '`cntry_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// user_id
		$this->user_id = new cField('cpy_vuser', 'cpy_vuser', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->user_id->Sortable = FALSE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// status_id
		$this->status_id = new cField('cpy_vuser', 'cpy_vuser', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// gend_id
		$this->gend_id = new cField('cpy_vuser', 'cpy_vuser', 'x_gend_id', 'gend_id', '`gend_id`', '`gend_id`', 16, -1, FALSE, '`gend_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lang_code
		$this->lang_code = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_code', 'lang_code', '`lang_code`', '`lang_code`', 200, -1, FALSE, '`lang_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_code->Sortable = FALSE; // Allow sort
		$this->fields['lang_code'] = &$this->lang_code;

		// lang_dir
		$this->lang_dir = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_dir', 'lang_dir', '`lang_dir`', '`lang_dir`', 200, -1, FALSE, '`lang_dir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_dir->Sortable = FALSE; // Allow sort
		$this->fields['lang_dir'] = &$this->lang_dir;

		// lang_dname
		$this->lang_dname = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_dname', 'lang_dname', '`lang_dname`', '`lang_dname`', 200, -1, FALSE, '`lang_dname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_dname->Sortable = FALSE; // Allow sort
		$this->fields['lang_dname'] = &$this->lang_dname;

		// lang_ccode
		$this->lang_ccode = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_ccode', 'lang_ccode', '`lang_ccode`', '`lang_ccode`', 200, -1, FALSE, '`lang_ccode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_ccode->Sortable = FALSE; // Allow sort
		$this->fields['lang_ccode'] = &$this->lang_ccode;

		// cntry_code
		$this->cntry_code = new cField('cpy_vuser', 'cpy_vuser', 'x_cntry_code', 'cntry_code', '`cntry_code`', '`cntry_code`', 200, -1, FALSE, '`cntry_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cntry_code->Sortable = FALSE; // Allow sort
		$this->fields['cntry_code'] = &$this->cntry_code;

		// user_token
		$this->user_token = new cField('cpy_vuser', 'cpy_vuser', 'x_user_token', 'user_token', '`user_token`', '`user_token`', 200, -1, FALSE, '`user_token`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_token->Sortable = FALSE; // Allow sort
		$this->fields['user_token'] = &$this->user_token;

		// upd_datetime
		$this->upd_datetime = new cField('cpy_vuser', 'cpy_vuser', 'x_upd_datetime', 'upd_datetime', '`upd_datetime`', ew_CastDateFieldForLike('`upd_datetime`', 0, "DB"), 135, 0, FALSE, '`upd_datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pgrp_name
		$this->pgrp_name = new cField('cpy_vuser', 'cpy_vuser', 'x_pgrp_name', 'pgrp_name', '`pgrp_name`', '`pgrp_name`', 200, -1, FALSE, '`pgrp_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pgrp_name->Sortable = TRUE; // Allow sort
		$this->fields['pgrp_name'] = &$this->pgrp_name;

		// cntry_name
		$this->cntry_name = new cField('cpy_vuser', 'cpy_vuser', 'x_cntry_name', 'cntry_name', '`cntry_name`', '`cntry_name`', 200, -1, FALSE, '`cntry_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cntry_name->Sortable = TRUE; // Allow sort
		$this->fields['cntry_name'] = &$this->cntry_name;

		// lang_name
		$this->lang_name = new cField('cpy_vuser', 'cpy_vuser', 'x_lang_name', 'lang_name', '`lang_name`', '`lang_name`', 200, -1, FALSE, '`lang_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_name->Sortable = TRUE; // Allow sort
		$this->fields['lang_name'] = &$this->lang_name;

		// user_name
		$this->user_name = new cField('cpy_vuser', 'cpy_vuser', 'x_user_name', 'user_name', '`user_name`', '`user_name`', 200, -1, FALSE, '`user_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_name->Sortable = TRUE; // Allow sort
		$this->fields['user_name'] = &$this->user_name;

		// user_email
		$this->user_email = new cField('cpy_vuser', 'cpy_vuser', 'x_user_email', 'user_email', '`user_email`', '`user_email`', 200, -1, FALSE, '`user_email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_email->Sortable = TRUE; // Allow sort
		$this->fields['user_email'] = &$this->user_email;

		// user_password
		$this->user_password = new cField('cpy_vuser', 'cpy_vuser', 'x_user_password', 'user_password', '`user_password`', '`user_password`', 200, -1, FALSE, '`user_password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_password->Sortable = TRUE; // Allow sort
		$this->fields['user_password'] = &$this->user_password;

		// user_mobile
		$this->user_mobile = new cField('cpy_vuser', 'cpy_vuser', 'x_user_mobile', 'user_mobile', '`user_mobile`', '`user_mobile`', 200, -1, FALSE, '`user_mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_mobile->Sortable = TRUE; // Allow sort
		$this->fields['user_mobile'] = &$this->user_mobile;

		// gend_name
		$this->gend_name = new cField('cpy_vuser', 'cpy_vuser', 'x_gend_name', 'gend_name', '`gend_name`', '`gend_name`', 200, -1, FALSE, '`gend_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gend_name->Sortable = TRUE; // Allow sort
		$this->fields['gend_name'] = &$this->gend_name;

		// status_name
		$this->status_name = new cField('cpy_vuser', 'cpy_vuser', 'x_status_name', 'status_name', '`status_name`', '`status_name`', 200, -1, FALSE, '`status_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status_name->Sortable = TRUE; // Allow sort
		$this->fields['status_name'] = &$this->status_name;

		// ins_datetime
		$this->ins_datetime = new cField('cpy_vuser', 'cpy_vuser', 'x_ins_datetime', 'ins_datetime', '`ins_datetime`', ew_CastDateFieldForLike('`ins_datetime`', 0, "DB"), 135, 0, FALSE, '`ins_datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cpy_vuser`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`cntry_name` ASC,`lang_name` ASC,`gend_name` ASC,`user_name` ASC";
	}
	...
	function SqlKeyFilter() {
		return "`pgrp_id` = @pgrp_id@ AND `lang_id` = @lang_id@ AND `cntry_id` = @cntry_id@ AND `user_id` = @user_id@ AND `status_id` = @status_id@ AND `gend_id` = @gend_id@";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "cpy_vuserview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "cpy_vuseredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cpy_vuseradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_vuserview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_vuserview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cpy_vuseradd.php?" . $this->UrlParm($parm);
		else
			$url = "cpy_vuseradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cpy_vuseredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cpy_vuseradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cpy_vuserdelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (is_array($arKeys)) {
			foreach ($arKeys as $key) {
				...
				if (!is_numeric($key[0])) // pgrp_id
					continue;
				if (!is_numeric($key[1])) // lang_id
					continue;
				if (!is_numeric($key[2])) // cntry_id
					continue;
				if (!is_numeric($key[3])) // user_id
					continue;
				if (!is_numeric($key[4])) // status_id
					continue;
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->pgrp_id->CurrentValue = $key[0];
			$this->lang_id->CurrentValue = $key[1];
			$this->cntry_id->CurrentValue = $key[2];
			$this->user_id->CurrentValue = $key[3];
			$this->status_id->CurrentValue = $key[4];
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->status_name->Exportable) $Doc->ExportCaption($this->status_name);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->status_name->Exportable) $Doc->ExportField($this->status_name);
