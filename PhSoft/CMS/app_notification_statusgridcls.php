...
$app_notification_status_grid = NULL; // Initialize page object first

class capp_notification_status_grid extends capp_notification_status {
	...
	// Page object name
	var $PageObjName = 'app_notification_status_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_notification_statusgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_notification_status"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->snotif_id->CurrentValue = strval($arKeys[0]); // snotif_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "app_notification") {
			$this->notif_id->Visible = FALSE;
			if ($GLOBALS["app_notification"]->EventCancelled) $this->EventCancelled = TRUE;
		}
