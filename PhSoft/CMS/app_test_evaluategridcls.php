...
$app_test_evaluate_grid = NULL; // Initialize page object first

class capp_test_evaluate_grid extends capp_test_evaluate {
	...
	// Page object name
	var $PageObjName = 'app_test_evaluate_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_test_evaluategrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_test_evaluate"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->eval_id->CurrentValue = strval($arKeys[0]); // eval_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
