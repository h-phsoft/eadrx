...
fapp_consultation_category_nameupdate.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_consultation_category_nameupdate.Lists["x_lang_id"].Data = "<?php echo $app_consultation_category_name_update->lang_id->LookupFilterQuery(FALSE, "update") ?>";
