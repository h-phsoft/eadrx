...
//
// Table class for phs_keys
//
class cphs_keys extends cTable {
	var $key_id;
	var $key_name;
	var $key_defvalue;
	...
	function __construct() {
		...
		$this->TableVar = 'phs_keys';
		$this->TableName = 'phs_keys';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`phs_keys`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// key_id
		$this->key_id = new cField('phs_keys', 'phs_keys', 'x_key_id', 'key_id', '`key_id`', '`key_id`', 3, -1, FALSE, '`key_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// key_name
		$this->key_name = new cField('phs_keys', 'phs_keys', 'x_key_name', 'key_name', '`key_name`', '`key_name`', 200, -1, FALSE, '`key_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->key_name->Sortable = TRUE; // Allow sort
		$this->fields['key_name'] = &$this->key_name;

		// key_defvalue
		$this->key_defvalue = new cField('phs_keys', 'phs_keys', 'x_key_defvalue', 'key_defvalue', '`key_defvalue`', '`key_defvalue`', 200, -1, FALSE, '`key_defvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "phs_keyvalues") {
			$sDetailUrl = $GLOBALS["phs_keyvalues"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_key_id=" . urlencode($this->key_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "phs_keyslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`phs_keys`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "phs_keysedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "phs_keysadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("phs_keysview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("phs_keysview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "phs_keysadd.php?" . $this->UrlParm($parm);
		else
			$url = "phs_keysadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("phs_keysedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("phs_keysedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("phs_keysadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("phs_keysadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("phs_keysdelete.php", $this->UrlParm());
	}
