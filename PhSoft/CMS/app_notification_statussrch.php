...
$app_notification_status_search = NULL; // Initialize page object first

class capp_notification_status_search extends capp_notification_status {
	...
	// Page object name
	var $PageObjName = 'app_notification_status_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "app_notification_statuslist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->notif_datetime); // notif_datetime
	...
	function LoadSearchValues() {
		...
		// notif_datetime
		$this->notif_datetime->AdvancedSearch->SearchValue = $objForm->GetValue("x_notif_datetime");
		$this->notif_datetime->AdvancedSearch->SearchOperator = $objForm->GetValue("z_notif_datetime");
	}
	...
	function RenderRow() {
		...
		$this->notif_datetime->ViewCustomAttributes = "";
			...
			$this->notif_datetime->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->notif_datetime->AdvancedSearch->SearchValue, 11), 11));
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckEuroDate($this->notif_datetime->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->notif_datetime->FldErrMsg());
		}
...
// Create page object
if (!isset($app_notification_status_search)) $app_notification_status_search = new capp_notification_status_search();

// Page init
$app_notification_status_search->Page_Init();

// Page main
$app_notification_status_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_notification_status_search->Page_Render();
?>
...
<?php if ($app_notification_status_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fapp_notification_statussearch = new ew_Form("fapp_notification_statussearch", "search");
<?php } else { ?>
var CurrentForm = fapp_notification_statussearch = new ew_Form("fapp_notification_statussearch", "search");
<?php } ?>

// Form_CustomValidate event
fapp_notification_statussearch.Form_CustomValidate = 
...
fapp_notification_statussearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_notification_statussearch.Lists["x_notif_id"] = {"LinkField":"x_notif_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_notif_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notification"};
fapp_notification_statussearch.Lists["x_notif_id"].Data = "<?php echo $app_notification_status_search->notif_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_notification_statussearch.Lists["x_nstatus_id"] = {"LinkField":"x_nstatus_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nstatus_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notif_status"};
fapp_notification_statussearch.Lists["x_nstatus_id"].Data = "<?php echo $app_notification_status_search->nstatus_id->LookupFilterQuery(FALSE, "search") ?>";
fapp_notification_statussearch.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_notification_statussearch.Lists["x_user_id"].Data = "<?php echo $app_notification_status_search->user_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fapp_notification_statussearch.Validate = function(fobj) {
...
<?php $app_notification_status_search->ShowPageHeader(); ?>
<?php
$app_notification_status_search->ShowMessage();
?>
<form name="fapp_notification_statussearch" id="fapp_notification_statussearch" class="<?php echo $app_notification_status_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_notification_status_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_notification_status_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_notification_status">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($app_notification_status_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($app_notification_status->notif_id->Visible) { // notif_id ?>
	<div id="r_notif_id" class="form-group">
		<label for="x_notif_id" class="<?php echo $app_notification_status_search->LeftColumnClass ?>"><span id="elh_app_notification_status_notif_id"><?php echo $app_notification_status->notif_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_notification_status_search->RightColumnClass ?>"><div<?php echo $app_notification_status->notif_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label for="x_nstatus_id" class="<?php echo $app_notification_status_search->LeftColumnClass ?>"><span id="elh_app_notification_status_nstatus_id"><?php echo $app_notification_status->nstatus_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_notification_status_search->RightColumnClass ?>"><div<?php echo $app_notification_status->nstatus_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label for="x_user_id" class="<?php echo $app_notification_status_search->LeftColumnClass ?>"><span id="elh_app_notification_status_user_id"><?php echo $app_notification_status->user_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_notification_status_search->RightColumnClass ?>"><div<?php echo $app_notification_status->user_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->notif_datetime->Visible) { // notif_datetime ?>
	<div id="r_notif_datetime" class="form-group">
		<label for="x_notif_datetime" class="<?php echo $app_notification_status_search->LeftColumnClass ?>"><span id="elh_app_notification_status_notif_datetime"><?php echo $app_notification_status->notif_datetime->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_notif_datetime" id="z_notif_datetime" value="="></p>
		</label>
		<div class="<?php echo $app_notification_status_search->RightColumnClass ?>"><div<?php echo $app_notification_status->notif_datetime->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_notification_status_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fapp_notification_statussearch.Init();
</script>
<?php
$app_notification_status_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_notification_status_search->Page_Terminate();
?>
