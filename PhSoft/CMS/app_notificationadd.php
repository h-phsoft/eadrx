...
$app_notification_add = NULL; // Initialize page object first

class capp_notification_add extends capp_notification {
	...
	// Page object name
	var $PageObjName = 'app_notification_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("app_notificationlist.php"); // No matching record, return to list
				}
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "app_notificationview.php")
	...
	function ValidateForm() {
		...
		if (in_array("app_notification_for", $DetailTblVar) && $GLOBALS["app_notification_for"]->DetailAdd) {
		...
		if (in_array("app_notification_status", $DetailTblVar) && $GLOBALS["app_notification_status"]->DetailAdd) {
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$DetailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("app_notification_for", $DetailTblVar) && $GLOBALS["app_notification_for"]->DetailAdd) {
				$GLOBALS["app_notification_for"]->notif_id->setSessionValue($this->notif_id->CurrentValue); // Set master key
				if (!isset($GLOBALS["app_notification_for_grid"])) $GLOBALS["app_notification_for_grid"] = new capp_notification_for_grid(); // Get detail page object
				$Security->LoadCurrentUserLevel($this->ProjectID . "app_notification_for"); // Load user level of detail table
				$AddRow = $GLOBALS["app_notification_for_grid"]->GridInsert();
				$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$AddRow)
					$GLOBALS["app_notification_for"]->notif_id->setSessionValue(""); // Clear master key if insert failed
			}
			if (in_array("app_notification_status", $DetailTblVar) && $GLOBALS["app_notification_status"]->DetailAdd) {
				$GLOBALS["app_notification_status"]->notif_id->setSessionValue($this->notif_id->CurrentValue); // Set master key
				if (!isset($GLOBALS["app_notification_status_grid"])) $GLOBALS["app_notification_status_grid"] = new capp_notification_status_grid(); // Get detail page object
				$Security->LoadCurrentUserLevel($this->ProjectID . "app_notification_status"); // Load user level of detail table
				$AddRow = $GLOBALS["app_notification_status_grid"]->GridInsert();
				$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$AddRow)
					$GLOBALS["app_notification_status"]->notif_id->setSessionValue(""); // Clear master key if insert failed
			}
		}
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("app_notification_for", $DetailTblVar)) {
				...
				if ($GLOBALS["app_notification_for_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["app_notification_for_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["app_notification_for_grid"]->CurrentMode = "add";
					$GLOBALS["app_notification_for_grid"]->CurrentAction = "gridadd";
			...
			if (in_array("app_notification_status", $DetailTblVar)) {
				...
				if ($GLOBALS["app_notification_status_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["app_notification_status_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["app_notification_status_grid"]->CurrentMode = "add";
					$GLOBALS["app_notification_status_grid"]->CurrentAction = "gridadd";
...
// Create page object
if (!isset($app_notification_add)) $app_notification_add = new capp_notification_add();

// Page init
$app_notification_add->Page_Init();

// Page main
$app_notification_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_notification_add->Page_Render();
?>
...
var CurrentForm = fapp_notificationadd = new ew_Form("fapp_notificationadd", "add");

// Validate form
fapp_notificationadd.Validate = function() {
...
fapp_notificationadd.Form_CustomValidate = 
...
fapp_notificationadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_notificationadd.Lists["x_for_id"] = {"LinkField":"x_for_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_for_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notif_for"};
fapp_notificationadd.Lists["x_for_id"].Data = "<?php echo $app_notification_add->for_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_notificationadd.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_notificationadd.Lists["x_lang_id"].Data = "<?php echo $app_notification_add->lang_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_notificationadd.Lists["x_nstatus_id"] = {"LinkField":"x_nstatus_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nstatus_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notif_status"};
fapp_notificationadd.Lists["x_nstatus_id"].Data = "<?php echo $app_notification_add->nstatus_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $app_notification_add->ShowPageHeader(); ?>
<?php
$app_notification_add->ShowMessage();
?>
<form name="fapp_notificationadd" id="fapp_notificationadd" class="<?php echo $app_notification_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_notification_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_notification_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_notification">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($app_notification_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($app_notification->for_id->Visible) { // for_id ?>
	<div id="r_for_id" class="form-group">
		<label id="elh_app_notification_for_id" for="x_for_id" class="<?php echo $app_notification_add->LeftColumnClass ?>"><?php echo $app_notification->for_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_add->RightColumnClass ?>"><div<?php echo $app_notification->for_id->CellAttributes() ?>>
...
<?php if ($app_notification->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_notification_lang_id" for="x_lang_id" class="<?php echo $app_notification_add->LeftColumnClass ?>"><?php echo $app_notification->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_add->RightColumnClass ?>"><div<?php echo $app_notification->lang_id->CellAttributes() ?>>
...
<?php if ($app_notification->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label id="elh_app_notification_nstatus_id" for="x_nstatus_id" class="<?php echo $app_notification_add->LeftColumnClass ?>"><?php echo $app_notification->nstatus_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_add->RightColumnClass ?>"><div<?php echo $app_notification->nstatus_id->CellAttributes() ?>>
...
<?php if ($app_notification->notif_title->Visible) { // notif_title ?>
	<div id="r_notif_title" class="form-group">
		<label id="elh_app_notification_notif_title" for="x_notif_title" class="<?php echo $app_notification_add->LeftColumnClass ?>"><?php echo $app_notification->notif_title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_add->RightColumnClass ?>"><div<?php echo $app_notification->notif_title->CellAttributes() ?>>
...
<?php if ($app_notification->notif_text->Visible) { // notif_text ?>
	<div id="r_notif_text" class="form-group">
		<label id="elh_app_notification_notif_text" for="x_notif_text" class="<?php echo $app_notification_add->LeftColumnClass ?>"><?php echo $app_notification->notif_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_add->RightColumnClass ?>"><div<?php echo $app_notification->notif_text->CellAttributes() ?>>
...
<?php
	if (in_array("app_notification_for", explode(",", $app_notification->getCurrentDetailTable())) && $app_notification_for->DetailAdd) {
?>
...
<?php } ?>
<?php
	if (in_array("app_notification_status", explode(",", $app_notification->getCurrentDetailTable())) && $app_notification_status->DetailAdd) {
?>
<?php if ($app_notification->getCurrentDetailTable() <> "") { ?>
...
<?php } ?>
<?php if (!$app_notification_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_notification_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_notification_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fapp_notificationadd.Init();
</script>
<?php
$app_notification_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_notification_add->Page_Terminate();
?>
