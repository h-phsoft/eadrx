...
class capp_tips_package_list extends capp_tips_package {
	...
	function __construct() {
		...
		$this->AddUrl = "app_tips_packageadd.php?" . EW_TABLE_SHOW_DETAIL . "=";
	...
	function SetupListOptions() {
		...
		$item = &$this->ListOptions->Add("detail_app_tips_pkg_cat");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'app_tips_pkg_cat') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	function RenderListOptions() {
		...
		// "detail_app_tips_pkg_cat"
		$oListOpt = &$this->ListOptions->Items["detail_app_tips_pkg_cat"];
		if ($Security->AllowList(CurrentProjectID() . 'app_tips_pkg_cat')) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("app_tips_pkg_cat", "TblCaption");
			...
			$links = "";
			if ($GLOBALS["app_tips_pkg_cat_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'app_tips_pkg_cat')) {
				$caption = $Language->Phrase("MasterDetailViewLink");
				$url = $this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=app_tips_pkg_cat");
			...
			if ($GLOBALS["app_tips_pkg_cat_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'app_tips_pkg_cat')) {
				$caption = $Language->Phrase("MasterDetailEditLink");
				$url = $this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=app_tips_pkg_cat");
			...
			if ($GLOBALS["app_tips_pkg_cat_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'app_tips_pkg_cat')) {
				$caption = $Language->Phrase("MasterDetailCopyLink");
				$url = $this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=app_tips_pkg_cat");
	...
	function SetupOtherOptions() {
		...
		$DetailTableLink = "";
		$item = &$option->Add("detailadd_app_tips_pkg_cat");
		$url = $this->GetAddUrl(EW_TABLE_SHOW_DETAIL . "=app_tips_pkg_cat");
		$caption = $Language->Phrase("Add") . "&nbsp;" . $this->TableCaption() . "/" . $GLOBALS["app_tips_pkg_cat"]->TableCaption();
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["app_tips_pkg_cat"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'app_tips_pkg_cat') && $Security->CanAdd());
		if ($item->Visible) {
