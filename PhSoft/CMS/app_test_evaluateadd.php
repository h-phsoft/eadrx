...
$app_test_evaluate_add = NULL; // Initialize page object first

class capp_test_evaluate_add extends capp_test_evaluate {
	...
	// Page object name
	var $PageObjName = 'app_test_evaluate_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("app_test_evaluatelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "app_test_evaluateview.php")
...
// Create page object
if (!isset($app_test_evaluate_add)) $app_test_evaluate_add = new capp_test_evaluate_add();

// Page init
$app_test_evaluate_add->Page_Init();

// Page main
$app_test_evaluate_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_evaluate_add->Page_Render();
?>
...
var CurrentForm = fapp_test_evaluateadd = new ew_Form("fapp_test_evaluateadd", "add");

// Validate form
fapp_test_evaluateadd.Validate = function() {
...
fapp_test_evaluateadd.Form_CustomValidate = 
...
fapp_test_evaluateadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_evaluateadd.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_evaluateadd.Lists["x_test_id"].Data = "<?php echo $app_test_evaluate_add->test_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_test_evaluateadd.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_test_evaluateadd.Lists["x_lang_id"].Data = "<?php echo $app_test_evaluate_add->lang_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_test_evaluateadd.Lists["x_gend_id"] = {"LinkField":"x_gend_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gend_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_gender"};
fapp_test_evaluateadd.Lists["x_gend_id"].Data = "<?php echo $app_test_evaluate_add->gend_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $app_test_evaluate_add->ShowPageHeader(); ?>
<?php
$app_test_evaluate_add->ShowMessage();
?>
<form name="fapp_test_evaluateadd" id="fapp_test_evaluateadd" class="<?php echo $app_test_evaluate_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_evaluate_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_evaluate_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_evaluate">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($app_test_evaluate_add->IsModal) ?>">
...
<?php if ($app_test_evaluate->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label id="elh_app_test_evaluate_test_id" for="x_test_id" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->test_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->test_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_test_evaluate_lang_id" for="x_lang_id" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->lang_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->gend_id->Visible) { // gend_id ?>
	<div id="r_gend_id" class="form-group">
		<label id="elh_app_test_evaluate_gend_id" for="x_gend_id" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->gend_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->gend_id->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_from->Visible) { // eval_from ?>
	<div id="r_eval_from" class="form-group">
		<label id="elh_app_test_evaluate_eval_from" for="x_eval_from" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_from->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_from->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_to->Visible) { // eval_to ?>
	<div id="r_eval_to" class="form-group">
		<label id="elh_app_test_evaluate_eval_to" for="x_eval_to" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_to->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_to->CellAttributes() ?>>
...
<?php if ($app_test_evaluate->eval_text->Visible) { // eval_text ?>
	<div id="r_eval_text" class="form-group">
		<label id="elh_app_test_evaluate_eval_text" class="<?php echo $app_test_evaluate_add->LeftColumnClass ?>"><?php echo $app_test_evaluate->eval_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_evaluate_add->RightColumnClass ?>"><div<?php echo $app_test_evaluate->eval_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_test_evaluateadd", "x_eval_text", 35, 8, <?php echo ($app_test_evaluate->eval_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if (!$app_test_evaluate_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_evaluate_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_test_evaluate_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fapp_test_evaluateadd.Init();
</script>
<?php
$app_test_evaluate_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_evaluate_add->Page_Terminate();
?>
