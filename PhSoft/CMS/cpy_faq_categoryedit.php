...
$cpy_faq_category_edit = NULL; // Initialize page object first

class ccpy_faq_category_edit extends ccpy_faq_category {
	...
	// Page object name
	var $PageObjName = 'cpy_faq_category_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			if (!is_null($this->fcat_id->CurrentValue)) {
	...
	function ValidateForm() {
		...
		if (in_array("cpy_faq", $DetailTblVar) && $GLOBALS["cpy_faq"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("cpy_faq", $DetailTblVar) && $GLOBALS["cpy_faq"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["cpy_faq_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("cpy_faq", $DetailTblVar)) {
				...
				if ($GLOBALS["cpy_faq_grid"]->DetailEdit) {
					$GLOBALS["cpy_faq_grid"]->CurrentMode = "edit";
					$GLOBALS["cpy_faq_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($cpy_faq_category_edit)) $cpy_faq_category_edit = new ccpy_faq_category_edit();

// Page init
$cpy_faq_category_edit->Page_Init();

// Page main
$cpy_faq_category_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_faq_category_edit->Page_Render();
?>
...
var CurrentForm = fcpy_faq_categoryedit = new ew_Form("fcpy_faq_categoryedit", "edit");

// Validate form
fcpy_faq_categoryedit.Validate = function() {
...
fcpy_faq_categoryedit.Form_CustomValidate = 
...
fcpy_faq_categoryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_faq_categoryedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_faq_categoryedit.Lists["x_status_id"].Data = "<?php echo $cpy_faq_category_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $cpy_faq_category_edit->ShowPageHeader(); ?>
<?php
$cpy_faq_category_edit->ShowMessage();
?>
<?php if (!$cpy_faq_category_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($cpy_faq_category_edit->Pager)) $cpy_faq_category_edit->Pager = new cPrevNextPager($cpy_faq_category_edit->StartRec, $cpy_faq_category_edit->DisplayRecs, $cpy_faq_category_edit->TotalRecs, $cpy_faq_category_edit->AutoHidePager) ?>
<?php if ($cpy_faq_category_edit->Pager->RecordCount > 0 && $cpy_faq_category_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cpy_faq_category_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cpy_faq_category_edit->PageUrl() ?>start=<?php echo $cpy_faq_category_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cpy_faq_category_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cpy_faq_category_edit->PageUrl() ?>start=<?php echo $cpy_faq_category_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cpy_faq_category_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cpy_faq_category_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cpy_faq_category_edit->PageUrl() ?>start=<?php echo $cpy_faq_category_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cpy_faq_category_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cpy_faq_category_edit->PageUrl() ?>start=<?php echo $cpy_faq_category_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cpy_faq_category_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcpy_faq_categoryedit" id="fcpy_faq_categoryedit" class="<?php echo $cpy_faq_category_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_faq_category_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_faq_category_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_faq_category">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cpy_faq_category_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($cpy_faq_category->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_cpy_faq_category_status_id" for="x_status_id" class="<?php echo $cpy_faq_category_edit->LeftColumnClass ?>"><?php echo $cpy_faq_category->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_faq_category_edit->RightColumnClass ?>"><div<?php echo $cpy_faq_category->status_id->CellAttributes() ?>>
...
<?php if ($cpy_faq_category->fcat_order->Visible) { // fcat_order ?>
	<div id="r_fcat_order" class="form-group">
		<label id="elh_cpy_faq_category_fcat_order" for="x_fcat_order" class="<?php echo $cpy_faq_category_edit->LeftColumnClass ?>"><?php echo $cpy_faq_category->fcat_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_faq_category_edit->RightColumnClass ?>"><div<?php echo $cpy_faq_category->fcat_order->CellAttributes() ?>>
...
<?php if ($cpy_faq_category->fcat_name->Visible) { // fcat_name ?>
	<div id="r_fcat_name" class="form-group">
		<label id="elh_cpy_faq_category_fcat_name" for="x_fcat_name" class="<?php echo $cpy_faq_category_edit->LeftColumnClass ?>"><?php echo $cpy_faq_category->fcat_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_faq_category_edit->RightColumnClass ?>"><div<?php echo $cpy_faq_category->fcat_name->CellAttributes() ?>>
...
<input type="hidden" data-table="cpy_faq_category" data-field="x_fcat_id" name="x_fcat_id" id="x_fcat_id" value="<?php echo ew_HtmlEncode($cpy_faq_category->fcat_id->CurrentValue) ?>">
<?php
	if (in_array("cpy_faq", explode(",", $cpy_faq_category->getCurrentDetailTable())) && $cpy_faq->DetailEdit) {
?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_faq_category_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_faq_category_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fcpy_faq_categoryedit.Init();
</script>
<?php
$cpy_faq_category_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_faq_category_edit->Page_Terminate();
?>
