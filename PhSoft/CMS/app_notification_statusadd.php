...
$app_notification_status_add = NULL; // Initialize page object first

class capp_notification_status_add extends capp_notification_status {
	...
	// Page object name
	var $PageObjName = 'app_notification_status_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("app_notification_statuslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "app_notification_statusview.php")
...
// Create page object
if (!isset($app_notification_status_add)) $app_notification_status_add = new capp_notification_status_add();

// Page init
$app_notification_status_add->Page_Init();

// Page main
$app_notification_status_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_notification_status_add->Page_Render();
?>
...
var CurrentForm = fapp_notification_statusadd = new ew_Form("fapp_notification_statusadd", "add");

// Validate form
fapp_notification_statusadd.Validate = function() {
...
fapp_notification_statusadd.Form_CustomValidate = 
...
fapp_notification_statusadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_notification_statusadd.Lists["x_notif_id"] = {"LinkField":"x_notif_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_notif_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notification"};
fapp_notification_statusadd.Lists["x_notif_id"].Data = "<?php echo $app_notification_status_add->notif_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_notification_statusadd.Lists["x_nstatus_id"] = {"LinkField":"x_nstatus_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nstatus_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notif_status"};
fapp_notification_statusadd.Lists["x_nstatus_id"].Data = "<?php echo $app_notification_status_add->nstatus_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_notification_statusadd.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_notification_statusadd.Lists["x_user_id"].Data = "<?php echo $app_notification_status_add->user_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $app_notification_status_add->ShowPageHeader(); ?>
<?php
$app_notification_status_add->ShowMessage();
?>
<form name="fapp_notification_statusadd" id="fapp_notification_statusadd" class="<?php echo $app_notification_status_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_notification_status_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_notification_status_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_notification_status">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($app_notification_status_add->IsModal) ?>">
...
<?php if ($app_notification_status->notif_id->Visible) { // notif_id ?>
	<div id="r_notif_id" class="form-group">
		<label id="elh_app_notification_status_notif_id" for="x_notif_id" class="<?php echo $app_notification_status_add->LeftColumnClass ?>"><?php echo $app_notification_status->notif_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_add->RightColumnClass ?>"><div<?php echo $app_notification_status->notif_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label id="elh_app_notification_status_nstatus_id" for="x_nstatus_id" class="<?php echo $app_notification_status_add->LeftColumnClass ?>"><?php echo $app_notification_status->nstatus_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_add->RightColumnClass ?>"><div<?php echo $app_notification_status->nstatus_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_notification_status_user_id" for="x_user_id" class="<?php echo $app_notification_status_add->LeftColumnClass ?>"><?php echo $app_notification_status->user_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_add->RightColumnClass ?>"><div<?php echo $app_notification_status->user_id->CellAttributes() ?>>
...
<?php if (!$app_notification_status_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_notification_status_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_notification_status_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fapp_notification_statusadd.Init();
</script>
<?php
$app_notification_status_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_notification_status_add->Page_Terminate();
?>
