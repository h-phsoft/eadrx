...
$cpy_faq_category_search = NULL; // Initialize page object first

class ccpy_faq_category_search extends ccpy_faq_category {
	...
	// Page object name
	var $PageObjName = 'cpy_faq_category_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "cpy_faq_categorylist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->fcat_order); // fcat_order
		$this->BuildSearchUrl($sSrchUrl, $this->fcat_name); // fcat_name
	...
	function LoadSearchValues() {
		...
		// fcat_order
		$this->fcat_order->AdvancedSearch->SearchValue = $objForm->GetValue("x_fcat_order");
		$this->fcat_order->AdvancedSearch->SearchOperator = $objForm->GetValue("z_fcat_order");

		// fcat_name
		$this->fcat_name->AdvancedSearch->SearchValue = $objForm->GetValue("x_fcat_name");
		$this->fcat_name->AdvancedSearch->SearchOperator = $objForm->GetValue("z_fcat_name");
	}
	...
	function RenderRow() {
		...
		$this->fcat_name->ViewCustomAttributes = "";
			...
			$this->fcat_order->EditValue = ew_HtmlEncode($this->fcat_order->AdvancedSearch->SearchValue);
			...
			$this->fcat_name->EditValue = ew_HtmlEncode($this->fcat_name->AdvancedSearch->SearchValue);
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckInteger($this->fcat_order->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->fcat_order->FldErrMsg());
		}
...
// Create page object
if (!isset($cpy_faq_category_search)) $cpy_faq_category_search = new ccpy_faq_category_search();

// Page init
$cpy_faq_category_search->Page_Init();

// Page main
$cpy_faq_category_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_faq_category_search->Page_Render();
?>
...
<?php if ($cpy_faq_category_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fcpy_faq_categorysearch = new ew_Form("fcpy_faq_categorysearch", "search");
<?php } else { ?>
var CurrentForm = fcpy_faq_categorysearch = new ew_Form("fcpy_faq_categorysearch", "search");
<?php } ?>

// Form_CustomValidate event
fcpy_faq_categorysearch.Form_CustomValidate = 
...
fcpy_faq_categorysearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_faq_categorysearch.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_faq_categorysearch.Lists["x_status_id"].Data = "<?php echo $cpy_faq_category_search->status_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fcpy_faq_categorysearch.Validate = function(fobj) {
...
<?php $cpy_faq_category_search->ShowPageHeader(); ?>
<?php
$cpy_faq_category_search->ShowMessage();
?>
<form name="fcpy_faq_categorysearch" id="fcpy_faq_categorysearch" class="<?php echo $cpy_faq_category_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_faq_category_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_faq_category_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_faq_category">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($cpy_faq_category_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($cpy_faq_category->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label for="x_status_id" class="<?php echo $cpy_faq_category_search->LeftColumnClass ?>"><span id="elh_cpy_faq_category_status_id"><?php echo $cpy_faq_category->status_id->FldCaption() ?></span>
		...
		<div class="<?php echo $cpy_faq_category_search->RightColumnClass ?>"><div<?php echo $cpy_faq_category->status_id->CellAttributes() ?>>
...
<?php if ($cpy_faq_category->fcat_order->Visible) { // fcat_order ?>
	<div id="r_fcat_order" class="form-group">
		<label for="x_fcat_order" class="<?php echo $cpy_faq_category_search->LeftColumnClass ?>"><span id="elh_cpy_faq_category_fcat_order"><?php echo $cpy_faq_category->fcat_order->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_fcat_order" id="z_fcat_order" value="="></p>
		</label>
		<div class="<?php echo $cpy_faq_category_search->RightColumnClass ?>"><div<?php echo $cpy_faq_category->fcat_order->CellAttributes() ?>>
...
<?php if ($cpy_faq_category->fcat_name->Visible) { // fcat_name ?>
	<div id="r_fcat_name" class="form-group">
		<label for="x_fcat_name" class="<?php echo $cpy_faq_category_search->LeftColumnClass ?>"><span id="elh_cpy_faq_category_fcat_name"><?php echo $cpy_faq_category->fcat_name->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_fcat_name" id="z_fcat_name" value="LIKE"></p>
		</label>
		<div class="<?php echo $cpy_faq_category_search->RightColumnClass ?>"><div<?php echo $cpy_faq_category->fcat_name->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_faq_category_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fcpy_faq_categorysearch.Init();
</script>
<?php
$cpy_faq_category_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_faq_category_search->Page_Terminate();
?>
