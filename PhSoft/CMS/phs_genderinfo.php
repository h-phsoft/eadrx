...
//
// Table class for phs_gender
//
class cphs_gender extends cTable {
	var $gend_id;
	var $gend_name;
	...
	function __construct() {
		...
		$this->TableVar = 'phs_gender';
		$this->TableName = 'phs_gender';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`phs_gender`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// gend_id
		$this->gend_id = new cField('phs_gender', 'phs_gender', 'x_gend_id', 'gend_id', '`gend_id`', '`gend_id`', 16, -1, FALSE, '`gend_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// gend_name
		$this->gend_name = new cField('phs_gender', 'phs_gender', 'x_gend_name', 'gend_name', '`gend_name`', '`gend_name`', 200, -1, FALSE, '`gend_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`phs_gender`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`gend_id` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "phs_genderedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "phs_genderadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("phs_genderview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("phs_genderview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "phs_genderadd.php?" . $this->UrlParm($parm);
		else
			$url = "phs_genderadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("phs_genderedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("phs_genderadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("phs_genderdelete.php", $this->UrlParm());
	}
