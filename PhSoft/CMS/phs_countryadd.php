...
$phs_country_add = NULL; // Initialize page object first

class cphs_country_add extends cphs_country {
	...
	// Page object name
	var $PageObjName = 'phs_country_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("phs_countrylist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "phs_countryview.php")
...
// Create page object
if (!isset($phs_country_add)) $phs_country_add = new cphs_country_add();

// Page init
$phs_country_add->Page_Init();

// Page main
$phs_country_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_country_add->Page_Render();
?>
...
var CurrentForm = fphs_countryadd = new ew_Form("fphs_countryadd", "add");

// Validate form
fphs_countryadd.Validate = function() {
...
fphs_countryadd.Form_CustomValidate = 
...
fphs_countryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fphs_countryadd.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fphs_countryadd.Lists["x_status_id"].Data = "<?php echo $phs_country_add->status_id->LookupFilterQuery(FALSE, "add") ?>";
fphs_countryadd.AutoSuggests["x_status_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $phs_country_add->status_id->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $phs_country_add->ShowPageHeader(); ?>
<?php
$phs_country_add->ShowMessage();
?>
<form name="fphs_countryadd" id="fphs_countryadd" class="<?php echo $phs_country_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_country_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_country_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_country">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($phs_country_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($phs_country->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_phs_country_status_id" class="<?php echo $phs_country_add->LeftColumnClass ?>"><?php echo $phs_country->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_country_add->RightColumnClass ?>"><div<?php echo $phs_country->status_id->CellAttributes() ?>>
...
<script type="text/javascript">
fphs_countryadd.CreateAutoSuggest({"id":"x_status_id","forceSelect":false});
</script>
</span>
...
<?php if ($phs_country->cntry_code->Visible) { // cntry_code ?>
	<div id="r_cntry_code" class="form-group">
		<label id="elh_phs_country_cntry_code" for="x_cntry_code" class="<?php echo $phs_country_add->LeftColumnClass ?>"><?php echo $phs_country->cntry_code->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_country_add->RightColumnClass ?>"><div<?php echo $phs_country->cntry_code->CellAttributes() ?>>
...
<?php if ($phs_country->cntry_name->Visible) { // cntry_name ?>
	<div id="r_cntry_name" class="form-group">
		<label id="elh_phs_country_cntry_name" for="x_cntry_name" class="<?php echo $phs_country_add->LeftColumnClass ?>"><?php echo $phs_country->cntry_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_country_add->RightColumnClass ?>"><div<?php echo $phs_country->cntry_name->CellAttributes() ?>>
...
<?php if (!$phs_country_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_country_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_country_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fphs_countryadd.Init();
</script>
<?php
$phs_country_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$phs_country_add->Page_Terminate();
?>
