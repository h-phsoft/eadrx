...
$app_consult_assign_grid = NULL; // Initialize page object first

class capp_consult_assign_grid extends capp_consult_assign {
	...
	// Page object name
	var $PageObjName = 'app_consult_assign_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_consult_assigngrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_consult_assign"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->assign_id->CurrentValue = strval($arKeys[0]); // assign_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "app_consultation") {
			...
			if ($GLOBALS["app_consultation"]->EventCancelled) $this->EventCancelled = TRUE;
		}
