...
$app_test_name_grid = NULL; // Initialize page object first

class capp_test_name_grid extends capp_test_name {
	...
	// Page object name
	var $PageObjName = 'app_test_name_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_test_namegrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_test_name"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->ntest_id->CurrentValue = strval($arKeys[0]); // ntest_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
