...
$app_test_question_add = NULL; // Initialize page object first

class capp_test_question_add extends capp_test_question {
	...
	// Page object name
	var $PageObjName = 'app_test_question_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("app_test_questionlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "app_test_questionview.php")
...
// Create page object
if (!isset($app_test_question_add)) $app_test_question_add = new capp_test_question_add();

// Page init
$app_test_question_add->Page_Init();

// Page main
$app_test_question_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_question_add->Page_Render();
?>
...
var CurrentForm = fapp_test_questionadd = new ew_Form("fapp_test_questionadd", "add");

// Validate form
fapp_test_questionadd.Validate = function() {
...
fapp_test_questionadd.Form_CustomValidate = 
...
fapp_test_questionadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_questionadd.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_questionadd.Lists["x_test_id"].Data = "<?php echo $app_test_question_add->test_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_test_questionadd.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_test_questionadd.Lists["x_lang_id"].Data = "<?php echo $app_test_question_add->lang_id->LookupFilterQuery(FALSE, "add") ?>";
fapp_test_questionadd.Lists["x_gend_id"] = {"LinkField":"x_gend_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gend_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_gender"};
fapp_test_questionadd.Lists["x_gend_id"].Data = "<?php echo $app_test_question_add->gend_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $app_test_question_add->ShowPageHeader(); ?>
<?php
$app_test_question_add->ShowMessage();
?>
<form name="fapp_test_questionadd" id="fapp_test_questionadd" class="<?php echo $app_test_question_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_question_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_question_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_question">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($app_test_question_add->IsModal) ?>">
...
<?php if ($app_test_question->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label id="elh_app_test_question_test_id" for="x_test_id" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->test_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->test_id->CellAttributes() ?>>
...
<?php if ($app_test_question->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_test_question_lang_id" for="x_lang_id" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->lang_id->CellAttributes() ?>>
...
<?php if ($app_test_question->gend_id->Visible) { // gend_id ?>
	<div id="r_gend_id" class="form-group">
		<label id="elh_app_test_question_gend_id" for="x_gend_id" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->gend_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->gend_id->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_num->Visible) { // qstn_num ?>
	<div id="r_qstn_num" class="form-group">
		<label id="elh_app_test_question_qstn_num" for="x_qstn_num" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_num->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_num->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_text->Visible) { // qstn_text ?>
	<div id="r_qstn_text" class="form-group">
		<label id="elh_app_test_question_qstn_text" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_test_questionadd", "x_qstn_text", 35, 4, <?php echo ($app_test_question->qstn_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($app_test_question->qstn_ansr1->Visible) { // qstn_ansr1 ?>
	<div id="r_qstn_ansr1" class="form-group">
		<label id="elh_app_test_question_qstn_ansr1" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_ansr1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_ansr1->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_test_questionadd", "x_qstn_ansr1", 35, 2, <?php echo ($app_test_question->qstn_ansr1->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($app_test_question->qstn_val1->Visible) { // qstn_val1 ?>
	<div id="r_qstn_val1" class="form-group">
		<label id="elh_app_test_question_qstn_val1" for="x_qstn_val1" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_val1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_val1->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_rep1->Visible) { // qstn_rep1 ?>
	<div id="r_qstn_rep1" class="form-group">
		<label id="elh_app_test_question_qstn_rep1" for="x_qstn_rep1" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_rep1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_rep1->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_ansr2->Visible) { // qstn_ansr2 ?>
	<div id="r_qstn_ansr2" class="form-group">
		<label id="elh_app_test_question_qstn_ansr2" for="x_qstn_ansr2" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_ansr2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_ansr2->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_val2->Visible) { // qstn_val2 ?>
	<div id="r_qstn_val2" class="form-group">
		<label id="elh_app_test_question_qstn_val2" for="x_qstn_val2" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_val2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_val2->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_rep2->Visible) { // qstn_rep2 ?>
	<div id="r_qstn_rep2" class="form-group">
		<label id="elh_app_test_question_qstn_rep2" for="x_qstn_rep2" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_rep2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_rep2->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_ansr3->Visible) { // qstn_ansr3 ?>
	<div id="r_qstn_ansr3" class="form-group">
		<label id="elh_app_test_question_qstn_ansr3" for="x_qstn_ansr3" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_ansr3->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_ansr3->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_val3->Visible) { // qstn_val3 ?>
	<div id="r_qstn_val3" class="form-group">
		<label id="elh_app_test_question_qstn_val3" for="x_qstn_val3" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_val3->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_val3->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_rep3->Visible) { // qstn_rep3 ?>
	<div id="r_qstn_rep3" class="form-group">
		<label id="elh_app_test_question_qstn_rep3" for="x_qstn_rep3" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_rep3->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_rep3->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_ansr4->Visible) { // qstn_ansr4 ?>
	<div id="r_qstn_ansr4" class="form-group">
		<label id="elh_app_test_question_qstn_ansr4" for="x_qstn_ansr4" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_ansr4->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_ansr4->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_val4->Visible) { // qstn_val4 ?>
	<div id="r_qstn_val4" class="form-group">
		<label id="elh_app_test_question_qstn_val4" for="x_qstn_val4" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_val4->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_val4->CellAttributes() ?>>
...
<?php if ($app_test_question->qstn_rep4->Visible) { // qstn_rep4 ?>
	<div id="r_qstn_rep4" class="form-group">
		<label id="elh_app_test_question_qstn_rep4" for="x_qstn_rep4" class="<?php echo $app_test_question_add->LeftColumnClass ?>"><?php echo $app_test_question->qstn_rep4->FldCaption() ?></label>
		<div class="<?php echo $app_test_question_add->RightColumnClass ?>"><div<?php echo $app_test_question->qstn_rep4->CellAttributes() ?>>
...
<?php if (!$app_test_question_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_question_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_test_question_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fapp_test_questionadd.Init();
</script>
<?php
$app_test_question_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_question_add->Page_Terminate();
?>
