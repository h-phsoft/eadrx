...
<?php if ($app_tips_package->cycle_id->Visible) { // cycle_id ?>
	<div id="r_cycle_id" class="form-group">
		<label id="elh_app_tips_package_cycle_id" for="x_cycle_id" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->cycle_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
