...
$app_tips_package_edit = NULL; // Initialize page object first

class capp_tips_package_edit extends capp_tips_package {
	...
	// Page object name
	var $PageObjName = 'app_tips_package_edit';
		...
		if (@$_POST["ajax"] == "autofill") {
			...
			if ($sDetailTblVar <> "") {
				...
				if (in_array("app_tips_pkg_cat", $DetailTblVar)) {
					...
					// Process auto fill for detail table 'app_tips_pkg_cat'
					if (preg_match('/^fapp_tips_pkg_cat(grid|add|addopt|edit|update|search)$/', @$_POST["form"])) {
						if (!isset($GLOBALS["app_tips_pkg_cat_grid"])) $GLOBALS["app_tips_pkg_cat_grid"] = new capp_tips_pkg_cat_grid;
						$GLOBALS["app_tips_pkg_cat_grid"]->Page_Init();
						$this->Page_Terminate();
						exit();
					}
				}
	...
	function ValidateForm() {
		...
		if (in_array("app_tips_pkg_cat", $DetailTblVar) && $GLOBALS["app_tips_pkg_cat"]->DetailEdit) {
			if (!isset($GLOBALS["app_tips_pkg_cat_grid"])) $GLOBALS["app_tips_pkg_cat_grid"] = new capp_tips_pkg_cat_grid(); // get detail page object
			$GLOBALS["app_tips_pkg_cat_grid"]->ValidateGridForm();
		}
		...
		if ($rs->EOF) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("app_tips_pkg_cat", $DetailTblVar) && $GLOBALS["app_tips_pkg_cat"]->DetailEdit) {
						if (!isset($GLOBALS["app_tips_pkg_cat_grid"])) $GLOBALS["app_tips_pkg_cat_grid"] = new capp_tips_pkg_cat_grid(); // Get detail page object
						$Security->LoadCurrentUserLevel($this->ProjectID . "app_tips_pkg_cat"); // Load user level of detail table
						$EditRow = $GLOBALS["app_tips_pkg_cat_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("app_tips_pkg_cat", $DetailTblVar)) {
				...
				if ($GLOBALS["app_tips_pkg_cat_grid"]->DetailEdit) {
					$GLOBALS["app_tips_pkg_cat_grid"]->CurrentMode = "edit";
					$GLOBALS["app_tips_pkg_cat_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($app_tips_package_edit)) $app_tips_package_edit = new capp_tips_package_edit();

// Page init
$app_tips_package_edit->Page_Init();

// Page main
$app_tips_package_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_tips_package_edit->Page_Render();
?>
...
var CurrentForm = fapp_tips_packageedit = new ew_Form("fapp_tips_packageedit", "edit");

// Validate form
fapp_tips_packageedit.Validate = function() {
...
fapp_tips_packageedit.Form_CustomValidate = 
...
fapp_tips_packageedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_tips_packageedit.Lists["x_cycle_id"] = {"LinkField":"x_cycle_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cycle_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_bill_cycle"};
fapp_tips_packageedit.Lists["x_cycle_id"].Data = "<?php echo $app_tips_package_edit->cycle_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_tips_packageedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fapp_tips_packageedit.Lists["x_status_id"].Data = "<?php echo $app_tips_package_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_tips_package_edit->ShowPageHeader(); ?>
<?php
$app_tips_package_edit->ShowMessage();
?>
<?php if (!$app_tips_package_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_tips_package_edit->Pager)) $app_tips_package_edit->Pager = new cPrevNextPager($app_tips_package_edit->StartRec, $app_tips_package_edit->DisplayRecs, $app_tips_package_edit->TotalRecs, $app_tips_package_edit->AutoHidePager) ?>
<?php if ($app_tips_package_edit->Pager->RecordCount > 0 && $app_tips_package_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_tips_package_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_tips_package_edit->PageUrl() ?>start=<?php echo $app_tips_package_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_tips_package_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_tips_package_edit->PageUrl() ?>start=<?php echo $app_tips_package_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_tips_package_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_tips_package_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_tips_package_edit->PageUrl() ?>start=<?php echo $app_tips_package_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_tips_package_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_tips_package_edit->PageUrl() ?>start=<?php echo $app_tips_package_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_tips_package_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_tips_packageedit" id="fapp_tips_packageedit" class="<?php echo $app_tips_package_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_tips_package_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_tips_package_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_tips_package">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_tips_package_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($app_tips_package->cycle_id->Visible) { // cycle_id ?>
	<div id="r_cycle_id" class="form-group">
		<label id="elh_app_tips_package_cycle_id" for="x_cycle_id" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->cycle_id->FldCaption() ?></label>
		<div class="<?php echo $app_tips_package_edit->RightColumnClass ?>"><div<?php echo $app_tips_package->cycle_id->CellAttributes() ?>>
...
<?php if ($app_tips_package->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_app_tips_package_status_id" for="x_status_id" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->status_id->FldCaption() ?></label>
		<div class="<?php echo $app_tips_package_edit->RightColumnClass ?>"><div<?php echo $app_tips_package->status_id->CellAttributes() ?>>
...
<?php if ($app_tips_package->pkg_order->Visible) { // pkg_order ?>
	<div id="r_pkg_order" class="form-group">
		<label id="elh_app_tips_package_pkg_order" for="x_pkg_order" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->pkg_order->FldCaption() ?></label>
		<div class="<?php echo $app_tips_package_edit->RightColumnClass ?>"><div<?php echo $app_tips_package->pkg_order->CellAttributes() ?>>
...
<?php if ($app_tips_package->pkg_name->Visible) { // pkg_name ?>
	<div id="r_pkg_name" class="form-group">
		<label id="elh_app_tips_package_pkg_name" for="x_pkg_name" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->pkg_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_tips_package_edit->RightColumnClass ?>"><div<?php echo $app_tips_package->pkg_name->CellAttributes() ?>>
...
<?php if ($app_tips_package->pkg_price->Visible) { // pkg_price ?>
	<div id="r_pkg_price" class="form-group">
		<label id="elh_app_tips_package_pkg_price" for="x_pkg_price" class="<?php echo $app_tips_package_edit->LeftColumnClass ?>"><?php echo $app_tips_package->pkg_price->FldCaption() ?></label>
		<div class="<?php echo $app_tips_package_edit->RightColumnClass ?>"><div<?php echo $app_tips_package->pkg_price->CellAttributes() ?>>
...
<input type="hidden" data-table="app_tips_package" data-field="x_pkg_id" name="x_pkg_id" id="x_pkg_id" value="<?php echo ew_HtmlEncode($app_tips_package->pkg_id->CurrentValue) ?>">
<?php
	if (in_array("app_tips_pkg_cat", explode(",", $app_tips_package->getCurrentDetailTable())) && $app_tips_pkg_cat->DetailEdit) {
?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_tips_package_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_tips_package_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_tips_packageedit.Init();
</script>
<?php
$app_tips_package_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_tips_package_edit->Page_Terminate();
?>
