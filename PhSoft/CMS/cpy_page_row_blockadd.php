...
$cpy_page_row_block_add = NULL; // Initialize page object first

class ccpy_page_row_block_add extends ccpy_page_row_block {
	...
	// Page object name
	var $PageObjName = 'cpy_page_row_block_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("cpy_page_row_blocklist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cpy_page_row_blockview.php")
	...
	function LoadDefaultValues() {
		...
		$this->blk_image->CurrentValue = NULL; // Clear file related field
	...
	function RenderRow() {
		...
		$this->blk_text->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->blk_image);
	...
	function AddRow($rsold = NULL) {
		...
		// blk_text
		$this->blk_text->SetDbValueDef($rsnew, $this->blk_text->CurrentValue, NULL, FALSE);
		if ($this->blk_image->Visible && !$this->blk_image->Upload->KeepFile) {
			$this->blk_image->UploadPath = '../../assets/pages/img/pageImages';
...
// Create page object
if (!isset($cpy_page_row_block_add)) $cpy_page_row_block_add = new ccpy_page_row_block_add();

// Page init
$cpy_page_row_block_add->Page_Init();

// Page main
$cpy_page_row_block_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_page_row_block_add->Page_Render();
?>
...
var CurrentForm = fcpy_page_row_blockadd = new ew_Form("fcpy_page_row_blockadd", "add");

// Validate form
fcpy_page_row_blockadd.Validate = function() {
...
fcpy_page_row_blockadd.Form_CustomValidate = 
...
fcpy_page_row_blockadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_page_row_blockadd.Lists["x_row_id"] = {"LinkField":"x_row_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_row_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_page_row"};
fcpy_page_row_blockadd.Lists["x_row_id"].Data = "<?php echo $cpy_page_row_block_add->row_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_page_row_blockadd.Lists["x_type_id"] = {"LinkField":"x_type_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_type_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_block_type"};
fcpy_page_row_blockadd.Lists["x_type_id"].Data = "<?php echo $cpy_page_row_block_add->type_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_page_row_blockadd.Lists["x_slid_id"] = {"LinkField":"x_slid_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_slid_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_slider_mst"};
fcpy_page_row_blockadd.Lists["x_slid_id"].Data = "<?php echo $cpy_page_row_block_add->slid_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_page_row_blockadd.Lists["x_video_id"] = {"LinkField":"x_video_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_video_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_video"};
fcpy_page_row_blockadd.Lists["x_video_id"].Data = "<?php echo $cpy_page_row_block_add->video_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_page_row_blockadd.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_page_row_blockadd.Lists["x_status_id"].Data = "<?php echo $cpy_page_row_block_add->status_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_page_row_blockadd.Lists["x_cols_id"] = {"LinkField":"x_cols_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cols_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_cols"};
fcpy_page_row_blockadd.Lists["x_cols_id"].Data = "<?php echo $cpy_page_row_block_add->cols_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $cpy_page_row_block_add->ShowPageHeader(); ?>
<?php
$cpy_page_row_block_add->ShowMessage();
?>
<form name="fcpy_page_row_blockadd" id="fcpy_page_row_blockadd" class="<?php echo $cpy_page_row_block_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_page_row_block_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_page_row_block_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_page_row_block">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cpy_page_row_block_add->IsModal) ?>">
...
<?php if ($cpy_page_row_block->row_id->Visible) { // row_id ?>
	<div id="r_row_id" class="form-group">
		<label id="elh_cpy_page_row_block_row_id" for="x_row_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->row_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->row_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->type_id->Visible) { // type_id ?>
	<div id="r_type_id" class="form-group">
		<label id="elh_cpy_page_row_block_type_id" for="x_type_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->type_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->type_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->slid_id->Visible) { // slid_id ?>
	<div id="r_slid_id" class="form-group">
		<label id="elh_cpy_page_row_block_slid_id" for="x_slid_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->slid_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->slid_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->video_id->Visible) { // video_id ?>
	<div id="r_video_id" class="form-group">
		<label id="elh_cpy_page_row_block_video_id" for="x_video_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->video_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->video_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_cpy_page_row_block_status_id" for="x_status_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->status_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->cols_id->Visible) { // cols_id ?>
	<div id="r_cols_id" class="form-group">
		<label id="elh_cpy_page_row_block_cols_id" for="x_cols_id" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->cols_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->cols_id->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_order->Visible) { // blk_order ?>
	<div id="r_blk_order" class="form-group">
		<label id="elh_cpy_page_row_block_blk_order" for="x_blk_order" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_order->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_name->Visible) { // blk_name ?>
	<div id="r_blk_name" class="form-group">
		<label id="elh_cpy_page_row_block_blk_name" for="x_blk_name" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_name->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_header->Visible) { // blk_header ?>
	<div id="r_blk_header" class="form-group">
		<label id="elh_cpy_page_row_block_blk_header" for="x_blk_header" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_header->FldCaption() ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_header->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_image->Visible) { // blk_image ?>
	<div id="r_blk_image" class="form-group">
		<label id="elh_cpy_page_row_block_blk_image" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_image->FldCaption() ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_image->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_stext->Visible) { // blk_stext ?>
	<div id="r_blk_stext" class="form-group">
		<label id="elh_cpy_page_row_block_blk_stext" for="x_blk_stext" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_stext->FldCaption() ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_stext->CellAttributes() ?>>
...
<?php if ($cpy_page_row_block->blk_text->Visible) { // blk_text ?>
	<div id="r_blk_text" class="form-group">
		<label id="elh_cpy_page_row_block_blk_text" class="<?php echo $cpy_page_row_block_add->LeftColumnClass ?>"><?php echo $cpy_page_row_block->blk_text->FldCaption() ?></label>
		<div class="<?php echo $cpy_page_row_block_add->RightColumnClass ?>"><div<?php echo $cpy_page_row_block->blk_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_page_row_blockadd", "x_blk_text", 35, 8, <?php echo ($cpy_page_row_block->blk_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if (!$cpy_page_row_block_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_page_row_block_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_page_row_block_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcpy_page_row_blockadd.Init();
</script>
<?php
$cpy_page_row_block_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_page_row_block_add->Page_Terminate();
?>
