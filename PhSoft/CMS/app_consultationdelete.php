...
$app_consultation_delete = NULL; // Initialize page object first

class capp_consultation_delete extends capp_consultation {
	...
	// Page object name
	var $PageObjName = 'app_consultation_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("app_consultationlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in app_consultation class, app_consultationinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("app_consultationlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($app_consultation_delete)) $app_consultation_delete = new capp_consultation_delete();

// Page init
$app_consultation_delete->Page_Init();

// Page main
$app_consultation_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_consultation_delete->Page_Render();
?>
...
var CurrentForm = fapp_consultationdelete = new ew_Form("fapp_consultationdelete", "delete");

// Form_CustomValidate event
fapp_consultationdelete.Form_CustomValidate = 
...
fapp_consultationdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_consultationdelete.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_consultationdelete.Lists["x_user_id"].Data = "<?php echo $app_consultation_delete->user_id->LookupFilterQuery(FALSE, "delete") ?>";
fapp_consultationdelete.Lists["x_cstatus_id"] = {"LinkField":"x_cstatus_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cstatus_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_consultation_status"};
fapp_consultationdelete.Lists["x_cstatus_id"].Data = "<?php echo $app_consultation_delete->cstatus_id->LookupFilterQuery(FALSE, "delete") ?>";
fapp_consultationdelete.Lists["x_cat_id"] = {"LinkField":"x_cat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_consultation_category"};
fapp_consultationdelete.Lists["x_cat_id"].Data = "<?php echo $app_consultation_delete->cat_id->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php $app_consultation_delete->ShowPageHeader(); ?>
<?php
$app_consultation_delete->ShowMessage();
?>
<form name="fapp_consultationdelete" id="fapp_consultationdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_consultation_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_consultation_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_consultation">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($app_consultation_delete->RecKeys as $key) { ?>
...
<?php if ($app_consultation->user_id->Visible) { // user_id ?>
		<th class="<?php echo $app_consultation->user_id->HeaderCellClass() ?>"><span id="elh_app_consultation_user_id" class="app_consultation_user_id"><?php echo $app_consultation->user_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->cstatus_id->Visible) { // cstatus_id ?>
		<th class="<?php echo $app_consultation->cstatus_id->HeaderCellClass() ?>"><span id="elh_app_consultation_cstatus_id" class="app_consultation_cstatus_id"><?php echo $app_consultation->cstatus_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->cat_id->Visible) { // cat_id ?>
		<th class="<?php echo $app_consultation->cat_id->HeaderCellClass() ?>"><span id="elh_app_consultation_cat_id" class="app_consultation_cat_id"><?php echo $app_consultation->cat_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->cons_amount->Visible) { // cons_amount ?>
		<th class="<?php echo $app_consultation->cons_amount->HeaderCellClass() ?>"><span id="elh_app_consultation_cons_amount" class="app_consultation_cons_amount"><?php echo $app_consultation->cons_amount->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->cons_file->Visible) { // cons_file ?>
		<th class="<?php echo $app_consultation->cons_file->HeaderCellClass() ?>"><span id="elh_app_consultation_cons_file" class="app_consultation_cons_file"><?php echo $app_consultation->cons_file->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->cons_audio->Visible) { // cons_audio ?>
		<th class="<?php echo $app_consultation->cons_audio->HeaderCellClass() ?>"><span id="elh_app_consultation_cons_audio" class="app_consultation_cons_audio"><?php echo $app_consultation->cons_audio->FldCaption() ?></span></th>
<?php } ?>
<?php if ($app_consultation->ins_datetime->Visible) { // ins_datetime ?>
		<th class="<?php echo $app_consultation->ins_datetime->HeaderCellClass() ?>"><span id="elh_app_consultation_ins_datetime" class="app_consultation_ins_datetime"><?php echo $app_consultation->ins_datetime->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$app_consultation_delete->RecCnt = 0;
$i = 0;
while (!$app_consultation_delete->Recordset->EOF) {
	$app_consultation_delete->RecCnt++;
	$app_consultation_delete->RowCnt++;

	// Set row properties
	$app_consultation->ResetAttrs();
	$app_consultation->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$app_consultation_delete->LoadRowValues($app_consultation_delete->Recordset);

	// Render row
	$app_consultation_delete->RenderRow();
?>
	<tr<?php echo $app_consultation->RowAttributes() ?>>
<?php if ($app_consultation->user_id->Visible) { // user_id ?>
		<td<?php echo $app_consultation->user_id->CellAttributes() ?>>
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_user_id" class="app_consultation_user_id">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_cstatus_id" class="app_consultation_cstatus_id">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_cat_id" class="app_consultation_cat_id">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_cons_amount" class="app_consultation_cons_amount">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_cons_file" class="app_consultation_cons_file">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_cons_audio" class="app_consultation_cons_audio">
...
<span id="el<?php echo $app_consultation_delete->RowCnt ?>_app_consultation_ins_datetime" class="app_consultation_ins_datetime">
...
<?php
	$app_consultation_delete->Recordset->MoveNext();
}
$app_consultation_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_consultation_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fapp_consultationdelete.Init();
</script>
<?php
$app_consultation_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_consultation_delete->Page_Terminate();
?>
