...
class ccpy_vteam extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'cpy_vteam';
		$this->TableName = 'cpy_vteam';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`cpy_vteam`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// team_id
		$this->team_id = new cField('cpy_vteam', 'cpy_vteam', 'x_team_id', 'team_id', '`team_id`', '`team_id`', 3, -1, FALSE, '`team_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// team_position
		$this->team_position = new cField('cpy_vteam', 'cpy_vteam', 'x_team_position', 'team_position', '`team_position`', '`team_position`', 200, -1, FALSE, '`team_position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->team_position->Sortable = TRUE; // Allow sort
		$this->fields['team_position'] = &$this->team_position;

		// team_text
		$this->team_text = new cField('cpy_vteam', 'cpy_vteam', 'x_team_text', 'team_text', '`team_text`', '`team_text`', 201, -1, FALSE, '`team_text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cpy_vteam`";
	}
	...
	function SqlKeyFilter() {
		return "`team_id` = @team_id@ AND `teamn_id` = @teamn_id@";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "cpy_vteamview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "cpy_vteamedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cpy_vteamadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cpy_vteamview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cpy_vteamview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cpy_vteamadd.php?" . $this->UrlParm($parm);
		else
			$url = "cpy_vteamadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cpy_vteamedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cpy_vteamadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cpy_vteamdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->teamn_id->CurrentValue = $key[1];
