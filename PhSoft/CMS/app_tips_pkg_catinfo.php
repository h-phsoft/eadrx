...
$app_tips_pkg_cat = NULL;

//
// Table class for app_tips_pkg_cat
//
class capp_tips_pkg_cat extends cTable {
	var $tpkg_id;
	var $pkg_id;
	var $tcat_id;
	...
	function __construct() {
		...
		$this->TableVar = 'app_tips_pkg_cat';
		$this->TableName = 'app_tips_pkg_cat';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_tips_pkg_cat`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// tpkg_id
		$this->tpkg_id = new cField('app_tips_pkg_cat', 'app_tips_pkg_cat', 'x_tpkg_id', 'tpkg_id', '`tpkg_id`', '`tpkg_id`', 3, -1, FALSE, '`tpkg_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pkg_id
		$this->pkg_id = new cField('app_tips_pkg_cat', 'app_tips_pkg_cat', 'x_pkg_id', 'pkg_id', '`pkg_id`', '`pkg_id`', 3, -1, FALSE, '`pkg_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tcat_id
		$this->tcat_id = new cField('app_tips_pkg_cat', 'app_tips_pkg_cat', 'x_tcat_id', 'tcat_id', '`tcat_id`', '`tcat_id`', 3, -1, FALSE, '`tcat_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "app_tips_package") {
			if ($this->pkg_id->getSessionValue() <> "")
				$sMasterFilter .= "`pkg_id`=" . ew_QuotedValue($this->pkg_id->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "app_tips_package") {
			if ($this->pkg_id->getSessionValue() <> "")
				$sDetailFilter .= "`pkg_id`=" . ew_QuotedValue($this->pkg_id->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_app_tips_package() {
		return "`pkg_id`=@pkg_id@";
	}

	// Detail filter
	function SqlDetailFilter_app_tips_package() {
		return "`pkg_id`=@pkg_id@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_tips_pkg_cat`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`pkg_id` ASC,`tcat_id` ASC";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "app_tips_pkg_catlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_tips_pkg_catedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_tips_pkg_catadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_tips_pkg_catview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_tips_pkg_catview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_tips_pkg_catadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_tips_pkg_catadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("app_tips_pkg_catedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("app_tips_pkg_catadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_tips_pkg_catdelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "app_tips_package" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			$url .= (strpos($url, "?") !== FALSE ? "&" : "?") . EW_TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_pkg_id=" . urlencode($this->pkg_id->CurrentValue);
		}
		return $url;
	}
