...
fphs_userssearch.Lists["x_pgrp_id"] = {"LinkField":"x_user_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_user_id","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_users"};
fphs_userssearch.Lists["x_pgrp_id"].Options = <?php echo json_encode($phs_users_search->pgrp_id->Options()) ?>;
...
<?php if (strval($phs_users->pgrp_id->AdvancedSearch->SearchValue) == "") $phs_users->pgrp_id->AdvancedSearch->SearchValue = CurrentUserID() ?>
