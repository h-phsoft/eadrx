...
$app_consult_answer_grid = NULL; // Initialize page object first

class capp_consult_answer_grid extends capp_consult_answer {
	...
	// Page object name
	var $PageObjName = 'app_consult_answer_grid';

	// Grid form hidden field names
	var $FormName = 'fapp_consult_answergrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["app_consult_answer"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->answer_id->CurrentValue = strval($arKeys[0]); // answer_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
