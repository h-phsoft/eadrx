...
$app_tips_edit = NULL; // Initialize page object first

class capp_tips_edit extends capp_tips {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_tipslist.php"); // Return to list page
			...
			if (!is_null($this->tips_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->tips_id->CurrentValue) == strval($this->Recordset->fields('tips_id'))) {
	...
	function LoadFormValues() {
		...
		if (!$this->tips_id->FldIsDetailKey)
			$this->tips_id->setFormValue($objForm->GetValue("x_tips_id"));
	}
...
// Create page object
if (!isset($app_tips_edit)) $app_tips_edit = new capp_tips_edit();

// Page init
$app_tips_edit->Page_Init();

// Page main
$app_tips_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_tips_edit->Page_Render();
?>
...
var CurrentForm = fapp_tipsedit = new ew_Form("fapp_tipsedit", "edit");

// Validate form
fapp_tipsedit.Validate = function() {
...
fapp_tipsedit.Form_CustomValidate = 
...
fapp_tipsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_tipsedit.Lists["x_tcat_id"] = {"LinkField":"x_tcat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tcat_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_category"};
fapp_tipsedit.Lists["x_tcat_id"].Data = "<?php echo $app_tips_edit->tcat_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_tipsedit.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_tipsedit.Lists["x_lang_id"].Data = "<?php echo $app_tips_edit->lang_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_tipsedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fapp_tipsedit.Lists["x_status_id"].Data = "<?php echo $app_tips_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_tips_edit->ShowPageHeader(); ?>
<?php
$app_tips_edit->ShowMessage();
?>
<?php if (!$app_tips_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_tips_edit->Pager)) $app_tips_edit->Pager = new cPrevNextPager($app_tips_edit->StartRec, $app_tips_edit->DisplayRecs, $app_tips_edit->TotalRecs, $app_tips_edit->AutoHidePager) ?>
<?php if ($app_tips_edit->Pager->RecordCount > 0 && $app_tips_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_tips_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_tips_edit->PageUrl() ?>start=<?php echo $app_tips_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_tips_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_tips_edit->PageUrl() ?>start=<?php echo $app_tips_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_tips_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_tips_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_tips_edit->PageUrl() ?>start=<?php echo $app_tips_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_tips_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_tips_edit->PageUrl() ?>start=<?php echo $app_tips_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_tips_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_tipsedit" id="fapp_tipsedit" class="<?php echo $app_tips_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_tips_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_tips_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_tips">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_tips_edit->IsModal) ?>">
...
<?php if ($app_tips->tcat_id->Visible) { // tcat_id ?>
	<div id="r_tcat_id" class="form-group">
		<label id="elh_app_tips_tcat_id" for="x_tcat_id" class="<?php echo $app_tips_edit->LeftColumnClass ?>"><?php echo $app_tips->tcat_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_tips_edit->RightColumnClass ?>"><div<?php echo $app_tips->tcat_id->CellAttributes() ?>>
...
<?php if ($app_tips->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_tips_lang_id" for="x_lang_id" class="<?php echo $app_tips_edit->LeftColumnClass ?>"><?php echo $app_tips->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_tips_edit->RightColumnClass ?>"><div<?php echo $app_tips->lang_id->CellAttributes() ?>>
...
<?php if ($app_tips->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_app_tips_status_id" for="x_status_id" class="<?php echo $app_tips_edit->LeftColumnClass ?>"><?php echo $app_tips->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_tips_edit->RightColumnClass ?>"><div<?php echo $app_tips->status_id->CellAttributes() ?>>
...
<?php if ($app_tips->tips_text->Visible) { // tips_text ?>
	<div id="r_tips_text" class="form-group">
		<label id="elh_app_tips_tips_text" class="<?php echo $app_tips_edit->LeftColumnClass ?>"><?php echo $app_tips->tips_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_tips_edit->RightColumnClass ?>"><div<?php echo $app_tips->tips_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_tipsedit", "x_tips_text", 35, 4, <?php echo ($app_tips->tips_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($app_tips->ins_datetime->Visible) { // ins_datetime ?>
	<div id="r_ins_datetime" class="form-group">
		<label id="elh_app_tips_ins_datetime" for="x_ins_datetime" class="<?php echo $app_tips_edit->LeftColumnClass ?>"><?php echo $app_tips->ins_datetime->FldCaption() ?></label>
		<div class="<?php echo $app_tips_edit->RightColumnClass ?>"><div<?php echo $app_tips->ins_datetime->CellAttributes() ?>>
...
<input type="hidden" data-table="app_tips" data-field="x_tips_id" name="x_tips_id" id="x_tips_id" value="<?php echo ew_HtmlEncode($app_tips->tips_id->CurrentValue) ?>">
<?php if (!$app_tips_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_tips_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_tips_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
