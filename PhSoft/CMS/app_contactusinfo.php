...
//
// Table class for app_contactus
//
class capp_contactus extends cTable {
	var $cont_id;
	var $user_id;
	var $cont_subj;
	var $cont_msg;
	...
	function __construct() {
		...
		$this->TableVar = 'app_contactus';
		$this->TableName = 'app_contactus';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`app_contactus`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// cont_id
		$this->cont_id = new cField('app_contactus', 'app_contactus', 'x_cont_id', 'cont_id', '`cont_id`', '`cont_id`', 3, -1, FALSE, '`cont_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// user_id
		$this->user_id = new cField('app_contactus', 'app_contactus', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// cont_subj
		$this->cont_subj = new cField('app_contactus', 'app_contactus', 'x_cont_subj', 'cont_subj', '`cont_subj`', '`cont_subj`', 200, -1, FALSE, '`cont_subj`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cont_subj->Sortable = TRUE; // Allow sort
		$this->fields['cont_subj'] = &$this->cont_subj;

		// cont_msg
		$this->cont_msg = new cField('app_contactus', 'app_contactus', 'x_cont_msg', 'cont_msg', '`cont_msg`', '`cont_msg`', 201, -1, FALSE, '`cont_msg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->cont_msg->Sortable = TRUE; // Allow sort
		$this->fields['cont_msg'] = &$this->cont_msg;

		// cont_datetime
		$this->cont_datetime = new cField('app_contactus', 'app_contactus', 'x_cont_datetime', 'cont_datetime', '`cont_datetime`', ew_CastDateFieldForLike('`cont_datetime`', 0, "DB"), 135, 0, FALSE, '`cont_datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_contactus`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`cont_datetime` ASC,`user_id` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "app_contactusedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "app_contactusadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("app_contactusview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("app_contactusview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "app_contactusadd.php?" . $this->UrlParm($parm);
		else
			$url = "app_contactusadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("app_contactusedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("app_contactusadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("app_contactusdelete.php", $this->UrlParm());
	}
