...
<?php if ($app_notification->for_id->Visible) { // for_id ?>
	<div id="r_for_id" class="form-group">
		<label id="elh_app_notification_for_id" for="x_for_id" class="<?php echo $app_notification_edit->LeftColumnClass ?>"><?php echo $app_notification->for_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($app_notification->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_notification_lang_id" for="x_lang_id" class="<?php echo $app_notification_edit->LeftColumnClass ?>"><?php echo $app_notification->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($app_notification->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label id="elh_app_notification_nstatus_id" for="x_nstatus_id" class="<?php echo $app_notification_edit->LeftColumnClass ?>"><?php echo $app_notification->nstatus_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
