...
fcpy_pagesearch.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_pagesearch.Lists["x_status_id"].Data = "<?php echo $cpy_page_search->status_id->LookupFilterQuery(FALSE, "search") ?>";
...
<?php if ($cpy_page->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label for="x_status_id" class="<?php echo $cpy_page_search->LeftColumnClass ?>"><span id="elh_cpy_page_status_id"><?php echo $cpy_page->status_id->FldCaption() ?></span>
		...
		<div class="<?php echo $cpy_page_search->RightColumnClass ?>"><div<?php echo $cpy_page->status_id->CellAttributes() ?>>
...
<?php if ($cpy_page->page_desc->Visible) { // page_desc ?>
	<div id="r_page_desc" class="form-group">
		<label for="x_page_desc" class="<?php echo $cpy_page_search->LeftColumnClass ?>"><span id="elh_cpy_page_page_desc"><?php echo $cpy_page->page_desc->FldCaption() ?></span>
