...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>favicon.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>favicon.ico">
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<span class="logo-lg">PhSoft 2018</span>
		</div>
		<!-- Header Navbar -->
