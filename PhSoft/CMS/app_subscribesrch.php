...
fapp_subscribesearch.Lists["x_pkg_id"] = {"LinkField":"x_pkg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pkg_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_tips_package"};
fapp_subscribesearch.Lists["x_pkg_id"].Data = "<?php echo $app_subscribe_search->pkg_id->LookupFilterQuery(FALSE, "search") ?>";
...
<?php if ($app_subscribe->pkg_id->Visible) { // pkg_id ?>
	<div id="r_pkg_id" class="form-group">
		<label for="x_pkg_id" class="<?php echo $app_subscribe_search->LeftColumnClass ?>"><span id="elh_app_subscribe_pkg_id"><?php echo $app_subscribe->pkg_id->FldCaption() ?></span>
		...
		<div class="<?php echo $app_subscribe_search->RightColumnClass ?>"><div<?php echo $app_subscribe->pkg_id->CellAttributes() ?>>
