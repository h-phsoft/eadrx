...
$phs_language_add = NULL; // Initialize page object first

class cphs_language_add extends cphs_language {
	...
	// Page object name
	var $PageObjName = 'phs_language_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("phs_languagelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "phs_languageview.php")
...
// Create page object
if (!isset($phs_language_add)) $phs_language_add = new cphs_language_add();

// Page init
$phs_language_add->Page_Init();

// Page main
$phs_language_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_language_add->Page_Render();
?>
...
var CurrentForm = fphs_languageadd = new ew_Form("fphs_languageadd", "add");

// Validate form
fphs_languageadd.Validate = function() {
...
fphs_languageadd.Form_CustomValidate = 
...
fphs_languageadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fphs_languageadd.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fphs_languageadd.Lists["x_status_id"].Data = "<?php echo $phs_language_add->status_id->LookupFilterQuery(FALSE, "add") ?>";
fphs_languageadd.Lists["x_lang_dir"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fphs_languageadd.Lists["x_lang_dir"].Options = <?php echo json_encode($phs_language_add->lang_dir->Options()) ?>;
...
<?php $phs_language_add->ShowPageHeader(); ?>
<?php
$phs_language_add->ShowMessage();
?>
<form name="fphs_languageadd" id="fphs_languageadd" class="<?php echo $phs_language_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_language_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_language_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_language">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($phs_language_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($phs_language->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_phs_language_status_id" for="x_status_id" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->status_id->CellAttributes() ?>>
...
<?php if ($phs_language->lang_code->Visible) { // lang_code ?>
	<div id="r_lang_code" class="form-group">
		<label id="elh_phs_language_lang_code" for="x_lang_code" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->lang_code->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->lang_code->CellAttributes() ?>>
...
<?php if ($phs_language->lang_dir->Visible) { // lang_dir ?>
	<div id="r_lang_dir" class="form-group">
		<label id="elh_phs_language_lang_dir" for="x_lang_dir" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->lang_dir->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->lang_dir->CellAttributes() ?>>
...
<?php if ($phs_language->lang_name->Visible) { // lang_name ?>
	<div id="r_lang_name" class="form-group">
		<label id="elh_phs_language_lang_name" for="x_lang_name" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->lang_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->lang_name->CellAttributes() ?>>
...
<?php if ($phs_language->lang_dname->Visible) { // lang_dname ?>
	<div id="r_lang_dname" class="form-group">
		<label id="elh_phs_language_lang_dname" for="x_lang_dname" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->lang_dname->FldCaption() ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->lang_dname->CellAttributes() ?>>
...
<?php if ($phs_language->lang_ccode->Visible) { // lang_ccode ?>
	<div id="r_lang_ccode" class="form-group">
		<label id="elh_phs_language_lang_ccode" for="x_lang_ccode" class="<?php echo $phs_language_add->LeftColumnClass ?>"><?php echo $phs_language->lang_ccode->FldCaption() ?></label>
		<div class="<?php echo $phs_language_add->RightColumnClass ?>"><div<?php echo $phs_language->lang_ccode->CellAttributes() ?>>
...
<?php if (!$phs_language_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_language_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_language_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fphs_languageadd.Init();
</script>
<?php
$phs_language_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$phs_language_add->Page_Terminate();
?>
