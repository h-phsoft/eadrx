...
class ccpy_page_edit extends ccpy_page {
	...
	function ValidateForm() {
		...
		if (in_array("cpy_page_row", $DetailTblVar) && $GLOBALS["cpy_page_row"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("cpy_page_row", $DetailTblVar) && $GLOBALS["cpy_page_row"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["cpy_page_row_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("cpy_page_row", $DetailTblVar)) {
				...
				if ($GLOBALS["cpy_page_row_grid"]->DetailEdit) {
					$GLOBALS["cpy_page_row_grid"]->CurrentMode = "edit";
					$GLOBALS["cpy_page_row_grid"]->CurrentAction = "gridedit";
...
fcpy_pageedit.Lists["x_status_id"] = {"LinkField":"x_status_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_status_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_status"};
fcpy_pageedit.Lists["x_status_id"].Data = "<?php echo $cpy_page_edit->status_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($cpy_page->status_id->Visible) { // status_id ?>
	<div id="r_status_id" class="form-group">
		<label id="elh_cpy_page_status_id" for="x_status_id" class="<?php echo $cpy_page_edit->LeftColumnClass ?>"><?php echo $cpy_page->status_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_edit->RightColumnClass ?>"><div<?php echo $cpy_page->status_id->CellAttributes() ?>>
...
<?php if ($cpy_page->slid_id->Visible) { // slid_id ?>
	<div id="r_slid_id" class="form-group">
		<label id="elh_cpy_page_slid_id" for="x_slid_id" class="<?php echo $cpy_page_edit->LeftColumnClass ?>"><?php echo $cpy_page->slid_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($cpy_page->page_desc->Visible) { // page_desc ?>
	<div id="r_page_desc" class="form-group">
		<label id="elh_cpy_page_page_desc" for="x_page_desc" class="<?php echo $cpy_page_edit->LeftColumnClass ?>"><?php echo $cpy_page->page_desc->FldCaption() ?></label>
...
<?php
	if (in_array("cpy_page_row", explode(",", $cpy_page->getCurrentDetailTable())) && $cpy_page_row->DetailEdit) {
?>
