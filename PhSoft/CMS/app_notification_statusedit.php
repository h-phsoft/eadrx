...
$app_notification_status_edit = NULL; // Initialize page object first

class capp_notification_status_edit extends capp_notification_status {
	...
	// Page object name
	var $PageObjName = 'app_notification_status_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_snotif_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_notification_statuslist.php"); // Return to list page
			...
			if (!is_null($this->snotif_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->snotif_id->CurrentValue) == strval($this->Recordset->fields('snotif_id'))) {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "app_notification_statuslist.php")
...
// Create page object
if (!isset($app_notification_status_edit)) $app_notification_status_edit = new capp_notification_status_edit();

// Page init
$app_notification_status_edit->Page_Init();

// Page main
$app_notification_status_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_notification_status_edit->Page_Render();
?>
...
var CurrentForm = fapp_notification_statusedit = new ew_Form("fapp_notification_statusedit", "edit");

// Validate form
fapp_notification_statusedit.Validate = function() {
...
fapp_notification_statusedit.Form_CustomValidate = 
...
fapp_notification_statusedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_notification_statusedit.Lists["x_notif_id"] = {"LinkField":"x_notif_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_notif_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notification"};
fapp_notification_statusedit.Lists["x_notif_id"].Data = "<?php echo $app_notification_status_edit->notif_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_notification_statusedit.Lists["x_nstatus_id"] = {"LinkField":"x_nstatus_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nstatus_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_notif_status"};
fapp_notification_statusedit.Lists["x_nstatus_id"].Data = "<?php echo $app_notification_status_edit->nstatus_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_notification_statusedit.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_user"};
fapp_notification_statusedit.Lists["x_user_id"].Data = "<?php echo $app_notification_status_edit->user_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_notification_status_edit->ShowPageHeader(); ?>
<?php
$app_notification_status_edit->ShowMessage();
?>
<?php if (!$app_notification_status_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_notification_status_edit->Pager)) $app_notification_status_edit->Pager = new cPrevNextPager($app_notification_status_edit->StartRec, $app_notification_status_edit->DisplayRecs, $app_notification_status_edit->TotalRecs, $app_notification_status_edit->AutoHidePager) ?>
<?php if ($app_notification_status_edit->Pager->RecordCount > 0 && $app_notification_status_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_notification_status_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_notification_status_edit->PageUrl() ?>start=<?php echo $app_notification_status_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_notification_status_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_notification_status_edit->PageUrl() ?>start=<?php echo $app_notification_status_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_notification_status_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_notification_status_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_notification_status_edit->PageUrl() ?>start=<?php echo $app_notification_status_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_notification_status_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_notification_status_edit->PageUrl() ?>start=<?php echo $app_notification_status_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_notification_status_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_notification_statusedit" id="fapp_notification_statusedit" class="<?php echo $app_notification_status_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_notification_status_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_notification_status_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_notification_status">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_notification_status_edit->IsModal) ?>">
<?php if ($app_notification_status->getCurrentMasterTable() == "app_notification") { ?>
...
<?php if ($app_notification_status->notif_id->Visible) { // notif_id ?>
	<div id="r_notif_id" class="form-group">
		<label id="elh_app_notification_status_notif_id" for="x_notif_id" class="<?php echo $app_notification_status_edit->LeftColumnClass ?>"><?php echo $app_notification_status->notif_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_edit->RightColumnClass ?>"><div<?php echo $app_notification_status->notif_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->nstatus_id->Visible) { // nstatus_id ?>
	<div id="r_nstatus_id" class="form-group">
		<label id="elh_app_notification_status_nstatus_id" for="x_nstatus_id" class="<?php echo $app_notification_status_edit->LeftColumnClass ?>"><?php echo $app_notification_status->nstatus_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_edit->RightColumnClass ?>"><div<?php echo $app_notification_status->nstatus_id->CellAttributes() ?>>
...
<?php if ($app_notification_status->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_app_notification_status_user_id" for="x_user_id" class="<?php echo $app_notification_status_edit->LeftColumnClass ?>"><?php echo $app_notification_status->user_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_notification_status_edit->RightColumnClass ?>"><div<?php echo $app_notification_status->user_id->CellAttributes() ?>>
...
<input type="hidden" data-table="app_notification_status" data-field="x_snotif_id" name="x_snotif_id" id="x_snotif_id" value="<?php echo ew_HtmlEncode($app_notification_status->snotif_id->CurrentValue) ?>">
<?php if (!$app_notification_status_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_notification_status_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_notification_status_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_notification_statusedit.Init();
</script>
<?php
$app_notification_status_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_notification_status_edit->Page_Terminate();
?>
