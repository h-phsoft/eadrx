...
$cpy_page_row_grid = NULL; // Initialize page object first

class ccpy_page_row_grid extends ccpy_page_row {
	...
	// Page object name
	var $PageObjName = 'cpy_page_row_grid';

	// Grid form hidden field names
	var $FormName = 'fcpy_page_rowgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cpy_page_row"];

		}
		$this->AddUrl = "cpy_page_rowadd.php";
