...
<input type="text" data-table="app_consultation_category_name" data-field="x_lang_id" name="x<?php echo $app_consultation_category_name_grid->RowIndex ?>_lang_id" id="x<?php echo $app_consultation_category_name_grid->RowIndex ?>_lang_id" size="30" placeholder="<?php echo ew_HtmlEncode($app_consultation_category_name->lang_id->getPlaceHolder()) ?>" value="<?php echo $app_consultation_category_name->lang_id->EditValue ?>"<?php echo $app_consultation_category_name->lang_id->EditAttributes() ?>>
</span>
