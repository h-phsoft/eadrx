...
$phs_keyvalues_edit = NULL; // Initialize page object first

class cphs_keyvalues_edit extends cphs_keyvalues {
	...
	// Page object name
	var $PageObjName = 'phs_keyvalues_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("phs_keyvalueslist.php"); // Return to list page
			...
			if (!is_null($this->kval_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->kval_id->CurrentValue) == strval($this->Recordset->fields('kval_id'))) {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "phs_keyvalueslist.php")
...
// Create page object
if (!isset($phs_keyvalues_edit)) $phs_keyvalues_edit = new cphs_keyvalues_edit();

// Page init
$phs_keyvalues_edit->Page_Init();

// Page main
$phs_keyvalues_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$phs_keyvalues_edit->Page_Render();
?>
...
var CurrentForm = fphs_keyvaluesedit = new ew_Form("fphs_keyvaluesedit", "edit");

// Validate form
fphs_keyvaluesedit.Validate = function() {
...
fphs_keyvaluesedit.Form_CustomValidate = 
...
fphs_keyvaluesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fphs_keyvaluesedit.Lists["x_key_id"] = {"LinkField":"x_key_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_key_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_keys"};
fphs_keyvaluesedit.Lists["x_key_id"].Data = "<?php echo $phs_keyvalues_edit->key_id->LookupFilterQuery(FALSE, "edit") ?>";
fphs_keyvaluesedit.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fphs_keyvaluesedit.Lists["x_lang_id"].Data = "<?php echo $phs_keyvalues_edit->lang_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $phs_keyvalues_edit->ShowPageHeader(); ?>
<?php
$phs_keyvalues_edit->ShowMessage();
?>
<?php if (!$phs_keyvalues_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($phs_keyvalues_edit->Pager)) $phs_keyvalues_edit->Pager = new cPrevNextPager($phs_keyvalues_edit->StartRec, $phs_keyvalues_edit->DisplayRecs, $phs_keyvalues_edit->TotalRecs, $phs_keyvalues_edit->AutoHidePager) ?>
<?php if ($phs_keyvalues_edit->Pager->RecordCount > 0 && $phs_keyvalues_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($phs_keyvalues_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $phs_keyvalues_edit->PageUrl() ?>start=<?php echo $phs_keyvalues_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($phs_keyvalues_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $phs_keyvalues_edit->PageUrl() ?>start=<?php echo $phs_keyvalues_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $phs_keyvalues_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($phs_keyvalues_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $phs_keyvalues_edit->PageUrl() ?>start=<?php echo $phs_keyvalues_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($phs_keyvalues_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $phs_keyvalues_edit->PageUrl() ?>start=<?php echo $phs_keyvalues_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $phs_keyvalues_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fphs_keyvaluesedit" id="fphs_keyvaluesedit" class="<?php echo $phs_keyvalues_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($phs_keyvalues_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $phs_keyvalues_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phs_keyvalues">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($phs_keyvalues_edit->IsModal) ?>">
<?php if ($phs_keyvalues->getCurrentMasterTable() == "phs_keys") { ?>
...
<?php if ($phs_keyvalues->key_id->Visible) { // key_id ?>
	<div id="r_key_id" class="form-group">
		<label id="elh_phs_keyvalues_key_id" for="x_key_id" class="<?php echo $phs_keyvalues_edit->LeftColumnClass ?>"><?php echo $phs_keyvalues->key_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keyvalues_edit->RightColumnClass ?>"><div<?php echo $phs_keyvalues->key_id->CellAttributes() ?>>
...
<?php if ($phs_keyvalues->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_phs_keyvalues_lang_id" for="x_lang_id" class="<?php echo $phs_keyvalues_edit->LeftColumnClass ?>"><?php echo $phs_keyvalues->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keyvalues_edit->RightColumnClass ?>"><div<?php echo $phs_keyvalues->lang_id->CellAttributes() ?>>
...
<?php if ($phs_keyvalues->key_value->Visible) { // key_value ?>
	<div id="r_key_value" class="form-group">
		<label id="elh_phs_keyvalues_key_value" for="x_key_value" class="<?php echo $phs_keyvalues_edit->LeftColumnClass ?>"><?php echo $phs_keyvalues->key_value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keyvalues_edit->RightColumnClass ?>"><div<?php echo $phs_keyvalues->key_value->CellAttributes() ?>>
...
<?php if ($phs_keyvalues->key_rvalue->Visible) { // key_rvalue ?>
	<div id="r_key_rvalue" class="form-group">
		<label id="elh_phs_keyvalues_key_rvalue" for="x_key_rvalue" class="<?php echo $phs_keyvalues_edit->LeftColumnClass ?>"><?php echo $phs_keyvalues->key_rvalue->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $phs_keyvalues_edit->RightColumnClass ?>"><div<?php echo $phs_keyvalues->key_rvalue->CellAttributes() ?>>
...
<?php if ($phs_keyvalues->key_text->Visible) { // key_text ?>
	<div id="r_key_text" class="form-group">
		<label id="elh_phs_keyvalues_key_text" class="<?php echo $phs_keyvalues_edit->LeftColumnClass ?>"><?php echo $phs_keyvalues->key_text->FldCaption() ?></label>
		<div class="<?php echo $phs_keyvalues_edit->RightColumnClass ?>"><div<?php echo $phs_keyvalues->key_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fphs_keyvaluesedit", "x_key_text", 35, 4, <?php echo ($phs_keyvalues->key_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<input type="hidden" data-table="phs_keyvalues" data-field="x_kval_id" name="x_kval_id" id="x_kval_id" value="<?php echo ew_HtmlEncode($phs_keyvalues->kval_id->CurrentValue) ?>">
<?php if (!$phs_keyvalues_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $phs_keyvalues_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $phs_keyvalues_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fphs_keyvaluesedit.Init();
</script>
<?php
$phs_keyvalues_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$phs_keyvalues_edit->Page_Terminate();
?>
