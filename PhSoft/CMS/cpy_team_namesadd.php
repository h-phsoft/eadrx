...
$cpy_team_names_add = NULL; // Initialize page object first

class ccpy_team_names_add extends ccpy_team_names {
	...
	// Page object name
	var $PageObjName = 'cpy_team_names_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("cpy_team_nameslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cpy_team_namesview.php")
...
// Create page object
if (!isset($cpy_team_names_add)) $cpy_team_names_add = new ccpy_team_names_add();

// Page init
$cpy_team_names_add->Page_Init();

// Page main
$cpy_team_names_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_team_names_add->Page_Render();
?>
...
var CurrentForm = fcpy_team_namesadd = new ew_Form("fcpy_team_namesadd", "add");

// Validate form
fcpy_team_namesadd.Validate = function() {
...
fcpy_team_namesadd.Form_CustomValidate = 
...
fcpy_team_namesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_team_namesadd.Lists["x_team_id"] = {"LinkField":"x_team_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_team_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_team"};
fcpy_team_namesadd.Lists["x_team_id"].Data = "<?php echo $cpy_team_names_add->team_id->LookupFilterQuery(FALSE, "add") ?>";
fcpy_team_namesadd.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_id","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fcpy_team_namesadd.Lists["x_lang_id"].Data = "<?php echo $cpy_team_names_add->lang_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $cpy_team_names_add->ShowPageHeader(); ?>
<?php
$cpy_team_names_add->ShowMessage();
?>
<form name="fcpy_team_namesadd" id="fcpy_team_namesadd" class="<?php echo $cpy_team_names_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_team_names_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_team_names_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_team_names">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cpy_team_names_add->IsModal) ?>">
...
<?php if ($cpy_team_names->team_id->Visible) { // team_id ?>
	<div id="r_team_id" class="form-group">
		<label id="elh_cpy_team_names_team_id" for="x_team_id" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->team_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->team_id->CellAttributes() ?>>
...
<?php if ($cpy_team_names->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_cpy_team_names_lang_id" for="x_lang_id" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->lang_id->CellAttributes() ?>>
...
<?php if ($cpy_team_names->team_name->Visible) { // team_name ?>
	<div id="r_team_name" class="form-group">
		<label id="elh_cpy_team_names_team_name" for="x_team_name" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->team_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->team_name->CellAttributes() ?>>
...
<?php if ($cpy_team_names->team_title->Visible) { // team_title ?>
	<div id="r_team_title" class="form-group">
		<label id="elh_cpy_team_names_team_title" for="x_team_title" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->team_title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->team_title->CellAttributes() ?>>
...
<?php if ($cpy_team_names->team_position->Visible) { // team_position ?>
	<div id="r_team_position" class="form-group">
		<label id="elh_cpy_team_names_team_position" for="x_team_position" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->team_position->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->team_position->CellAttributes() ?>>
...
<?php if ($cpy_team_names->team_text->Visible) { // team_text ?>
	<div id="r_team_text" class="form-group">
		<label id="elh_cpy_team_names_team_text" class="<?php echo $cpy_team_names_add->LeftColumnClass ?>"><?php echo $cpy_team_names->team_text->FldCaption() ?></label>
		<div class="<?php echo $cpy_team_names_add->RightColumnClass ?>"><div<?php echo $cpy_team_names->team_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_team_namesadd", "x_team_text", 35, 8, <?php echo ($cpy_team_names->team_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if (!$cpy_team_names_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_team_names_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_team_names_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcpy_team_namesadd.Init();
</script>
<?php
$cpy_team_names_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_team_names_add->Page_Terminate();
?>
