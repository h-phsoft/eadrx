...
$app_test_name_edit = NULL; // Initialize page object first

class capp_test_name_edit extends capp_test_name {
	...
	// Page object name
	var $PageObjName = 'app_test_name_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ntest_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("app_test_namelist.php"); // Return to list page
			...
			if (!is_null($this->ntest_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->ntest_id->CurrentValue) == strval($this->Recordset->fields('ntest_id'))) {
	...
	function LoadFormValues() {
		...
		if (!$this->ntest_id->FldIsDetailKey)
			$this->ntest_id->setFormValue($objForm->GetValue("x_ntest_id"));
	}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// test_desc
			$this->test_desc->SetDbValueDef($rsnew, $this->test_desc->CurrentValue, NULL, $this->test_desc->ReadOnly);
...
// Create page object
if (!isset($app_test_name_edit)) $app_test_name_edit = new capp_test_name_edit();

// Page init
$app_test_name_edit->Page_Init();

// Page main
$app_test_name_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$app_test_name_edit->Page_Render();
?>
...
var CurrentForm = fapp_test_nameedit = new ew_Form("fapp_test_nameedit", "edit");

// Validate form
fapp_test_nameedit.Validate = function() {
...
fapp_test_nameedit.Form_CustomValidate = 
...
fapp_test_nameedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fapp_test_nameedit.Lists["x_test_id"] = {"LinkField":"x_test_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_test_iname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"app_test"};
fapp_test_nameedit.Lists["x_test_id"].Data = "<?php echo $app_test_name_edit->test_id->LookupFilterQuery(FALSE, "edit") ?>";
fapp_test_nameedit.Lists["x_lang_id"] = {"LinkField":"x_lang_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_lang_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_language"};
fapp_test_nameedit.Lists["x_lang_id"].Data = "<?php echo $app_test_name_edit->lang_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $app_test_name_edit->ShowPageHeader(); ?>
<?php
$app_test_name_edit->ShowMessage();
?>
<?php if (!$app_test_name_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($app_test_name_edit->Pager)) $app_test_name_edit->Pager = new cPrevNextPager($app_test_name_edit->StartRec, $app_test_name_edit->DisplayRecs, $app_test_name_edit->TotalRecs, $app_test_name_edit->AutoHidePager) ?>
<?php if ($app_test_name_edit->Pager->RecordCount > 0 && $app_test_name_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($app_test_name_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $app_test_name_edit->PageUrl() ?>start=<?php echo $app_test_name_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($app_test_name_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $app_test_name_edit->PageUrl() ?>start=<?php echo $app_test_name_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $app_test_name_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($app_test_name_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $app_test_name_edit->PageUrl() ?>start=<?php echo $app_test_name_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($app_test_name_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $app_test_name_edit->PageUrl() ?>start=<?php echo $app_test_name_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $app_test_name_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fapp_test_nameedit" id="fapp_test_nameedit" class="<?php echo $app_test_name_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($app_test_name_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $app_test_name_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="app_test_name">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($app_test_name_edit->IsModal) ?>">
...
<?php if ($app_test_name->test_id->Visible) { // test_id ?>
	<div id="r_test_id" class="form-group">
		<label id="elh_app_test_name_test_id" for="x_test_id" class="<?php echo $app_test_name_edit->LeftColumnClass ?>"><?php echo $app_test_name->test_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_name_edit->RightColumnClass ?>"><div<?php echo $app_test_name->test_id->CellAttributes() ?>>
...
<?php if ($app_test_name->lang_id->Visible) { // lang_id ?>
	<div id="r_lang_id" class="form-group">
		<label id="elh_app_test_name_lang_id" for="x_lang_id" class="<?php echo $app_test_name_edit->LeftColumnClass ?>"><?php echo $app_test_name->lang_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_name_edit->RightColumnClass ?>"><div<?php echo $app_test_name->lang_id->CellAttributes() ?>>
...
<?php if ($app_test_name->test_name->Visible) { // test_name ?>
	<div id="r_test_name" class="form-group">
		<label id="elh_app_test_name_test_name" for="x_test_name" class="<?php echo $app_test_name_edit->LeftColumnClass ?>"><?php echo $app_test_name->test_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $app_test_name_edit->RightColumnClass ?>"><div<?php echo $app_test_name->test_name->CellAttributes() ?>>
...
<?php if ($app_test_name->test_desc->Visible) { // test_desc ?>
	<div id="r_test_desc" class="form-group">
		<label id="elh_app_test_name_test_desc" class="<?php echo $app_test_name_edit->LeftColumnClass ?>"><?php echo $app_test_name->test_desc->FldCaption() ?></label>
		<div class="<?php echo $app_test_name_edit->RightColumnClass ?>"><div<?php echo $app_test_name->test_desc->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fapp_test_nameedit", "x_test_desc", 35, 8, <?php echo ($app_test_name->test_desc->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<input type="hidden" data-table="app_test_name" data-field="x_ntest_id" name="x_ntest_id" id="x_ntest_id" value="<?php echo ew_HtmlEncode($app_test_name->ntest_id->CurrentValue) ?>">
<?php if (!$app_test_name_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $app_test_name_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $app_test_name_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fapp_test_nameedit.Init();
</script>
<?php
$app_test_name_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$app_test_name_edit->Page_Terminate();
?>
