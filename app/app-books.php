    ...
    foreach ($aBooks as $book) {
      ...
      <div class="block col-12 col-sm-12">
        <div class="block-body">
          <div class="row">
            <div class="col-12 col-sm-2 px-5">
            ...
            <div class="col-12 col-sm-10 px-5">
              <div class="row">
                <h3><?php echo ph_DBKey("Book Name", $curLang->Lang_Id) . ': ' . ph_DBKey($book->Book_Title, $curLang->Lang_Id); ?></h3>
              </div>
              <div class="row">
                <h4><?php echo ph_DBKey("Book Language", $curLang->Lang_Id) . ': ' . $bookLang->Lang_Name; ?></h4>
              </div>
              <div class="row">
