  ...
  <div class="row">
    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
      <div class="card card-signin my-5">
        <div class="card-body">
          <form class="form-signin" method="post" action="<?php echo $PH_BASE_PATH . '?' . $nLang . '/' . ph_Setting('App-Mode-Register') . '/-1'; ?>">
            ...
            <p class="mt-3">
              <?php echo ph_DBKey('Back to', $curLang->Lang_Id); ?> <a href='<?php echo $PH_BASE_PATH . '?' . $nLang . '/' . ph_Setting('App-Mode-Login'); ?>'><strong style="color: #7a020c"><?php echo ph_DBKey('Login', $curLang->Lang_Id); ?></strong></a>
            </p>
          </form>
        </div>
      </div>
