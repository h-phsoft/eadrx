<nav class="sidebar sidebar-right">
  <div class="sidebar-dismiss sidebar-dismiss-right" data-side="right">
  ...
  <ul class="list-unstyled components">
    <?php
    foreach ($navRightMenu->aSubs as $menu) {
      if (count($menu->aSubs) > 0) {
        ...
        <li>
          <a class="dropdown-toggle" href="#Submenu<?php echo $menu->Menu_Id; ?>" data-toggle="collapse" aria-expanded="false">
            ...
            <em><?php echo ph_DBKey($menu->Menu_Name, $curLang->Lang_Id); ?></em>
          </a>
