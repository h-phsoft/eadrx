        ...
        Paging.opts = $.extend(Paging.opts || {
          ...
          "onFormat": function (type) {	// callback for every format element
            switch (type) {
              case 'block':
                if (!this.active) {
                  return '<li><a href="#" class="btn btn-sm btn-outline-secondary">' + this.value + '</a></li>';
                } else if (this.value != this.page) {
                  return '<li><a href="#" class="btn btn-sm btn-outline-secondary">' + this.value + '</a></li>';
                }
                return '<li><a href="#" class="active btn btn-sm btn-outline-secondary">' + this.value + '</a></li>';
              case 'first':
                if (this.active) {
                  return '<li class="first"><a href="#" title="First" class="btn btn-sm btn-outline-secondary"><i class="fas fa-step-backward"></i></a></li>';
                }
                return '<li class="first disabled"><a href="#" title="First" class="btn btn-sm btn-outline-secondary"><i class="fas fa-step-backward"></i></a></li>';
              case 'prev':
                if (this.active) {
                  return '<li class="prev"><a href="#" title="Previous" class="btn btn-sm btn-outline-secondary"><i class="fas fa-chevron-left"></i></a></li>';
                }
                return '<li class="prev disabled"><a href="#" title="Previous" class="btn btn-sm btn-outline-secondary"><i class="fas fa-chevron-left"></i></a></li>';
              case 'next':
                if (this.active) {
                  return '<li class="next"><a href="#" title="Next" class="btn btn-sm btn-outline-secondary"><i class="fas fa-chevron-right"></i></a></li>';
                }
                return '<li class="next disabled"><a href="#" title="Next" class="btn btn-sm btn-outline-secondary"><i class="fas fa-chevron-right"></i></a></li>';
              case 'last':
                if (this.active) {
                  return '<li class="last"><a href="#" title="Last" class="btn btn-sm btn-outline-secondary"><i class="fas fa-step-forward"></i></a></li>';
                }
                return '<li class="last disabled"><a href="#" title="Last" class="btn btn-sm btn-outline-secondary"><i class="fas fa-step-forward"></i></a></li>';
              case "leap":
              case 'fill':
                if (this.active) {
                  return '';
