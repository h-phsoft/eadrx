 ...
 */
$PhSoft_vers = 'PhSoft 1 (C) 2000-2019';

if (!defined('PH_MYSQL_CHARSET')) {
  define("PH_MYSQL_CHARSET", "utf8", TRUE);
}
if (!defined('PH_DEBUG_ENABLED')) {
  define("PH_DEBUG_ENABLED", FALSE, TRUE); // TRUE to debug
}
if (!defined('PH_USE_MYSQLI')) {
